...
def logic_integration_account_usage_configuration_list(client,
                                                       resource_group_name,
                                                       integration_account_name,
                                                       top=None):
    return client.list(resource_group_name=resource_group_name,
...
def logic_integration_account_usage_configuration_show(client,
                                                       resource_group_name,
                                                       integration_account_name,
                                                       usage_configuration_name):
    return client.get(resource_group_name=resource_group_name,
                      integration_account_name=integration_account_name,
                      usage_configuration_name=usage_configuration_name)


def logic_integration_account_usage_configuration_create(client,
                                                         resource_group_name,
                                                         integration_account_name,
                                                         usage_configuration_name,
                                                         location=None,
...
def logic_integration_account_usage_configuration_update(client,
                                                         resource_group_name,
                                                         integration_account_name,
                                                         usage_configuration_name,
                                                         location=None,
...
def logic_integration_account_usage_configuration_delete(client,
                                                         resource_group_name,
                                                         integration_account_name,
                                                         usage_configuration_name):
    return client.delete(resource_group_name=resource_group_name,
...
def logic_integration_account_usage_configuration_list_callback_url(client,
                                                                    resource_group_name,
                                                                    integration_account_name,
                                                                    usage_configuration_name,
                                                                    not_after=None,
