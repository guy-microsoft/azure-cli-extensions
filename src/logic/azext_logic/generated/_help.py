...
helps['logic integration-account-usage-configuration'] = """
    type: group
    short-summary: logic integration-account-usage-configuration
"""

helps['logic integration-account-usage-configuration list'] = """
    type: command
    short-summary: "Gets a list of integration account usage configurations."
    examples:
      - name: Get usage configurations by integration account name
        text: |-
               az logic integration-account-usage-configuration list --integration-account-name \
"<integrationAccountName>" --resource-group "testResourceGroup"
"""

helps['logic integration-account-usage-configuration show'] = """
    type: command
    short-summary: "Gets an integration account usage configuration."
    examples:
      - name: Get usage configuration by name
        text: |-
               az logic integration-account-usage-configuration show --integration-account-name \
"testIntegrationAccount" --resource-group "testResourceGroup" --usage-configuration-name "testUsageConfigurationName"
"""

helps['logic integration-account-usage-configuration create'] = """
    type: command
    short-summary: "Create an integration account usage configuration."
    examples:
      - name: Create or update usage configuration
        text: |-
               az logic integration-account-usage-configuration create --integration-account-name \
"testIntegrationAccount" --resource-group "testResourceGroup" --location "westus" --metadata "{}" --throttles \
"{\\"default\\":{\\"actionStatuses\\":[\\"Succeeded\\",\\"Failed\\"],\\"period\\":{\\"frequency\\":\\"Hour\\",\\"interv\
al\\":1},\\"threshold\\":10000,\\"triggerStatuses\\":[\\"Succeeded\\",\\"Failed\\"]}}" --usage-configuration-name \
"testUsageConfigurationName"
"""

helps['logic integration-account-usage-configuration update'] = """
    type: command
    short-summary: "Update an integration account usage configuration."
"""

helps['logic integration-account-usage-configuration delete'] = """
    type: command
    short-summary: "Deletes an integration account usage configuration."
    examples:
      - name: Delete a usage configuration by name
        text: |-
               az logic integration-account-usage-configuration delete --integration-account-name \
"testIntegrationAccount" --resource-group "testResourceGroup" --usage-configuration-name "testUsageConfigurationName"
"""

helps['logic integration-account-usage-configuration list-callback-url'] = """
    type: command
    short-summary: "Get the callback url."
    examples:
      - name: Get the callback url
        text: |-
               az logic integration-account-usage-configuration list-callback-url --integration-account-name \
"testIntegrationAccount" --key-type "Primary" --not-after "2018-04-19T16:00:00Z" --resource-group "testResourceGroup" \
