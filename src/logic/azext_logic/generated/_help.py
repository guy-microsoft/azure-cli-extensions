    ...
    examples:
      - name: Validate a workflow
        text: |-
               ...
               "test-resource-group" --location "brazilsouth" --properties-definition $schema=https://sch\\
               ema.management.azure.com/providers/Microsoft.Logic/schemas/2016-06-01/workflowdefinition.j\\
               son# actions=[object Object] contentVersion=1.0.0.0 outputs=[object Object] parameters=[ob\\
               ject Object] triggers=[object Object] --properties-integration-account id=/subscriptions/3\\
               4adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/test-resource-group/providers/Microsoft\\
               .Logic/integrationAccounts/test-integration-account --workflow-name "test-workflow"
"""
...
helps['logic workflow move'] = """
    ...
    examples:
      - name: Move a workflow
        text: |-
               az logic workflow move --id "subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGr
               oups/newResourceGroup/providers/Microsoft.Logic/workflows/newWorkflowName"
               --resource-group "testResourceGroup" --workflow-name "testWorkflow"
"""
