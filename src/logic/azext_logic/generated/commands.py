...
def load_command_table(self, _):
    ...
    from azext_logic.generated._client_factory import cf_integration_account_usage_configuration
    logic_integration_account_usage_configuration = CliCommandType(
        operations_tmpl='azext_logic.vendored_sdks.logic.operations._integration_account_usage_configuration_operations'
        '#IntegrationAccountUsageConfigurationOperations.{}',
        client_factory=cf_integration_account_usage_configuration)
    with self.command_group('logic integration-account-usage-configuration',
                            logic_integration_account_usage_configuration,
                            client_factory=cf_integration_account_usage_configuration, is_experimental=True) as g:
        g.custom_command('list', 'logic_integration_account_usage_configuration_list')
        g.custom_show_command('show', 'logic_integration_account_usage_configuration_show')
        g.custom_command('create', 'logic_integration_account_usage_configuration_create')
        g.custom_command('update', 'logic_integration_account_usage_configuration_update')
        g.custom_command('delete', 'logic_integration_account_usage_configuration_delete', confirmation=True)
        g.custom_command('list-callback-url', 'logic_integration_account_usage_configuration_list_callback_url')
