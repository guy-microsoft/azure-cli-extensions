...
def load_arguments(self, _):
    ...
    with self.argument_context('logic integration-account-usage-configuration list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('integration_account_name', type=str, help='The integration account name.')
        c.argument('top', type=int, help='The number of items to be included in the result.')

    with self.argument_context('logic integration-account-usage-configuration show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('integration_account_name', type=str, help='The integration account name.', id_part='name')
        c.argument('usage_configuration_name', type=str, help='The integration account usage configuration name.',
                   id_part='child_name_1')

    with self.argument_context('logic integration-account-usage-configuration create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('integration_account_name', type=str, help='The integration account name.')
        c.argument('usage_configuration_name', type=str, help='The integration account usage configuration name.')
        c.argument('location', arg_type=get_location_type(self.cli_ctx),
                   validator=get_default_location_from_resource_group)
        c.argument('tags', tags_type)
        c.argument('disable_override', arg_type=get_three_state_flag(), help='Whether to disable runtime override of '
                   'the usage configuration.')
        c.argument('throttles', type=validate_file_or_dict, help='The usage configuration throttles. Expected value: '
                   'json-string/@json-file.')
        c.argument('metadata', type=validate_file_or_dict,
                   help='The metadata. Expected value: json-string/@json-file.')

    with self.argument_context('logic integration-account-usage-configuration update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('integration_account_name', type=str, help='The integration account name.', id_part='name')
        c.argument('usage_configuration_name', type=str, help='The integration account usage configuration name.',
                   id_part='child_name_1')
    ...
    with self.argument_context('logic integration-account-usage-configuration delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('integration_account_name', type=str, help='The integration account name.', id_part='name')
        c.argument('usage_configuration_name', type=str, help='The integration account usage configuration name.',
                   id_part='child_name_1')

    with self.argument_context('logic integration-account-usage-configuration list-callback-url') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('integration_account_name', type=str, help='The integration account name.')
        c.argument('usage_configuration_name', type=str, help='The integration account usage configuration name.')
        c.argument('not_after', help='The expiry time.')
