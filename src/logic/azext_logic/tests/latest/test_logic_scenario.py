...
# EXAMPLE: /IntegrationAccountUsageConfigurations/put/Create or update usage configuration
@try_manual
def step__integrationaccountusageconfigurations_put(test, rg_2, rg, rg_3):
    test.cmd('az logic integration-account-usage-configuration create '
             '--integration-account-name "{myIntegrationAccount}" '
             '--resource-group "{rg_2}" '
             '--location "westus" '
             '--metadata "{{}}" '
             '--throttles "{{\\"default\\":{{\\"actionStatuses\\":[\\"Succeeded\\",\\"Failed\\"],\\"period\\":{{\\"freq'
             'uency\\":\\"Hour\\",\\"interval\\":1}},\\"threshold\\":10000,\\"triggerStatuses\\":[\\"Succeeded\\",\\"Fa'
             'iled\\"]}}}}" '
             '--usage-configuration-name "testUsageConfigurationName"',
             checks=[])


# EXAMPLE: /IntegrationAccountUsageConfigurations/get/Get usage configuration by name
@try_manual
def step__integrationaccountusageconfigurations_get(test, rg_2, rg, rg_3):
    test.cmd('az logic integration-account-usage-configuration show '
             '--integration-account-name "{myIntegrationAccount}" '
             '--resource-group "{rg_2}" '
             '--usage-configuration-name "testUsageConfigurationName"',
             checks=[])
...
# EXAMPLE: /IntegrationAccountUsageConfigurations/get/Get usage configurations by integration account name
@try_manual
def step__integrationaccountusageconfigurations_get2(test, rg_2, rg, rg_3):
    test.cmd('az logic integration-account-usage-configuration list '
             '--integration-account-name "{myIntegrationAccount2}" '
             '--resource-group "{rg_2}"',
             checks=[])


# EXAMPLE: /IntegrationAccountUsageConfigurations/post/Get the callback url
@try_manual
def step__integrationaccountusageconfigurations_post(test, rg_2, rg, rg_3):
    test.cmd('az logic integration-account-usage-configuration list-callback-url '
             '--integration-account-name "{myIntegrationAccount}" '
             '--key-type "Primary" '
             '--not-after "2018-04-19T16:00:00Z" '
             '--resource-group "{rg_2}" '
...
# EXAMPLE: /IntegrationAccountUsageConfigurations/delete/Delete a usage configuration by name
@try_manual
def step__integrationaccountusageconfigurations_delete(test, rg_2, rg, rg_3):
    test.cmd('az logic integration-account-usage-configuration delete -y '
             '--integration-account-name "{myIntegrationAccount}" '
             '--resource-group "{rg_2}" '
             '--usage-configuration-name "testUsageConfigurationName"',
             checks=[])
...
def call_scenario(test, rg_2, rg, rg_3):
    ...
    step__integrationaccountusageconfigurations_put(test, rg_2, rg, rg_3)
    step__integrationaccountusageconfigurations_get(test, rg_2, rg, rg_3)
    step__integrationaccountusageconfigurations_get2(test, rg_2, rg, rg_3)
    step__integrationaccountusageconfigurations_post(test, rg_2, rg, rg_3)
    step__integrationaccountusageconfigurations_delete(test, rg_2, rg, rg_3)
