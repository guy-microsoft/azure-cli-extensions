...
class IntegrationAccountUsageConfiguration(Resource):
    ...
    def __init__(
        ...
        *,
        ...
        throttles: Optional[Dict[str, "UsageConfigurationThrottle"]] = None,
        metadata: Optional[object] = None,
        **kwargs
    ):
...
class IntegrationAccountUsageConfigurationListResult(msrest.serialization.Model):
    """The list of integration account usage configurations.

    :param value: The list of integration account usage configurations.
    :type value: list[~logic_management_client.models.IntegrationAccountUsageConfiguration]
    :param next_link: The URL to get the next set of results.
    :type next_link: str
    """

    _attribute_map = {
        'value': {'key': 'value', 'type': '[IntegrationAccountUsageConfiguration]'},
        'next_link': {'key': 'nextLink', 'type': 'str'},
    }
    ...
    def __init__(
        self,
        *,
        value: Optional[List["IntegrationAccountUsageConfiguration"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        super(IntegrationAccountUsageConfigurationListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link
...
class UsageConfigurationThrottle(msrest.serialization.Model):
    ...
    :type period: ~logic_management_client.models.UsageConfigurationThrottlePeriod
    :param trigger_statuses: The trigger statuses to throttle.
    :type trigger_statuses: list[str or ~logic_management_client.models.WorkflowStatus]
    :param action_statuses: The action statuses to throttle.
    :type action_statuses: list[str or ~logic_management_client.models.WorkflowStatus]
    """
    ...
    def __init__(
        ...
        *,
        ...
        period: Optional["UsageConfigurationThrottlePeriod"] = None,
        trigger_statuses: Optional[List[Union[str, "WorkflowStatus"]]] = None,
        action_statuses: Optional[List[Union[str, "WorkflowStatus"]]] = None,
        **kwargs
    ):
...
class UsageConfigurationThrottlePeriod(msrest.serialization.Model):
    """The usage configuration throttle period.

    :param interval: The throttle period interval.
    :type interval: float
    :param frequency: The throttle frequency. Possible values include: "NotSpecified", "Second",
