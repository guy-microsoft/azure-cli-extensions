...
try:
    ...
    from ._models_py3 import IntegrationAccountUsageConfigurationListResult
    ...
    from ._models import IntegrationAccountUsageConfiguration  # type: ignore
    from ._models import IntegrationAccountUsageConfigurationListResult  # type: ignore
    ...
    from ._models import UsageConfigurationThrottle  # type: ignore
    from ._models import UsageConfigurationThrottlePeriod  # type: ignore
