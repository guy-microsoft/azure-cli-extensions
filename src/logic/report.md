...
|**--access_control**|object|The access control configuration.|access_control|properties_access_control|
...
|**--name**|string|The workflow name.|name|name|
...
|**--workflow_name**|string|The workflow name.|workflow_name|workflow_name|
|**--trigger_name**|string|The workflow trigger name.|trigger_name|trigger_name|
|**--source**|object|The workflow trigger reference.|source|source|
