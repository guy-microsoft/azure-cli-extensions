...
|az logic integration-account-usage-configuration|IntegrationAccountUsageConfigurations|[commands](#CommandsInIntegrationAccountUsageConfigurations)|
...
\\":[\\"Succeeded\\",\\"Failed\\"],\\"period\\":{\\"frequency\\":\\"Hour\\",\\"interval\\":1},\\"threshold\\":10000,\\"\
triggerStatuses\\":[\\"Succeeded\\",\\"Failed\\"]}}" --usage-configuration-name "testUsageConfigurationName"
```
##### <a name="ParametersIntegrationAccountUsageConfigurationsCreateOrUpdate#Create">Parameters</a> 
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--resource-group-name**|string|The resource group name.|resource_group_name|resourceGroupName|
|**--integration-account-name**|string|The integration account name.|integration_account_name|integrationAccountName|
...
|**--location**|string|The resource location.|location|location|
|**--tags**|dictionary|The resource tags.|tags|tags|
|**--disable-override**|boolean|Whether to disable runtime override of the usage configuration.|disable_override|disableOverride|
|**--throttles**|dictionary|The usage configuration throttles.|throttles|throttles|
|**--metadata**|any|The metadata.|metadata|metadata|

#### <a name="IntegrationAccountUsageConfigurationsCreateOrUpdate#Update">Command `az logic integration-account-usage-configuration update`</a>

##### <a name="ParametersIntegrationAccountUsageConfigurationsCreateOrUpdate#Update">Parameters</a> 
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--resource-group-name**|string|The resource group name.|resource_group_name|resourceGroupName|
|**--integration-account-name**|string|The integration account name.|integration_account_name|integrationAccountName|
...
#### <a name="IntegrationAccountUsageConfigurationsDelete">Command `az logic integration-account-usage-configuration delete`</a>

##### <a name="ExamplesIntegrationAccountUsageConfigurationsDelete">Example</a>
```
az logic integration-account-usage-configuration delete --integration-account-name "testIntegrationAccount" \
--resource-group "testResourceGroup" --usage-configuration-name "testUsageConfigurationName"
```
##### <a name="ParametersIntegrationAccountUsageConfigurationsDelete">Parameters</a> 
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--resource-group-name**|string|The resource group name.|resource_group_name|resourceGroupName|
|**--integration-account-name**|string|The integration account name.|integration_account_name|integrationAccountName|
...
#### <a name="IntegrationAccountUsageConfigurationsListCallbackUrl">Command `az logic integration-account-usage-configuration list-callback-url`</a>

##### <a name="ExamplesIntegrationAccountUsageConfigurationsListCallbackUrl">Example</a>
```
az logic integration-account-usage-configuration list-callback-url --integration-account-name "testIntegrationAccount" \
--key-type "Primary" --not-after "2018-04-19T16:00:00Z" --resource-group "testResourceGroup" \
--usage-configuration-name "testUsageConfiguration"
```
##### <a name="ParametersIntegrationAccountUsageConfigurationsListCallbackUrl">Parameters</a> 
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--resource-group-name**|string|The resource group name.|resource_group_name|resourceGroupName|
|**--integration-account-name**|string|The integration account name.|integration_account_name|integrationAccountName|
