...
class ServiceOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        device_service = models.DeviceService(tags=tags, location=location, etag=etag, notes=notes, quantity=quantity, billing_domain_name=billing_domain_name, admin_domain_name=admin_domain_name)
        api_version = "2019-06-01"
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        device_service = models.DeviceServiceProperties(notes=notes, quantity=quantity, billing_domain_name=billing_domain_name, admin_domain_name=admin_domain_name)
        api_version = "2019-06-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
