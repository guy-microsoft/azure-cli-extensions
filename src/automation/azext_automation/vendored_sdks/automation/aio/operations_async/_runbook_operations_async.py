...
class RunbookOperations:
    ...
    async def _publish_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._publish_initial.metadata['url']
    ...
    async def create_or_update(
        ...
        automation_account_name: str,
        runbook_name: str,
        runbook_type: Union[str, "models.RunbookTypeEnum"],
        name: Optional[str] = None,
        location: Optional[str] = None,
        tags: Optional[Dict[str, str]] = None,
        log_verbose: Optional[bool] = None,
        log_progress: Optional[bool] = None,
        draft: Optional["models.RunbookDraft"] = None,
        publish_content_link: Optional["models.ContentLink"] = None,
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Runbook or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Runbook or ~azure.mgmt.automation.models.Runbook
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Runbook"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.RunbookCreateOrUpdateParameters(name=name, location=location, tags=tags, log_verbose=log_verbose, log_progress=log_progress, runbook_type=runbook_type, draft=draft, publish_content_link=publish_content_link, description=description, log_activity_trace=log_activity_trace)
        api_version = "2018-06-30"
        ...
        body_content = self._serialize.body(_parameters, 'RunbookCreateOrUpdateParameters')
    ...
    async def update(
        ...
        **kwargs
        ...
        _parameters = models.RunbookUpdateParameters(name=name, location=location, tags=tags, description=description, log_verbose=log_verbose, log_progress=log_progress, log_activity_trace=log_activity_trace)
        api_version = "2018-06-30"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'RunbookUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RunbookListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.RunbookListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
