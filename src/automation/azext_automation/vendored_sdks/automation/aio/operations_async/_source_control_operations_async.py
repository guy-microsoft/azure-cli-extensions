...
class SourceControlOperations:
    ...
    async def create_or_update(
        ...
        source_type: Optional[Union[str, "models.SourceType"]] = None,
        security_token: Optional["models.SourceControlSecurityTokenProperties"] = None,
    ...
    def list_by_automation_account(
        ...
        **kwargs
    ) -> "models.SourceControlListResult":
