...
from .operations_async import KeyOperations
...
from .operations_async import ObjectDataTypeOperations
from .operations_async import FieldOperations
...
from .operations_async import SoftwareUpdateConfigurationOperations
from .operations_async import SoftwareUpdateConfigurationRunOperations
from .operations_async import SoftwareUpdateConfigurationMachineRunOperations
from .operations_async import SourceControlOperations
from .operations_async import SourceControlSyncJobOperations
from .operations_async import SourceControlSyncJobStreamOperations
...
from .operations_async import NodeReportOperations
...
from .operations_async import TestJobStreamOperations
...
class AutomationClient(object):
    ...
    :vartype operation: azure.mgmt.automation.aio.operations_async.OperationOperations
    ...
    :vartype usage: azure.mgmt.automation.aio.operations_async.UsageOperations
    :ivar key: KeyOperations operations
    :vartype key: azure.mgmt.automation.aio.operations_async.KeyOperations
    ...
    :ivar object_data_type: ObjectDataTypeOperations operations
    :vartype object_data_type: azure.mgmt.automation.aio.operations_async.ObjectDataTypeOperations
    :ivar field: FieldOperations operations
    :vartype field: azure.mgmt.automation.aio.operations_async.FieldOperations
    ...
    :ivar software_update_configuration: SoftwareUpdateConfigurationOperations operations
    :vartype software_update_configuration: azure.mgmt.automation.aio.operations_async.SoftwareUpdateConfigurationOperations
    :ivar software_update_configuration_run: SoftwareUpdateConfigurationRunOperations operations
    :vartype software_update_configuration_run: azure.mgmt.automation.aio.operations_async.SoftwareUpdateConfigurationRunOperations
    :ivar software_update_configuration_machine_run: SoftwareUpdateConfigurationMachineRunOperations operations
    :vartype software_update_configuration_machine_run: azure.mgmt.automation.aio.operations_async.SoftwareUpdateConfigurationMachineRunOperations
    ...
    :ivar source_control_sync_job_stream: SourceControlSyncJobStreamOperations operations
    :vartype source_control_sync_job_stream: azure.mgmt.automation.aio.operations_async.SourceControlSyncJobStreamOperations
    ...
    :vartype node_report: azure.mgmt.automation.aio.operations_async.NodeReportOperations
    ...
    :vartype test_job_stream: azure.mgmt.automation.aio.operations_async.TestJobStreamOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.module = ModuleOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.object_data_type = ObjectDataTypeOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.field = FieldOperations(
            self._client, self._config, self._serialize, self._deserialize)
        ...
        self.watcher = WatcherOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.software_update_configuration = SoftwareUpdateConfigurationOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.software_update_configuration_run = SoftwareUpdateConfigurationRunOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.software_update_configuration_machine_run = SoftwareUpdateConfigurationMachineRunOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.source_control = SourceControlOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.source_control_sync_job = SourceControlSyncJobOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.source_control_sync_job_stream = SourceControlSyncJobStreamOperations(
            self._client, self._config, self._serialize, self._deserialize)
        ...
        self.dsc_node = DscNodeOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.node_report = NodeReportOperations(
            self._client, self._config, self._serialize, self._deserialize)
