...
class RunbookOperations:
    ...
    async def create_or_update(
        ...
        content_hash: Optional["models.ContentHash"] = None,
        version: Optional[str] = None,
        in_edit: Optional[bool] = None,
        draft_content_link: Optional["models.ContentLink"] = None,
        creation_time: Optional[datetime.datetime] = None,
        last_modified_time: Optional[datetime.datetime] = None,
        parameters: Optional[Dict[str, "models.RunbookParameter"]] = None,
