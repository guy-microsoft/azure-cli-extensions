...
class AutomationAccountOperations:
    ...
    async def update(
        ...
        **kwargs
        ...
        parameters = models.AutomationAccountUpdateParameters(name=name, location=location, tags=tags, sku=sku)
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        parameters = models.AutomationAccountCreateOrUpdateParameters(name=name, location=location, tags=tags, sku=sku)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
