...
from .operations import ObjectDataTypeOperations
from .operations import FieldOperations
...
from .operations import SoftwareUpdateConfigurationOperations
from .operations import SoftwareUpdateConfigurationRunOperations
from .operations import SoftwareUpdateConfigurationMachineRunOperations
from .operations import SourceControlOperations
from .operations import SourceControlSyncJobOperations
from .operations import SourceControlSyncJobStreamOperations
...
from .operations import NodeReportOperations
...
class AutomationClient(object):
    ...
    :vartype operation: azure.mgmt.automation.operations.OperationOperations
    ...
    :vartype usage: azure.mgmt.automation.operations.UsageOperations
    :ivar key: KeyOperations operations
    :vartype key: azure.mgmt.automation.operations.KeyOperations
    ...
    :vartype object_data_type: azure.mgmt.automation.operations.ObjectDataTypeOperations
    :ivar field: FieldOperations operations
    :vartype field: azure.mgmt.automation.operations.FieldOperations
    ...
    :vartype software_update_configuration: azure.mgmt.automation.operations.SoftwareUpdateConfigurationOperations
    :ivar software_update_configuration_run: SoftwareUpdateConfigurationRunOperations operations
    :vartype software_update_configuration_run: azure.mgmt.automation.operations.SoftwareUpdateConfigurationRunOperations
    :ivar software_update_configuration_machine_run: SoftwareUpdateConfigurationMachineRunOperations operations
    :vartype software_update_configuration_machine_run: azure.mgmt.automation.operations.SoftwareUpdateConfigurationMachineRunOperations
    ...
    :vartype source_control_sync_job_stream: azure.mgmt.automation.operations.SourceControlSyncJobStreamOperations
    ...
    :vartype node_report: azure.mgmt.automation.operations.NodeReportOperations
    ...
    :vartype test_job_stream: azure.mgmt.automation.operations.TestJobStreamOperations
