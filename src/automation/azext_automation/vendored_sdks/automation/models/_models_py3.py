...
class JobCreateParameters(msrest.serialization.Model):
    ...
    _attribute_map = {
        'parameters': {'key': 'properties.parameters', 'type': '{str}'},
        'run_on': {'key': 'properties.runOn', 'type': 'str'},
        'name': {'key': 'runbook.name', 'type': 'str'},
    }
...
class RunbookCreateOrUpdateParameters(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'description': {'key': 'properties.description', 'type': 'str'},
        'log_activity_trace': {'key': 'properties.logActivityTrace', 'type': 'int'},
        'uri': {'key': 'publishContentLink.uri', 'type': 'str'},
        'content_hash': {'key': 'publishContentLink.contentHash', 'type': 'ContentHash'},
        'version': {'key': 'publishContentLink.version', 'type': 'str'},
        'in_edit': {'key': 'draft.inEdit', 'type': 'bool'},
        'draft_content_link': {'key': 'draft.draftContentLink', 'type': 'ContentLink'},
        'creation_time': {'key': 'draft.creationTime', 'type': 'iso-8601'},
        'last_modified_time': {'key': 'draft.lastModifiedTime', 'type': 'iso-8601'},
        'parameters': {'key': 'draft.parameters', 'type': '{RunbookParameter}'},
        'output_types': {'key': 'draft.outputTypes', 'type': '[str]'},
    }
