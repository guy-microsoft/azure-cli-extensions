...
class DscNodeUpdateParameters(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'name': {'key': 'properties.nodeConfiguration.name', 'type': 'str'},
    }
...
class JobSchedule(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'last_modified_time': {'key': 'properties.lastModifiedTime', 'type': 'iso-8601'},
        'description': {'key': 'properties.description', 'type': 'str'},
        'week_days': {'key': 'properties.advancedSchedule.weekDays', 'type': '[str]'},
        'month_days': {'key': 'properties.advancedSchedule.monthDays', 'type': '[int]'},
        'monthly_occurrences': {'key': 'properties.advancedSchedule.monthlyOccurrences', 'type': '[AdvancedScheduleMonthlyOccurrence]'},
    }
...
class JobScheduleProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        'job_schedule_id': {'key': 'jobScheduleId', 'type': 'str'},
        'schedule': {'key': 'schedule', 'type': 'ScheduleAssociationProperty'},
        'runbook': {'key': 'runbook', 'type': 'RunbookAssociationProperty'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(JobScheduleProperties, self).__init__(**kwargs)
...
class SoftwareUpdateConfiguration(msrest.serialization.Model):
    ...
    :ivar creation_time_properties_creation_time: Creation time of the resource, which only appears
     in the response.
    ...
    :ivar last_modified_time_properties_last_modified_time: Last time resource was modified, which
     only appears in the response.
    :vartype last_modified_time_properties_last_modified_time: ~datetime.datetime
    :ivar last_modified_by: LastModifiedBy property, which only appears in the response.
    :vartype last_modified_by: str
    :param parameters_properties_tasks_post_task_parameters: Gets or sets the parameters of the
     task.
    :type parameters_properties_tasks_post_task_parameters: dict[str, str]
    :param source_properties_tasks_post_task_source: Gets or sets the name of the runbook.
    :type source_properties_tasks_post_task_source: str
    :param parameters_properties_tasks_pre_task_parameters: Gets or sets the parameters of the
     task.
    :type parameters_properties_tasks_pre_task_parameters: dict[str, str]
    :param source_properties_tasks_pre_task_source: Gets or sets the name of the runbook.
    :type source_properties_tasks_pre_task_source: str
    :param start_time: Gets or sets the start time of the schedule.
    :type start_time: ~datetime.datetime
    :ivar start_time_offset_minutes: Gets the start time's offset in minutes.
    :vartype start_time_offset_minutes: float
    ...
    :param time_zone: Gets or sets the time zone of the schedule.
    :type time_zone: str
    :param creation_time_properties_schedule_info_creation_time: Gets or sets the creation time.
    :type creation_time_properties_schedule_info_creation_time: ~datetime.datetime
    :param last_modified_time_properties_schedule_info_last_modified_time: Gets or sets the last
     modified time.
    :type last_modified_time_properties_schedule_info_last_modified_time: ~datetime.datetime
    :param description: Gets or sets the description.
    :type description: str
    :param week_days: Days of the week that the job should execute on.
    :type week_days: list[str]
    ...
    _validation = {
        ...
        'last_modified_time_properties_last_modified_time': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'last_modified_time_properties_last_modified_time': {'key': 'properties.lastModifiedTime', 'type': 'iso-8601'},
        'last_modified_by': {'key': 'properties.lastModifiedBy', 'type': 'str'},
        'parameters_properties_tasks_post_task_parameters': {'key': 'properties.tasks.postTask.parameters', 'type': '{str}'},
        'source_properties_tasks_post_task_source': {'key': 'properties.tasks.postTask.source', 'type': 'str'},
        'parameters_properties_tasks_pre_task_parameters': {'key': 'properties.tasks.preTask.parameters', 'type': '{str}'},
        'source_properties_tasks_pre_task_source': {'key': 'properties.tasks.preTask.source', 'type': 'str'},
        'start_time': {'key': 'properties.scheduleInfo.startTime', 'type': 'iso-8601'},
        'start_time_offset_minutes': {'key': 'properties.scheduleInfo.startTimeOffsetMinutes', 'type': 'float'},
        'expiry_time': {'key': 'properties.scheduleInfo.expiryTime', 'type': 'iso-8601'},
        'expiry_time_offset_minutes': {'key': 'properties.scheduleInfo.expiryTimeOffsetMinutes', 'type': 'float'},
        'is_enabled': {'key': 'properties.scheduleInfo.isEnabled', 'type': 'bool'},
        'next_run': {'key': 'properties.scheduleInfo.nextRun', 'type': 'iso-8601'},
        'next_run_offset_minutes': {'key': 'properties.scheduleInfo.nextRunOffsetMinutes', 'type': 'float'},
        'interval': {'key': 'properties.scheduleInfo.interval', 'type': 'int'},
        'frequency': {'key': 'properties.scheduleInfo.frequency', 'type': 'str'},
        'time_zone': {'key': 'properties.scheduleInfo.timeZone', 'type': 'str'},
        'creation_time_properties_schedule_info_creation_time': {'key': 'properties.scheduleInfo.creationTime', 'type': 'iso-8601'},
        'last_modified_time_properties_schedule_info_last_modified_time': {'key': 'properties.scheduleInfo.lastModifiedTime', 'type': 'iso-8601'},
        'description': {'key': 'properties.scheduleInfo.description', 'type': 'str'},
        'week_days': {'key': 'properties.scheduleInfo.advancedSchedule.weekDays', 'type': '[str]'},
        'month_days': {'key': 'properties.scheduleInfo.advancedSchedule.monthDays', 'type': '[int]'},
        'monthly_occurrences': {'key': 'properties.scheduleInfo.advancedSchedule.monthlyOccurrences', 'type': '[AdvancedScheduleMonthlyOccurrence]'},
        'operating_system': {'key': 'properties.updateConfiguration.operatingSystem', 'type': 'str'},
        'windows': {'key': 'properties.updateConfiguration.windows', 'type': 'WindowsProperties'},
        'linux': {'key': 'properties.updateConfiguration.linux', 'type': 'LinuxProperties'},
        'duration': {'key': 'properties.updateConfiguration.duration', 'type': 'duration'},
        'azure_virtual_machines': {'key': 'properties.updateConfiguration.azureVirtualMachines', 'type': '[str]'},
        'non_azure_computer_names': {'key': 'properties.updateConfiguration.nonAzureComputerNames', 'type': '[str]'},
        'azure_queries': {'key': 'properties.updateConfiguration.targets.azureQueries', 'type': '[AzureQueryProperties]'},
        'non_azure_queries': {'key': 'properties.updateConfiguration.targets.nonAzureQueries', 'type': '[NonAzureQueryProperties]'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        parameters_properties_tasks_post_task_parameters: Optional[Dict[str, str]] = None,
        source_properties_tasks_post_task_source: Optional[str] = None,
        parameters_properties_tasks_pre_task_parameters: Optional[Dict[str, str]] = None,
        source_properties_tasks_pre_task_source: Optional[str] = None,
        start_time: Optional[datetime.datetime] = None,
        expiry_time: Optional[datetime.datetime] = None,
        expiry_time_offset_minutes: Optional[float] = None,
        is_enabled: Optional[bool] = False,
        ...
        frequency: Optional[Union[str, "ScheduleFrequency"]] = None,
        time_zone: Optional[str] = None,
        creation_time_properties_schedule_info_creation_time: Optional[datetime.datetime] = None,
        last_modified_time_properties_schedule_info_last_modified_time: Optional[datetime.datetime] = None,
        description: Optional[str] = None,
        week_days: Optional[List[str]] = None,
        month_days: Optional[List[int]] = None,
        monthly_occurrences: Optional[List["AdvancedScheduleMonthlyOccurrence"]] = None,
        ...
        **kwargs
        ...
        self.last_modified_time_properties_last_modified_time = None
        self.last_modified_by = None
        self.parameters_properties_tasks_post_task_parameters = parameters_properties_tasks_post_task_parameters
        self.source_properties_tasks_post_task_source = source_properties_tasks_post_task_source
        self.parameters_properties_tasks_pre_task_parameters = parameters_properties_tasks_pre_task_parameters
        self.source_properties_tasks_pre_task_source = source_properties_tasks_pre_task_source
        self.start_time = start_time
        self.start_time_offset_minutes = None
        self.expiry_time = expiry_time
        self.expiry_time_offset_minutes = expiry_time_offset_minutes
        ...
        self.frequency = frequency
        self.time_zone = time_zone
        self.creation_time_properties_schedule_info_creation_time = creation_time_properties_schedule_info_creation_time
        self.last_modified_time_properties_schedule_info_last_modified_time = last_modified_time_properties_schedule_info_last_modified_time
        self.description = description
        self.week_days = week_days
        self.month_days = month_days
        self.monthly_occurrences = monthly_occurrences
