...
class SoftwareUpdateConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.parameters_properties_tasks_post_task_parameters = kwargs.get('parameters_properties_tasks_post_task_parameters', None)
        self.source_properties_tasks_post_task_source = kwargs.get('source_properties_tasks_post_task_source', None)
        self.parameters_properties_tasks_pre_task_parameters = kwargs.get('parameters_properties_tasks_pre_task_parameters', None)
        self.source_properties_tasks_pre_task_source = kwargs.get('source_properties_tasks_pre_task_source', None)
        self.start_time = kwargs.get('start_time', None)
        self.start_time_offset_minutes = None
        self.expiry_time = kwargs.get('expiry_time', None)
        self.expiry_time_offset_minutes = kwargs.get('expiry_time_offset_minutes', None)
        ...
        self.frequency = kwargs.get('frequency', None)
        self.time_zone = kwargs.get('time_zone', None)
        self.creation_time_properties_schedule_info_creation_time = kwargs.get('creation_time_properties_schedule_info_creation_time', None)
        self.last_modified_time_properties_schedule_info_last_modified_time = kwargs.get('last_modified_time_properties_schedule_info_last_modified_time', None)
        self.description = kwargs.get('description', None)
        self.week_days = kwargs.get('week_days', None)
        self.month_days = kwargs.get('month_days', None)
        self.monthly_occurrences = kwargs.get('monthly_occurrences', None)
