...
class AgentRegistrationInformationOperations(object):
    ...
    def regenerate_key(
        ...
        resource_group_name,  # type: str
        automation_account_name,  # type: str
        key_name,  # type: Union[str, "models.AgentRegistrationKeyName"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AgentRegistration"
        ...
        :param automation_account_name: The name of the automation account.
        :type automation_account_name: str
        :param key_name: Gets or sets the agent registration key name - primary or secondary.
        ...
        _parameters = models.AgentRegistrationRegenerateKeyParameter(key_name=key_name)
        api_version = "2018-01-15"
        ...
        body_content = self._serialize.body(_parameters, 'AgentRegistrationRegenerateKeyParameter')
