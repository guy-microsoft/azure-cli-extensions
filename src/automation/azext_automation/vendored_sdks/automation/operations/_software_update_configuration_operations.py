...
class SoftwareUpdateConfigurationOperations(object):
    """SoftwareUpdateConfigurationOperations operations.
    ...
    def create(
        ...
        operating_system,  # type: Union[str, "models.OperatingSystemType"]
        client_request_id=None,  # type: Optional[str]
        error=None,  # type: Optional["models.ErrorResponse"]
        parameters=None,  # type: Optional[Dict[str, str]]
        source=None,  # type: Optional[str]
        task_properties_parameters=None,  # type: Optional[Dict[str, str]]
        task_properties_source=None,  # type: Optional[str]
        start_time=None,  # type: Optional[datetime.datetime]
        expiry_time=None,  # type: Optional[datetime.datetime]
        expiry_time_offset_minutes=None,  # type: Optional[float]
        is_enabled=False,  # type: Optional[bool]
        next_run=None,  # type: Optional[datetime.datetime]
        next_run_offset_minutes=None,  # type: Optional[float]
        interval=None,  # type: Optional[int]
        frequency=None,  # type: Optional[Union[str, "models.ScheduleFrequency"]]
        ...
        week_days=None,  # type: Optional[List[str]]
        month_days=None,  # type: Optional[List[int]]
        monthly_occurrences=None,  # type: Optional[List["AdvancedScheduleMonthlyOccurrence"]]
        windows=None,  # type: Optional["models.WindowsProperties"]
        linux=None,  # type: Optional["models.LinuxProperties"]
        duration=None,  # type: Optional[datetime.timedelta]
        azure_virtual_machines=None,  # type: Optional[List[str]]
        non_azure_computer_names=None,  # type: Optional[List[str]]
        azure_queries=None,  # type: Optional[List["AzureQueryProperties"]]
        non_azure_queries=None,  # type: Optional[List["NonAzureQueryProperties"]]
        **kwargs  # type: Any
    ):
