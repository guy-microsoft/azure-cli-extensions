...
class DscCompilationJobOperations(object):
    ...
    def _create_initial(
        ...
        configuration,  # type: "models.DscConfigurationAssociationProperty"
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.DscCompilationJobCreateParameters(name=name, location=location, tags=tags, configuration=configuration, parameters=parameters, increment_node_configuration_build=increment_node_configuration_build)
        ...
        body_content = self._serialize.body(_parameters, 'DscCompilationJobCreateParameters')
    ...
    def begin_create(
     ...
     required.
        ...
        :return: An instance of LROPoller that returns DscCompilationJob
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DscCompilationJobListResult"
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DscCompilationJobListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.DscCompilationJobListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
