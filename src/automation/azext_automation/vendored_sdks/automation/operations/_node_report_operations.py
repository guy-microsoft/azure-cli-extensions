...
class NodeReportOperations(object):
    """NodeReportOperations operations.
    ...
    def list_by_node(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DscNodeReportListResult"
        ...
        :return: DscNodeReportListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.DscNodeReportListResult
