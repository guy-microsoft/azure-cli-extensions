...
class CredentialOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Credential or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Credential or ~azure.mgmt.automation.models.Credential
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Credential"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.CredentialCreateOrUpdateParameters(name=name, user_name=user_name, password=password, description=description)
        api_version = "2015-10-31"
        ...
        body_content = self._serialize.body(_parameters, 'CredentialCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.CredentialUpdateParameters(name=name, user_name=user_name, password=password, description=description)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'CredentialUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.CredentialListResult"
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CredentialListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.CredentialListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
