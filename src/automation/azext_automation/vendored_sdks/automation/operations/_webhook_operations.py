...
class WebhookOperations(object):
    ...
    def create_or_update(
        ...
        runbook=None,  # type: Optional["models.RunbookAssociationProperty"]
        run_on=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Webhook"
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Webhook or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Webhook or ~azure.mgmt.automation.models.Webhook
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Webhook"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.WebhookCreateOrUpdateParameters(name=name, is_enabled=is_enabled, uri=uri, expiry_time=expiry_time, parameters=parameters, runbook=runbook, run_on=run_on)
        api_version = "2015-10-31"
        ...
        body_content = self._serialize.body(_parameters, 'WebhookCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.WebhookUpdateParameters(name=name, is_enabled=is_enabled, run_on=run_on, parameters=parameters, description=description)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'WebhookUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: WebhookListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.WebhookListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
