...
class ScheduleOperations(object):
    ...
    def create_or_update(
        ...
        frequency,  # type: Union[str, "models.ScheduleFrequency"]
        description=None,  # type: Optional[str]
        expiry_time=None,  # type: Optional[datetime.datetime]
        interval=None,  # type: Optional[object]
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.automation.models.Schedule or ~azure.mgmt.automation.models.Schedule or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Schedule"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.ScheduleCreateOrUpdateParameters(name=name, description=description, start_time=start_time, expiry_time=expiry_time, interval=interval, frequency=frequency, time_zone=time_zone, week_days=week_days, month_days=month_days, monthly_occurrences=monthly_occurrences)
        ...
        body_content = self._serialize.body(_parameters, 'ScheduleCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.ScheduleUpdateParameters(name=name, description=description, is_enabled=is_enabled)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'ScheduleUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ScheduleListResult"
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ScheduleListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.ScheduleListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
