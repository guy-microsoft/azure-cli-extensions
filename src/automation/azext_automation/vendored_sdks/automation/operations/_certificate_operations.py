...
class CertificateOperations(object):
    ...
    def create_or_update(
        ...
        certificate_name,  # type: str
        name,  # type: str
        base64_value,  # type: str
        description=None,  # type: Optional[str]
        thumbprint=None,  # type: Optional[str]
        is_exportable=None,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Certificate"
        ...
        :type name: str
        :param base64_value: Gets or sets the base64 encoded value of the certificate.
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Certificate or ~azure.mgmt.automation.models.Certificate
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Certificate"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.CertificateCreateOrUpdateParameters(name=name, base64_value=base64_value, description=description, thumbprint=thumbprint, is_exportable=is_exportable)
        api_version = "2015-10-31"
        ...
        body_content = self._serialize.body(_parameters, 'CertificateCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.CertificateUpdateParameters(name=name, description=description)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.automation.models.CertificateListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
