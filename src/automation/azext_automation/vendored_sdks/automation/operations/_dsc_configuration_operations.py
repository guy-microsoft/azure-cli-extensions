...
class DscConfigurationOperations(object):
    ...
    def create_or_update(
        ...
        automation_account_name,  # type: str
        configuration_name,  # type: str
        source,  # type: "models.ContentSource"
        name=None,  # type: Optional[str]
        location=None,  # type: Optional[str]
        tags=None,  # type: Optional[Dict[str, str]]
        log_verbose=None,  # type: Optional[bool]
        log_progress=None,  # type: Optional[bool]
        parameters=None,  # type: Optional[Dict[str, "DscConfigurationParameter"]]
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DscConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.DscConfiguration or ~azure.mgmt.automation.models.DscConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DscConfiguration"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.DscConfigurationCreateOrUpdateParameters(name=name, location=location, tags=tags, log_verbose=log_verbose, log_progress=log_progress, source=source, parameters=parameters, description=description)
        api_version = "2015-10-31"
        ...
        body_content = self._serialize.body(_parameters, 'DscConfigurationCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.DscConfigurationUpdateParameters(name=name, tags=tags, log_verbose=log_verbose, log_progress=log_progress, source=source, parameters=parameters, description=description)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        if _parameters is not None:
            body_content = self._serialize.body(_parameters, 'DscConfigurationUpdateParameters')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DscConfigurationListResult"
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DscConfigurationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.DscConfigurationListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
