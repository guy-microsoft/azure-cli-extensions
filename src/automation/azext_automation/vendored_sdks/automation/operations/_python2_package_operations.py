...
class Python2PackageOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.PythonPackageCreateParameters(tags=tags, content_link=content_link)
        api_version = "2018-06-30"
        ...
        body_content = self._serialize.body(_parameters, 'PythonPackageCreateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.PythonPackageUpdateParameters(tags=tags)
        api_version = "2018-06-30"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'PythonPackageUpdateParameters')
        body_content_kwargs['content'] = body_content
