...
class DscNodeOperations(object):
    ...
    def update(
        ...
        automation_account_name,  # type: str
        node_id,  # type: str
        dsc_node_update_parameters_node_id=None,  # type: Optional[str]
        ...
        **kwargs  # type: Any
        ...
        :type node_id: str
        :param dsc_node_update_parameters_node_id: Gets or sets the id of the dsc node.
        :type dsc_node_update_parameters_node_id: str
        ...
        _dsc_node_update_parameters = models.DscNodeUpdateParameters(node_id=dsc_node_update_parameters_node_id, name=name)
        api_version = "2018-01-15"
        ...
        body_content = self._serialize.body(_dsc_node_update_parameters, 'DscNodeUpdateParameters')
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DscNodeListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.DscNodeListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
