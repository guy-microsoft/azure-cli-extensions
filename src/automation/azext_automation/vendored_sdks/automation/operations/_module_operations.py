...
class ModuleOperations(object):
    ...
    def create_or_update(
        ...
        automation_account_name,  # type: str
        module_name,  # type: str
        content_link,  # type: "models.ContentLink"
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Module or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Module or ~azure.mgmt.automation.models.Module
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Module"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.ModuleCreateOrUpdateParameters(name=name, location=location, tags=tags, content_link=content_link)
        api_version = "2015-10-31"
        ...
        body_content = self._serialize.body(_parameters, 'ModuleCreateOrUpdateParameters')
    ...
    def update(
        ...
        location=None,  # type: Optional[str]
        tags=None,  # type: Optional[Dict[str, str]]
        content_link=None,  # type: Optional["models.ContentLink"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Module"
        ...
        _parameters = models.ModuleUpdateParameters(name=name, location=location, tags=tags, content_link=content_link)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'ModuleUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ModuleListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.ModuleListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
