...
class SourceControlSyncJobOperations(object):
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :param commit_id: The commit id of the source control sync job. If not syncing to a commitId,
        ...
        _parameters = models.SourceControlSyncJobCreateParameters(commit_id=commit_id)
        ...
        body_content = self._serialize.body(_parameters, 'SourceControlSyncJobCreateParameters')
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SourceControlSyncJobListResult"
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SourceControlSyncJobListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.SourceControlSyncJobListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
