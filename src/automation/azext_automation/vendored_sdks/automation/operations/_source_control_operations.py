...
class SourceControlOperations(object):
    ...
    def create_or_update(
        ...
        repo_url=None,  # type: Optional[str]
        branch=None,  # type: Optional[str]
        folder_path=None,  # type: Optional[str]
        auto_sync=None,  # type: Optional[bool]
        publish_runbook=None,  # type: Optional[bool]
        source_type=None,  # type: Optional[Union[str, "models.SourceType"]]
        security_token=None,  # type: Optional["models.SourceControlSecurityTokenProperties"]
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.automation.models.SourceControl or ~azure.mgmt.automation.models.SourceControl
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SourceControl"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.SourceControlCreateOrUpdateParameters(repo_url=repo_url, branch=branch, folder_path=folder_path, auto_sync=auto_sync, publish_runbook=publish_runbook, source_type=source_type, security_token=security_token, description=description)
        ...
        body_content = self._serialize.body(_parameters, 'SourceControlCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.SourceControlUpdateParameters(branch=branch, folder_path=folder_path, auto_sync=auto_sync, publish_runbook=publish_runbook, security_token=security_token, description=description)
        api_version = "2017-05-15-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'SourceControlUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SourceControlListResult"
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SourceControlListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.SourceControlListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
