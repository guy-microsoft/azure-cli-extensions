...
class VariableOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.automation.models.Variable or ~azure.mgmt.automation.models.Variable
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Variable"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.VariableCreateOrUpdateParameters(name=name, value=value, description=description, is_encrypted=is_encrypted)
        ...
        body_content = self._serialize.body(_parameters, 'VariableCreateOrUpdateParameters')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.VariableUpdateParameters(name=name, value=value, description=description)
        api_version = "2015-10-31"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'VariableUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.VariableListResult"
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VariableListResult or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.VariableListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
