...
class AvailableSkuOperations(object):
    """AvailableSkuOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.DataBoxEdgeSkuList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~data_box_edge_management_client.models.DataBoxEdgeSkuList]
