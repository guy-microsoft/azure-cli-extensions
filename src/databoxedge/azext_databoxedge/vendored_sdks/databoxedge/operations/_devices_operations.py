...
class DevicesOperations(object):
    ...
    def generate_certificate(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.GenerateCertResponse"
        ...
        :rtype: ~data_box_edge_management_client.models.GenerateCertResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.GenerateCertResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def update_extended_information(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "models.DataBoxEdgeDeviceExtendedInfoPatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DataBoxEdgeDeviceExtendedInfo"
        ...
        :type parameters: ~data_box_edge_management_client.models.DataBoxEdgeDeviceExtendedInfoPatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DataBoxEdgeDeviceExtendedInfo, or the result of cls(response)
        :rtype: ~data_box_edge_management_client.models.DataBoxEdgeDeviceExtendedInfo
        :raises: ~azure.core.exceptions.HttpResponseError
