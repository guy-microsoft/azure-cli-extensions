...
class Addon(ArmBaseModel):
    ...
    :type kind: str or ~data_box_edge_management_client.models.AddonType
    :ivar system_data: Addon type.
    :vartype system_data: ~data_box_edge_management_client.models.SystemData
    """
...
class AddonList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Addon]
...
class ArcAddon(Addon):
    ...
    :ivar host_platform: Host OS supported by the Arc addon. Possible values include: "Windows",
     "Linux".
    :vartype host_platform: str or ~data_box_edge_management_client.models.PlatformType
    ...
    :vartype provisioning_state: str or ~data_box_edge_management_client.models.AddonState
    """
...
class CloudEdgeManagementRole(Role):
    ...
    :ivar local_management_status: Local Edge Management Status. Possible values include:
     "Enabled", "Disabled".
    :vartype local_management_status: str or ~data_box_edge_management_client.models.RoleStatus
    :ivar edge_profile: Edge Profile of the resource.
    :vartype edge_profile: ~data_box_edge_management_client.models.EdgeProfile
...
class DataBoxEdgeDevice(ArmBaseModel):
    ...
    :type identity: ~data_box_edge_management_client.models.ResourceIdentity
    ...
    :param resource_move_details: The details of the move operation on this resource.
    :type resource_move_details: ~data_box_edge_management_client.models.ResourceMoveDetails
    :param edge_profile: The details of Edge Profile for this resource.
    :type edge_profile: ~data_box_edge_management_client.models.EdgeProfile
    """
    ...
    def __init__(
        ...
        *,
        ...
        resource_move_details: Optional["ResourceMoveDetails"] = None,
...
class DataBoxEdgeDevicePatch(msrest.serialization.Model):
    ...
    :type edge_profile: ~data_box_edge_management_client.models.EdgeProfilePatch
    """
...
class EdgeProfile(msrest.serialization.Model):
    ...
    :type subscription: ~data_box_edge_management_client.models.EdgeProfileSubscription
    """
...
class EdgeProfilePatch(msrest.serialization.Model):
    ...
    :type subscription: ~data_box_edge_management_client.models.EdgeProfileSubscriptionPatch
    """
...
class EdgeProfileSubscription(msrest.serialization.Model):
    ...
    :param state:  Possible values include: "Registered", "Warned", "Suspended", "Deleted",
     "Unregistered".
    :type state: str or ~data_box_edge_management_client.models.SubscriptionState
    ...
    :type registered_features:
     list[~data_box_edge_management_client.models.SubscriptionRegisteredFeatures]
    """
...
class IoTRole(Role):
    ...
    :type compute_resource: ~data_box_edge_management_client.models.ComputeResource
    :param role_status: Role status. Possible values include: "Enabled", "Disabled".
    :type role_status: str or ~data_box_edge_management_client.models.RoleStatus
    """
...
class KubernetesClusterInfo(msrest.serialization.Model):
    ...
    :vartype etcd_info: ~data_box_edge_management_client.models.EtcdInfo
    :ivar nodes: Kubernetes cluster nodes.
    :vartype nodes: list[~data_box_edge_management_client.models.NodeInfo]
...
class KubernetesRole(Role):
    ...
    :ivar provisioning_state: State of Kubernetes deployment. Possible values include: "Invalid",
     "Creating", "Created", "Updating", "Reconfiguring", "Failed", "Deleting".
    :vartype provisioning_state: str or ~data_box_edge_management_client.models.KubernetesState
    :ivar host_platform_type: Platform where the runtime is hosted. Possible values include:
     "KubernetesCluster", "LinuxVM".
    :vartype host_platform_type: str or ~data_box_edge_management_client.models.HostPlatformType
    :param kubernetes_cluster_info: Kubernetes cluster configuration.
    :type kubernetes_cluster_info: ~data_box_edge_management_client.models.KubernetesClusterInfo
    :param kubernetes_role_resources: Kubernetes role resources.
    :type kubernetes_role_resources:
     ~data_box_edge_management_client.models.KubernetesRoleResources
    :param role_status: Role status. Possible values include: "Enabled", "Disabled".
    :type role_status: str or ~data_box_edge_management_client.models.RoleStatus
    """
...
class KubernetesRoleNetwork(msrest.serialization.Model):
    ...
    :vartype cni_config: ~data_box_edge_management_client.models.CniConfig
    :ivar load_balancer_config: Load balancer configuration.
    :vartype load_balancer_config: ~data_box_edge_management_client.models.LoadBalancerConfig
    """
...
class KubernetesRoleResources(msrest.serialization.Model):
    ...
    :type storage: ~data_box_edge_management_client.models.KubernetesRoleStorage
    :param compute: Required. Kubernetes role compute resource.
    :type compute: ~data_box_edge_management_client.models.KubernetesRoleCompute
    :ivar network: Kubernetes role network resource.
    :vartype network: ~data_box_edge_management_client.models.KubernetesRoleNetwork
    """
...
class KubernetesRoleStorage(msrest.serialization.Model):
    ...
    :vartype storage_classes:
     list[~data_box_edge_management_client.models.KubernetesRoleStorageClassInfo]
    :param endpoints: Mount points of shares in role(s).
    :type endpoints: list[~data_box_edge_management_client.models.MountPointMap]
    """
...
class KubernetesRoleStorageClassInfo(msrest.serialization.Model):
    ...
    :vartype posix_compliant: str or ~data_box_edge_management_client.models.PosixComplianceStatus
    """
...
class MetricConfiguration(msrest.serialization.Model):
    ...
    :type counter_sets: list[~data_box_edge_management_client.models.MetricCounterSet]
    """
...
class MetricCounter(msrest.serialization.Model):
    ...
    :type dimension_filter: list[~data_box_edge_management_client.models.MetricDimension]
    :param additional_dimensions: The additional dimensions to be added to metric.
    :type additional_dimensions: list[~data_box_edge_management_client.models.MetricDimension]
    """
...
class MetricCounterSet(msrest.serialization.Model):
    ...
    :type counters: list[~data_box_edge_management_client.models.MetricCounter]
    """
...
class MonitoringMetricConfiguration(ArmBaseModel):
    ...
    :type metric_configurations: list[~data_box_edge_management_client.models.MetricConfiguration]
    """
...
class MonitoringMetricConfigurationList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.MonitoringMetricConfiguration]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class NodeInfo(msrest.serialization.Model):
    ...
    :vartype type: str or ~data_box_edge_management_client.models.KubernetesNodeType
    :param ip_configuration: IP Configuration of the Kubernetes node.
    :type ip_configuration: list[~data_box_edge_management_client.models.KubernetesIpConfiguration]
    """
...
class ResourceIdentity(msrest.serialization.Model):
    ...
    :type type: str or ~data_box_edge_management_client.models.MsiIdentityType
...
class SystemData(msrest.serialization.Model):
    ...
    :type created_by_type: str or ~data_box_edge_management_client.models.CreatedByType
    ...
    :type last_modified_by_type: str or ~data_box_edge_management_client.models.CreatedByType
