...
def load_command_table(self, _):
    ...
    databoxedge_available_sku = CliCommandType(
        operations_tmpl='azext_databoxedge.vendored_sdks.databoxedge.operations._available_skus_operations#AvailableSku'
        'sOperations.{}',
        client_factory=cf_available_sku)
    with self.command_group('databoxedge available-sku', databoxedge_available_sku,
                            client_factory=cf_available_sku) as g:
    ...
    with self.command_group('databoxedge device', databoxedge_device, client_factory=cf_device) as g:
        ...
        g.custom_command('generate-certificate', 'databoxedge_device_generate_certificate')
        ...
        g.custom_command('update-extended-information', 'databoxedge_device_update_extended_information')
    ...
    from azext_databoxedge.generated._client_factory import cf_addon
    databoxedge_addon = CliCommandType(
        operations_tmpl='azext_databoxedge.vendored_sdks.databoxedge.operations._addons_operations#AddonsOperations.{}',
        client_factory=cf_addon)
    with self.command_group('databoxedge addon', databoxedge_addon, client_factory=cf_addon) as g:
        g.custom_command('list', 'databoxedge_addon_list')
        g.custom_show_command('show', 'databoxedge_addon_show')
        g.custom_command('create', 'databoxedge_addon_create', supports_no_wait=True)
        g.custom_command('update', 'databoxedge_addon_update', supports_no_wait=True)
        g.custom_command('delete', 'databoxedge_addon_delete', supports_no_wait=True, confirmation=True)
        g.custom_wait_command('wait', 'databoxedge_addon_show')

    from azext_databoxedge.generated._client_factory import cf_monitoring_config
    databoxedge_monitoring_config = CliCommandType(
        operations_tmpl='azext_databoxedge.vendored_sdks.databoxedge.operations._monitoring_config_operations#Monitorin'
        'gConfigOperations.{}',
        client_factory=cf_monitoring_config)
    with self.command_group('databoxedge monitoring-config', databoxedge_monitoring_config,
                            client_factory=cf_monitoring_config) as g:
        g.custom_command('list', 'databoxedge_monitoring_config_list')
        g.custom_show_command('show', 'databoxedge_monitoring_config_show')
        g.custom_command('create', 'databoxedge_monitoring_config_create', supports_no_wait=True)
        g.generic_update_command('update', setter_arg_name='monitoring_metric_configuration',
                                 setter_name='begin_create_or_update',
                                 custom_func_name='databoxedge_monitoring_config_update', supports_no_wait=True)
        g.custom_command('delete', 'databoxedge_monitoring_config_delete', supports_no_wait=True, confirmation=True)
        g.custom_wait_command('wait', 'databoxedge_monitoring_config_show')
