...
helps['databoxedge available-sku'] = """
    type: group
    short-summary: Manage available sku with databoxedge
"""
...
helps['databoxedge device create'] = """
    ...
    parameters:
      ...
      - name: --resource-move-details
        short-summary: "The details of the move operation on this resource."
        long-summary: |
            Usage: --resource-move-details operation-in-progress=XX operation-in-progress-lock-timeout-in-utc=XX

            operation-in-progress: Denotes whether move operation is in progress
            operation-in-progress-lock-timeout-in-utc: Denotes the timeout of the operation to finish
...
helps['databoxedge device update'] = """
    ...
    examples:
      - name: DataBoxEdgeDevicePatch
        text: |-
               az databoxedge device update --name "testedgedevice" --id "/subscriptions/0d44739e-0563-474f-97e7-24a0cd\
b23b29/resourceGroups/rapvs-rg/providers/Microsoft.AzureStack/linkedSubscriptions/ca014ddc-5cf2-45f8-b390-e901e4a0ae87"\
 --resource-group "GroupForEdgeAutomation"
"""
...
"AzureVM" --device-admin-password encryption-algorithm="AES256" encryption-cert-thumbprint="<encryptionThumprint>" \
...
helps['databoxedge device generate-certificate'] = """
    type: command
    short-summary: "Generates certificate for activation key."
    examples:
      - name: DownloadUpdatesPost
        text: |-
               az databoxedge device generate-certificate --name "testedgedevice" --resource-group \
"GroupForEdgeAutomation"
"""

helps['databoxedge device get-extended-information'] = """
    type: command
    short-summary: "Gets additional information for the specified Azure Stack Edge/Data Box Gateway device."
    examples:
...
helps['databoxedge device update-extended-information'] = """
    type: command
    short-summary: "Gets additional information for the specified Data Box Edge/Data Box Gateway device."
    examples:
      - name: GetUpdateExtendedInfo
        text: |-
               az databoxedge device update-extended-information --name "testedgedevice" --resource-group \
"GroupForEdgeAutomation"
"""
...
helps['databoxedge order list-dc-access-code'] = """
    ...
    examples:
      - name: GetDCAccessCode
        text: |-
               az databoxedge order list-dc-access-code --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation"
"""
...
helps['databoxedge addon'] = """
    type: group
    short-summary: Manage addon with databoxedge
"""

helps['databoxedge addon list'] = """
    type: command
    short-summary: "Lists all the addons configured in the role."
    examples:
      - name: RoleListAddOns
        text: |-
...
helps['databoxedge addon show'] = """
    type: command
    short-summary: "Gets a specific addon by name."
    examples:
      - name: GetAddOns
        text: |-
               az databoxedge addon show --name "arcName" --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "KubernetesRole"
"""

helps['databoxedge addon create'] = """
    type: command
    short-summary: "Create a addon."
    examples:
      - name: PutAddOns
        text: |-
               az databoxedge addon create --addon "{\\"kind\\":\\"ArcForKubernetes\\",\\"properties\\":{\\"resourceGro\
upName\\":\\"GroupForEdgeAutomation\\",\\"resourceLocation\\":\\"EastUS\\",\\"resourceName\\":\\"testedgedevice\\",\\"s\
ubscriptionId\\":\\"4385cf00-2d3a-425a-832f-f4285b1c9dce\\"}}" --name "arcName" --device-name "testedgedevice" \
--resource-group "GroupForEdgeAutomation" --role-name "KubernetesRole"
"""

helps['databoxedge addon update'] = """
    type: command
    short-summary: "Update a addon."
"""

helps['databoxedge addon delete'] = """
    type: command
    short-summary: "Deletes the addon on the device."
    examples:
      - name: DeleteAddOns
        text: |-
               az databoxedge addon delete --name "arcName" --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "KubernetesRole"
"""

helps['databoxedge addon wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the databoxedge addon is met.
    examples:
      - name: Pause executing next line of CLI script until the databoxedge addon is successfully created.
        text: |-
               az databoxedge addon wait --name "arcName" --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "KubernetesRole" --created
      - name: Pause executing next line of CLI script until the databoxedge addon is successfully updated.
        text: |-
               az databoxedge addon wait --name "arcName" --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "KubernetesRole" --updated
      - name: Pause executing next line of CLI script until the databoxedge addon is successfully deleted.
        text: |-
               az databoxedge addon wait --name "arcName" --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "KubernetesRole" --deleted
"""

helps['databoxedge monitoring-config'] = """
    type: group
    short-summary: Manage monitoring config with databoxedge
"""

helps['databoxedge monitoring-config list'] = """
    type: command
    short-summary: "Lists metric configurations in a role."
    examples:
      - name: ListMonitoringConfig
        text: |-
               az databoxedge monitoring-config list --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "testrole"
"""

helps['databoxedge monitoring-config show'] = """
    type: command
    short-summary: "Gets a  metric configuration of a role."
    examples:
      - name: GetMonitoringConfig
        text: |-
               az databoxedge monitoring-config show --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "testrole"
"""

helps['databoxedge monitoring-config create'] = """
    type: command
    short-summary: "Creates a new metric configuration or updates an existing one for a role."
    examples:
...
helps['databoxedge monitoring-config update'] = """
    type: command
    short-summary: "Update a new metric configuration or updates an existing one for a role."
"""

helps['databoxedge monitoring-config delete'] = """
    type: command
    short-summary: "deletes a new metric configuration for a role."
    examples:
      - name: DeleteMonitoringConfig
        text: |-
               az databoxedge monitoring-config delete --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "testrole"
"""

helps['databoxedge monitoring-config wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the databoxedge monitoring-config is met.
    examples:
      - name: Pause executing next line of CLI script until the databoxedge monitoring-config is successfully created.
        text: |-
               az databoxedge monitoring-config wait --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "testrole" --created
      - name: Pause executing next line of CLI script until the databoxedge monitoring-config is successfully updated.
        text: |-
               az databoxedge monitoring-config wait --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "testrole" --updated
      - name: Pause executing next line of CLI script until the databoxedge monitoring-config is successfully deleted.
        text: |-
               az databoxedge monitoring-config wait --device-name "testedgedevice" --resource-group \
"GroupForEdgeAutomation" --role-name "testrole" --deleted
"""
