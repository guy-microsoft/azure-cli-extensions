...
@try_manual
def step_device_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_list2(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge device list '
             '-g ""',
...
@try_manual
def step_device_show_network_setting(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_show_update_summary(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_update(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge device update '
             '--name "{myDevice}" '
             '--id "/subscriptions/{subscription_id}/resourceGroups/{rg_2}/providers/Microsoft.AzureStack/linkedSubscri'
             'ptions/ca014ddc-5cf2-45f8-b390-e901e4a0ae87" '
             '--resource-group "{rg}"',
             checks=checks)
...
@try_manual
def step_device_create_or_update_security_setting(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_download_update(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_get_extended_information(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /Devices/post/GetUpdateExtendedInfo
@try_manual
def step_device_update_extended_information(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge device update-extended-information '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
@try_manual
def step_device_install_update(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_scan_for_update(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_upload_certificate(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /Addons/put/PutAddOns
@try_manual
def step_addon_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge addon create '
             '--addon "{{\\"kind\\":\\"ArcForKubernetes\\",\\"properties\\":{{\\"resourceGroupName\\":\\"{rg}\\",\\"res'
             'ourceLocation\\":\\"EastUS\\",\\"resourceName\\":\\"{myDevice}\\",\\"subscriptionId\\":\\"4385cf00-2d3a-4'
             '25a-832f-f4285b1c9dce\\"}}}}" '
             '--name "{myAddon}" '
...
# EXAMPLE: /Addons/get/GetAddOns
@try_manual
def step_addon_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge addon show '
             '--name "{myAddon}" '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}" '
             '--role-name "{myRole2}"',
...
# EXAMPLE: /Addons/get/RoleListAddOns
@try_manual
def step_addon_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge addon list '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}" '
             '--role-name "{myRole}"',
             checks=checks)
...
# EXAMPLE: /Addons/delete/DeleteAddOns
@try_manual
def step_addon_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge addon delete -y '
             '--name "{myAddon}" '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}" '
             '--role-name "{myRole2}"',
...
@try_manual
def step_alert_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_alert_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /AvailableSkus/get/AvailableSkus
@try_manual
def step_available_sku_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge available-sku list',
             checks=checks)


# EXAMPLE: /BandwidthSchedules/put/BandwidthSchedulePut
@try_manual
def step_bandwidth_schedule_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_bandwidth_schedule_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_bandwidth_schedule_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_bandwidth_schedule_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_container_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_container_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_container_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_container_refresh(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_container_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_job_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /MonitoringConfig/put/PutMonitoringConfig
@try_manual
def step_monitoring_config_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge monitoring-config create '
             '--device-name "{myDevice}" '
             '--metric-configurations "[{{\\"counterSets\\":[{{\\"counters\\":[{{\\"name\\":\\"test\\"}}]}}],\\"mdmAcco'
             'unt\\":\\"test\\",\\"metricNameSpace\\":\\"test\\",\\"resourceId\\":\\"test\\"}}]" '
             '--resource-group "{rg}" '
             '--role-name "{myRole3}"',
             checks=checks)


# EXAMPLE: /MonitoringConfig/get/GetMonitoringConfig
@try_manual
def step_monitoring_config_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge monitoring-config show '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}" '
             '--role-name "{myRole3}"',
             checks=checks)
...
# EXAMPLE: /MonitoringConfig/get/ListMonitoringConfig
@try_manual
def step_monitoring_config_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge monitoring-config list '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}" '
             '--role-name "{myRole3}"',
             checks=checks)
...
# EXAMPLE: /MonitoringConfig/delete/DeleteMonitoringConfig
@try_manual
def step_monitoring_config_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge monitoring-config delete -y '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}" '
             '--role-name "{myRole3}"',
             checks=checks)
...
@try_manual
def step_node_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_operation_status_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_order_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_order_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_order_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /Orders/post/GetDCAccessCode
@try_manual
def step_order_list_dc_access_code(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge order list-dc-access-code '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
@try_manual
def step_order_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_role_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_storage_account_credentials_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_storage_account_credentials_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_share_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_share_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_share_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_share_refresh(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_share_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_storage_account_credentials_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_storage_account_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_storage_account_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_storage_account_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_trigger_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
    test.cmd('az databoxedge trigger create '
             ...
             'xEdgeDevices/{{myDevice}}/shares/{myShare}"',
             checks=checks)


# EXAMPLE: /Triggers/get/TriggerGet
@try_manual
def step_trigger_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_trigger_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_trigger_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_user_create(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_user_show(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_user_list(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_user_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_device_delete(test, rg_2, rg, rg_3, checks=None):
    if checks is None:
        checks = []
