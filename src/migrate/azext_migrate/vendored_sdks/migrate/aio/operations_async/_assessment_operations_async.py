...
class AssessmentOperations:
    ...
    async def create(
        ...
        reserved_instance: Union[str, "models.ReservedInstance"],
        azure_vm_families: List[Union[str, "models.AzureVmFamily"]],
        azure_disk_type: Union[str, "models.AzureDiskType"],
        vm_uptime: "models.VmUptime",
