...
class HyperVCollectorOperations(object):
    ...
    def list_by_project(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.HyperVCollectorList"
        ...
        :return: HyperVCollectorList, or the result of cls(response)
        :rtype: ~azure_migrate_v2.models.HyperVCollectorList
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        _collector_body = models.HyperVCollector(e_tag=e_tag, discovery_site_id=discovery_site_id, spn_details=spn_details)
        api_version = "2019-10-01"
        ...
        if _collector_body is not None:
            body_content = self._serialize.body(_collector_body, 'HyperVCollector')
        else:
            body_content = None
