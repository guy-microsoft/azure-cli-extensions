...
class AssessmentOperations(object):
    ...
    def list_by_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure_migrate_v2.models.AssessmentResultList
    ...
    def create(
        ...
        reserved_instance,  # type: Union[str, "models.ReservedInstance"]
        azure_vm_families,  # type: List[Union[str, "models.AzureVmFamily"]]
        azure_disk_type,  # type: Union[str, "models.AzureDiskType"]
        vm_uptime,  # type: "models.VmUptime"
        ...
        **kwargs  # type: Any
        ...
        _assessment = models.Assessment(e_tag=e_tag, azure_location=azure_location, azure_offer_code=azure_offer_code, azure_pricing_tier=azure_pricing_tier, azure_storage_redundancy=azure_storage_redundancy, scaling_factor=scaling_factor, percentile=percentile, time_range=time_range, stage=stage, currency=currency, azure_hybrid_use_benefit=azure_hybrid_use_benefit, discount_percentage=discount_percentage, sizing_criterion=sizing_criterion, reserved_instance=reserved_instance, azure_vm_families=azure_vm_families, azure_disk_type=azure_disk_type, vm_uptime=vm_uptime)
        api_version = "2019-10-01"
        ...
        if _assessment is not None:
            body_content = self._serialize.body(_assessment, 'Assessment')
        else:
            body_content = None
