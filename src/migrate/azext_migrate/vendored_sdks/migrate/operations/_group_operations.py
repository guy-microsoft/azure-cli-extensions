...
class GroupOperations(object):
    ...
    def list_by_project(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure_migrate_v2.models.GroupResultList
    ...
    def create(
        ...
        project_name,  # type: str
        group_name,  # type: str
        properties,  # type: "models.GroupProperties"
        ...
        **kwargs  # type: Any
        ...
        _group = models.Group(e_tag=e_tag, properties=properties)
        api_version = "2019-10-01"
        ...
        if _group is not None:
            body_content = self._serialize.body(_group, 'Group')
        else:
            body_content = None
    ...
    def update_machine(
        ...
        **kwargs  # type: Any
        ...
        _group_update_properties = models.UpdateGroupBody(e_tag=e_tag, properties=properties)
        api_version = "2019-10-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _group_update_properties is not None:
            body_content = self._serialize.body(_group_update_properties, 'UpdateGroupBody')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
