...
class JobOperations(object):
    ...
    def _create_initial(
        ...
        **kwargs  # type: Any
        ...
        _job_resource = models.JobResource(location=location, tags=tags, sku=sku, type=type, user_assigned_identities=user_assigned_identities, transfer_type=transfer_type, details=details, delivery_type=delivery_type, scheduled_date_time=scheduled_date_time)
        api_version = "2020-04-01"
    ...
    def _update_initial(
        ...
        type=None,  # type: Optional[str]
        user_assigned_identities=None,  # type: Optional[Dict[str, "models.UserAssignedIdentity"]]
        contact_details=None,  # type: Optional["models.ContactDetails"]
        shipping_address=None,  # type: Optional["models.ShippingAddress"]
        key_encryption_key=None,  # type: Optional["models.KeyEncryptionKey"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.JobResource"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.JobResource"]]
        ...
        _job_resource_update_parameter = models.JobResourceUpdateParameter(tags=tags, type=type, user_assigned_identities=user_assigned_identities, contact_details=contact_details, shipping_address=shipping_address, key_encryption_key=key_encryption_key)
        api_version = "2020-04-01"
        content_type = kwargs.pop("content_type", "application/json")
