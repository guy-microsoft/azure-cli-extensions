...
class JobResourceUpdateParameter(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'tenant_id': {'key': 'identity.tenantId', 'type': 'str'},
        'user_assigned_identities': {'key': 'identity.userAssignedIdentities', 'type': '{UserAssignedIdentity}'},
        'contact_details': {'key': 'properties.details.contactDetails', 'type': 'ContactDetails'},
        'shipping_address': {'key': 'properties.details.shippingAddress', 'type': 'ShippingAddress'},
        'key_encryption_key': {'key': 'properties.details.keyEncryptionKey', 'type': 'KeyEncryptionKey'},
    }
