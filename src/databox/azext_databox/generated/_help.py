...
helps['databox job update'] = """
    ...
    parameters:
      - name: --details-contact-details
        short-summary: "Contact details for notification and shipping."
        long-summary: |
            Usage: --details-contact-details contact-name=XX phone=XX phone-extension=XX mobile=XX email-list=XX \
notification-preference=XX
            ...
            notification-preference: Notification preference for a job stage.
...
state-or-province=XX country=XX postal-code=XX zip-extended-code=XX company-name=XX address-type=XX
    ...
    examples:
      - name: JobsPatch
        text: |-
               az databox job update --name "SdkJob952" --details-contact-details contact-name="Update Job" \
email-list="testing@microsoft.com" phone="1234567890" phone-extension="1234" --details-shipping-address \
address-type="Commercial" city="San Francisco" company-name="Microsoft" country="US" postal-code="94107" \
state-or-province="CA" street-address1="16 TOWNSEND ST" street-address2="Unit 1" --resource-group "SdkRg5154"
      - name: JobsPatchCmk
        text: |-
               az databox job update --name "SdkJob1735" --details-key-encryption-key "{\\"kekType\\":\\"CustomerManage\
d\\",\\"kekUrl\\":\\"https://sdkkeyvault.vault.azure.net/keys/SSDKEY/\\",\\"kekVaultResourceID\\":\\"/subscriptions/fa6\
8082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/providers/Microsoft.KeyVault/vaults/SDKKeyVault\\"}" \
--resource-group "SdkRg7937"
      - name: JobsPatchSystemAssignedToUserAssigned
        text: |-
               az databox job update --name "SdkJob2965" --identity-type "SystemAssigned,UserAssigned" \
--identity-user-assigned-identities "{\\"/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/pr\
oviders/Microsoft.ManagedIdentity/userAssignedIdentities/sdkIdentity\\":{}}" --details-key-encryption-key \
"{\\"identityProperties\\":{\\"type\\":\\"UserAssigned\\",\\"userAssigned\\":{\\"resourceId\\":\\"/subscriptions/fa6808\
2f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/providers/Microsoft.ManagedIdentity/userAssignedIdentities/sdkId\
entity\\"}},\\"kekType\\":\\"CustomerManaged\\",\\"kekUrl\\":\\"https://sdkkeyvault.vault.azure.net/keys/SSDKEY/\\",\\"\
kekVaultResourceID\\":\\"/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/providers/Microsof\
t.KeyVault/vaults/SDKKeyVault\\"}" --resource-group "SdkRg9765"
"""
