...
def databox_job_update(client,
    ...
    job_resource_update_parameter['details']['key_encryption_key']['kek_type'] = kek_type
    ...
    job_resource_update_parameter['identity']['type'] = resource_identity_type
