...
# Env setup_scenario
@try_manual
def setup_scenario(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13):
    pass


# Env cleanup_scenario
@try_manual
def cleanup_scenario(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13):
    pass
...
def call_scenario(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13):
    setup_scenario(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13)
    step_job_create(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[
    ...
    step_job_show(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[
        test.check("name", "{myJob}", case_sensitive=False),
        test.check("location", "westus", case_sensitive=False),
        test.check("transferType", "ImportToAzure", case_sensitive=False),
        test.check("sku.name", "DataBox", case_sensitive=False),
    ])
    step_job_list2(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[
        test.check('length(@)', 1),
    ])
    step_job_list(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[
        test.check('length(@)', 8),
    ])
    ...
    step_job_book_shipment_pick_up(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12,
                                   rg_13, checks=[])
    step_job_list_credentials(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13,
                              checks=[])
    step_job_cancel(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[])
    step_job_update(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[
        test.check("name", "{myJob}", case_sensitive=False),
    ])
    # STEP NOT FOUND: ServiceRegionConfiguration
    step_service_validate_address(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13,
                                  checks=[])
    # STEP NOT FOUND: ServiceValidateInputs
    step_service_list_available_sku_by_resource_group(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10,
                                                      rg_11, rg_12, rg_13, checks=[])
    step_job_delete(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13, checks=[])
    cleanup_scenario(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13)
...
class DataboxScenarioTest(ScenarioTest):
    ...
    def test_databox_Scenario(self, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13):
