...
def step_jobspatch(test, rg_4, rg_5, rg_8, rg, rg_2, rg_3, rg_6, rg_7, rg_9, rg_10, rg_11, rg_12, rg_13):
    test.cmd('az databox job update '
             '--name "{myJob}" '
             '--details-contact-details contact-name="Update Job" email-list="testing@microsoft.com" '
             'phone="1234567890" phone-extension="1234" '
             '--details-shipping-address address-type="Commercial" city="San Francisco" company-name="Microsoft" '
             'country="US" postal-code="94107" state-or-province="CA" street-address1="16 TOWNSEND ST" '
             'street-address2="Unit 1" '
             '--resource-group "{rg}"',
             checks=[
                 test.check("name", "{myJob}", case_sensitive=False),
             ])
