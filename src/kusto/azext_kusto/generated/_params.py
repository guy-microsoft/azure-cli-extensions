...
def load_arguments(self, _):
    ...
    with self.argument_context('kusto data-connection event-grid data-connection-validation-async') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', help='The name of the database in the Kusto cluster.', id_part='child_name_1')
        c.argument('data_connection_name', options_list=['--name', '-n'], help='The name of the data connection.')
    ...
    with self.argument_context('kusto data-connection event-hub data-connection-validation-async') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', help='The name of the database in the Kusto cluster.', id_part='child_name_1')
        c.argument('data_connection_name', options_list=['--name', '-n'], help='The name of the data connection.')
    ...
    with self.argument_context('kusto data-connection iot-hub data-connection-validation-async') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', help='The name of the database in the Kusto cluster.', id_part='child_name_1')
        c.argument('data_connection_name', options_list=['--name', '-n'], help='The name of the data connection.')
