...
def kusto_data_connection_event_grid_data_connection_validation_async(client,
                                                                      resource_group_name,
                                                                      cluster_name,
                                                                      database_name,
                                                                      data_connection_name=None,
    ...
    properties['blob_storage_event_type'] = blob_storage_event_type
    return sdk_no_wait(no_wait,
                       client.begin_data_connection_validation_async,
                       resource_group_name=resource_group_name,
                       cluster_name=cluster_name,
                       database_name=database_name,
                       data_connection_name=data_connection_name,
...
def kusto_data_connection_event_hub_data_connection_validation_async(client,
                                                                     resource_group_name,
                                                                     cluster_name,
                                                                     database_name,
                                                                     data_connection_name=None,
...
def kusto_data_connection_iot_hub_data_connection_validation_async(client,
                                                                   resource_group_name,
                                                                   cluster_name,
                                                                   database_name,
                                                                   data_connection_name=None,
