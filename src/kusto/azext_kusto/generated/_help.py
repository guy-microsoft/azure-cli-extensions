...
helps['kusto cluster create'] = """
    ...
    parameters:
      ...
      - name: --language-extensions-value
        ...
        long-summary: |
            Usage: --language-extensions-value language-extension-name=XX

            language-extension-name: The language extension name.

            Multiple actions can be specified by using more than one --language-extensions-value argument.
    examples:
...
ummy.keyvault.com" key-version="keyVersion" --sku name="Standard_L8s" capacity=2 tier="Standard" --resource-group "kust\
orptest"
"""
...
sourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterLeader" --database-name "db1" --default-princip\
als-modification-kind "Union" --resource-group "kustorptest"
"""
