...
helps['kusto data-connection event-grid data-connection-validation-async'] = """
    type: command
    short-summary: Checks that the data connection parameters are valid.
"""
...
helps['kusto data-connection event-hub data-connection-validation-async'] = """
    type: command
    short-summary: Checks that the data connection parameters are valid.
    examples:
      - name: KustoDataConnectionValidation
        text: |-
               az kusto data-connection event-hub data-connection-validation-async --cluster-name "kustoclusterrptest4"\
 --database-name "KustoDatabase8" --name "DataConnections8" --consumer-group "testConsumerGroup1" --event-hub-resource-\
id "/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.EventHub/namespa\
ces/eventhubTestns1/eventhubs/eventhubTest1" --resource-group "kustorptest"
"""
...
helps['kusto data-connection iot-hub data-connection-validation-async'] = """
    type: command
    short-summary: Checks that the data connection parameters are valid.
"""
