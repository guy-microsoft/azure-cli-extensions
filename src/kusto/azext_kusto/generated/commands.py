...
def load_command_table(self, _):
    ...
    with self.command_group('kusto data-connection', kusto_data_connection, client_factory=cf_data_connection,
        ...
        g.custom_command('event-grid data-connection-validation', 'kusto_data_connection_event_grid_data_connection_val'
                         'idation')
        g.custom_command('event-grid data-connection-validation-async', 'kusto_data_connection_event_grid_data_connecti'
                         'on_validation_async', supports_no_wait=True)
        g.custom_command('event-hub data-connection-validation', 'kusto_data_connection_event_hub_data_connection_valid'
                         'ation')
        g.custom_command('event-hub data-connection-validation-async', 'kusto_data_connection_event_hub_data_connection'
                         '_validation_async', supports_no_wait=True)
        g.custom_command('iot-hub data-connection-validation', 'kusto_data_connection_iot_hub_data_connection_validatio'
                         'n')
        g.custom_command('iot-hub data-connection-validation-async', 'kusto_data_connection_iot_hub_data_connection_val'
                         'idation_async', supports_no_wait=True)
