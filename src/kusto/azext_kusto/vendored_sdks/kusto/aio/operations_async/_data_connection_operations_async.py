...
class DataConnectionOperations:
    ...
    async def _data_connection_validation_async_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        database_name: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self._data_connection_validation_async_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
            'databaseName': self._serialize.url("database_name", database_name, 'str'),
        ...
        return deserialized
    _data_connection_validation_async_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/dataConnectionValidationAsync'}  # type: ignore

    async def data_connection_validation_async(
        self,
        resource_group_name: str,
        cluster_name: str,
        database_name: str,
        ...
        **kwargs
        ...
        raw_result = await self._data_connection_validation_async_initial(
    ...
    data_connection_validation_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/dataConnectionValidationAsync'}  # type: ignore
