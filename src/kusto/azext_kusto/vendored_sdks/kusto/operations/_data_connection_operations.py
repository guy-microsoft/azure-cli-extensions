...
class DataConnectionOperations(object):
    ...
    def begin_data_connection_validation_async(
        self,
        resource_group_name,  # type: str
        cluster_name,  # type: str
        database_name,  # type: str
    ...
    begin_data_connection_validation_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/dataConnectionValidationAsync'}  # type: ignore
