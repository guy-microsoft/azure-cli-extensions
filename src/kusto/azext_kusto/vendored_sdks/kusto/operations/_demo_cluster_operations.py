...
class DemoClusterOperations(object):
    """DemoClusterOperations operations.
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/democlusters/{clusterName}'}
