...
class AgentPoolOperations(object):
    """AgentPoolOperations operations.
    ...
    def _create_initial(
        ...
        os=None,  # type: Optional[Union[str, "models.Os"]]
        virtual_network_subnet_resource_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AgentPool"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AgentPool"]
    ...
    def begin_create(
     ...
     machine.
        ...
        :rtype: ~azure.core.polling.LROPoller[~container_registry_management_client.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.AgentPoolListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
