...
class ImportPipelineOperations(object):
    """ImportPipelineOperations operations.
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        import_pipeline_name,  # type: str
        source=None,  # type: Optional["models.ImportPipelineSourceProperties"]
        options=None,  # type: Optional[List[Union[str, "models.PipelineOptions"]]]
        status=None,  # type: Optional[Union[str, "models.TriggerStatus"]]
    ...
    def begin_create(
     ...
     user identity
        ...
        :rtype: ~azure.core.polling.LROPoller[~container_registry_management_client.models.ImportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.ImportPipelineListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
