...
class WebhookOperations(object):
    ...
    def _create_initial(
        ...
        service_uri=None,  # type: Optional[str]
        custom_headers=None,  # type: Optional[Dict[str, str]]
        status=None,  # type: Optional[Union[str, "models.WebhookStatus"]]
        scope=None,  # type: Optional[str]
        actions=None,  # type: Optional[List[Union[str, "models.WebhookAction"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Webhook"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Webhook"]
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.WebhookListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_event(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.EventListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
