...
class ScopeMapOperations(object):
    """ScopeMapOperations operations.
    ...
    def _create_initial(
        ...
        actions=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ScopeMap"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ScopeMap"]
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.ScopeMapListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
