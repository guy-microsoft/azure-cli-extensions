...
class PipelineRunOperations(object):
    ...
    def _create_initial(
        ...
        pipeline_resource_id=None,  # type: Optional[str]
        artifacts=None,  # type: Optional[List[str]]
        source=None,  # type: Optional["models.PipelineRunSourceProperties"]
        target=None,  # type: Optional["models.PipelineRunTargetProperties"]
        catalog_digest=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.PipelineRun"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PipelineRun"]
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.PipelineRunListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
