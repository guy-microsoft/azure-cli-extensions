...
class ExportPipelineOperations(object):
    """ExportPipelineOperations operations.
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        export_pipeline_name,  # type: str
        target=None,  # type: Optional["models.ExportPipelineTargetProperties"]
    ...
    def begin_create(
     ...
     user identity
        ...
        :rtype: ~azure.core.polling.LROPoller[~container_registry_management_client.models.ExportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_registry_management_client.models.ExportPipelineListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
