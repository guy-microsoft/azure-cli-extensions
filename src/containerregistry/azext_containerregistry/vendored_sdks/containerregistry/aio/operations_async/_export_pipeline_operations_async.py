...
class ExportPipelineOperations:
    """ExportPipelineOperations async operations.
    ...
    async def _create_initial(
        ...
        registry_name: str,
        export_pipeline_name: str,
        target: Optional["models.ExportPipelineTargetProperties"] = None,
        ...
        **kwargs
        ...
        _export_pipeline_create_parameters = models.ExportPipeline(target=target, options=options, principal_id=principal_id, tenant_id=tenant_id, type_identity_type=type, user_assigned_identities=user_assigned_identities)
        api_version = "2019-12-01-preview"
        ...
        body_content = self._serialize.body(_export_pipeline_create_parameters, 'ExportPipeline')
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/exportPipelines/{exportPipelineName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/exportPipelines/{exportPipelineName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.ExportPipelineListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
