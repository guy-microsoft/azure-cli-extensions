...
class AgentPoolOperations:
    """AgentPoolOperations async operations.
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~container_registry_management_client.models.AgentPool
    ...
    async def _create_initial(
        ...
        os: Optional[Union[str, "models.Os"]] = None,
        ...
        **kwargs
        ...
        _agent_pool = models.AgentPool(location=location, tags=tags, count=count, tier=tier, os=os, virtual_network_subnet_resource_id=virtual_network_subnet_resource_id)
        api_version = "2019-06-01-preview"
        ...
        body_content = self._serialize.body(_agent_pool, 'AgentPool')
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/agentPools/{agentPoolName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/agentPools/{agentPoolName}'}  # type: ignore
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        _update_parameters = models.AgentPoolUpdateParameters(tags=tags, count=count)
        api_version = "2019-06-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_update_parameters, 'AgentPoolUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    async def update(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/agentPools/{agentPoolName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.AgentPoolListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_queue_status(
        ...
        **kwargs
        ...
        :rtype: ~container_registry_management_client.models.AgentPoolQueueStatus
        :raises: ~azure.core.exceptions.HttpResponseError
        """
