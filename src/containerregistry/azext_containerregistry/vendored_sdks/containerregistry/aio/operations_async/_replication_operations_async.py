...
class ReplicationOperations:
    """ReplicationOperations async operations.
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/replications/{replicationName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/replications/{replicationName}'}  # type: ignore
    ...
    async def update(
     ...
     however its data will continue to be synced with other replications.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/replications/{replicationName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.ReplicationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
