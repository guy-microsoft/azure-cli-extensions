...
class WebhookOperations:
    ...
    async def _create_initial(
        ...
        status: Optional[Union[str, "models.WebhookStatus"]] = None,
        scope: Optional[str] = None,
        actions: Optional[List[Union[str, "models.WebhookAction"]]] = None,
        **kwargs
    ) -> "models.Webhook":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Webhook"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        ...
        _webhook_create_parameters = models.WebhookCreateParameters(tags=tags, location=location, service_uri=service_uri, custom_headers=custom_headers, status=status, scope=scope, actions=actions)
        api_version = "2019-12-01-preview"
        ...
        body_content = self._serialize.body(_webhook_create_parameters, 'WebhookCreateParameters')
    ...
    async def create(
     ...
     belongs.
        ...
        :param webhook_name: The name of the webhook.
        :type webhook_name: str
        :param location: The location of the webhook. This cannot be changed after the resource is
     created.
        :type location: str
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/webhooks/{webhookName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/webhooks/{webhookName}'}  # type: ignore
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        _webhook_update_parameters = models.WebhookUpdateParameters(tags=tags, service_uri=service_uri, custom_headers=custom_headers, status=status, scope=scope, actions=actions)
        api_version = "2019-12-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_webhook_update_parameters, 'WebhookUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    async def update(
     ...
     'foo' is equivalent to 'foo:latest'. Empty means all events.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/webhooks/{webhookName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.WebhookListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_event(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.EventListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_event.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/webhooks/{webhookName}/listEvents'}  # type: ignore
