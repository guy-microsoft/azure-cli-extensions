...
class PrivateEndpointConnectionOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        _private_endpoint_connection = models.PrivateEndpointConnection(private_link_service_connection_state=private_link_service_connection_state, id_properties_private_endpoint_id=id)
        api_version = "2019-12-01-preview"
    ...
    async def create_or_update(
     ...
     the connection between service consumer and provider.
        :type private_link_service_connection_state: ~container_registry_management_client.models.PrivateLinkServiceConnectionState
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/privateEndpointConnections/{privateEndpointConnectionName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/privateEndpointConnections/{privateEndpointConnectionName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.PrivateEndpointConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
