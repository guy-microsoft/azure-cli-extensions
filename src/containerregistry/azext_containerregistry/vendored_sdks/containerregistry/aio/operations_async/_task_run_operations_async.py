...
class TaskRunOperations:
    """TaskRunOperations async operations.
    ...
    async def _create_initial(
        ...
        run_request: Optional["models.RunRequest"] = None,
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/taskRuns/{taskRunName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/taskRuns/{taskRunName}'}  # type: ignore
    ...
    async def update(
     ...
     user identity
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/taskRuns/{taskRunName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.TaskRunListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
