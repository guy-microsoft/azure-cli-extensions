...
class ImportPipelineOperations:
    """ImportPipelineOperations async operations.
    ...
    async def _create_initial(
        ...
        registry_name: str,
        import_pipeline_name: str,
        source: Optional["models.ImportPipelineSourceProperties"] = None,
        options: Optional[List[Union[str, "models.PipelineOptions"]]] = None,
        status: Optional[Union[str, "models.TriggerStatus"]] = None,
        ...
        **kwargs
        ...
        _import_pipeline_create_parameters = models.ImportPipeline(source=source, options=options, status=status, principal_id=principal_id, tenant_id=tenant_id, type_identity_type=type, user_assigned_identities=user_assigned_identities)
        api_version = "2019-12-01-preview"
        ...
        body_content = self._serialize.body(_import_pipeline_create_parameters, 'ImportPipeline')
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/importPipelines/{importPipelineName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/importPipelines/{importPipelineName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.ImportPipelineListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
