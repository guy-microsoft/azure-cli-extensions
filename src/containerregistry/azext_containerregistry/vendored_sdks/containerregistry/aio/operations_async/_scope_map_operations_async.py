...
class ScopeMapOperations:
    """ScopeMapOperations async operations.
    ...
    async def _create_initial(
        ...
        **kwargs
        ...
        _scope_map_create_parameters = models.ScopeMap(description=description, actions=actions)
        api_version = "2019-05-01-preview"
        ...
        body_content = self._serialize.body(_scope_map_create_parameters, 'ScopeMap')
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}'}  # type: ignore
    ...
    async def delete(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}'}  # type: ignore
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        _scope_map_update_parameters = models.ScopeMapUpdateParameters(description=description, actions=actions)
        api_version = "2019-05-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_scope_map_update_parameters, 'ScopeMapUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    async def update(
     ...
     belongs.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}'}  # type: ignore
    ...
    def list(
     ...
     belongs.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_registry_management_client.models.ScopeMapListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
