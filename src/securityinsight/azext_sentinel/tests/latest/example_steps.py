...
@try_manual
def step_alert_rule_create4(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az sentinel alert-rule create '
...
@try_manual
def step_alert_rule_show_action(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az sentinel alert-rule show-action '
             '--action-id "912bec42-cb66-4c03-ac63-1761b6898c3e" '
             '--resource-group "{rg}" '
             '--rule-id "73e01a99-5cd7-4139-a149-9f2736ff2ab5" '
             '--workspace-name "myWorkspace"',
...
@try_manual
def step_alert_rule_delete2(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az sentinel alert-rule delete -y '
             '--resource-group "{rg}" '
...
@try_manual
def step_incident_comment_delete(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az sentinel incident-comment delete -y '
             '--incident-comment-id "4bb36b7b-26ff-4d1c-9cbe-0d8ab3da0014" '
             '--incident-id "73e01a98-5cd7-4139-a149-9f2736ff2ab5" '
             '--resource-group "{rg}" '
             '--workspace-name "myWorkspace"',
             checks=checks)
