...
from .example_steps import step_alert_rule_show_action
from .example_steps import step_alert_rule_delete
from .example_steps import step_alert_rule_delete2
...
def call_scenario(test, rg):
    ...
    step_alert_rule_create4(test, rg, checks=[])
    ...
    step_alert_rule_show_action(test, rg, checks=[])
    step_alert_rule_delete(test, rg, checks=[])
    step_alert_rule_delete2(test, rg, checks=[])
    ...
    step_incident_comment_delete(test, rg, checks=[])
