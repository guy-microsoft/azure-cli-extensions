...
def sentinel_alert_rule_show_action(client,
                                    resource_group_name,
                                    workspace_name,
                                    rule_id,
                                    action_id):
...
def sentinel_incident_comment_create(client,
    ...
    return client.create_or_update_comment(resource_group_name=resource_group_name,
                                           workspace_name=workspace_name,
                                           incident_id=incident_id,
                                           incident_comment_id=incident_comment_id,
...
def sentinel_incident_comment_delete(client,
                                     ...
                                     incident_id,
                                     incident_comment_id):
    return client.delete_comment(resource_group_name=resource_group_name,
                                 workspace_name=workspace_name,
                                 incident_id=incident_id,
                                 incident_comment_id=incident_comment_id)
