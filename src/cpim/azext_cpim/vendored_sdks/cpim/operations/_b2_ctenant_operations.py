...
class B2CTenantOperations(object):
    """B2CTenantOperations operations.
    ...
    def update(
        ...
        billing_type=None,  # type: Optional[Union[str, "models.BillingType"]]
        name=None,  # type: Optional[Union[str, "models.B2CResourceSkuName"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.B2CTenantResource"
        ...
        update_tenant_request_body = models.B2CTenantUpdateRequest(tags=tags, tenant_id=tenant_id, billing_type=billing_type, name=name)
        api_version = "2019-01-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _create_initial(
        ...
        properties=None,  # type: Optional["models.CreateTenantRequestBodyProperties"]
        tags=None,  # type: Optional[Dict[str, str]]
        name=None,  # type: Optional[Union[str, "models.B2CResourceSkuName"]]
        **kwargs  # type: Any
    ):
        ...
        create_tenant_request_body = models.CreateTenantRequestBody(location=location, properties=properties, tags=tags, name=name)
        api_version = "2019-01-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :param resource_name: The initial domain name of the B2C tenant.
        :type resource_name: str
        :param location: The location in which the resource is hosted and data resides. Refer to `this
         documentation <https://aka.ms/B2CDataResidency>`_ to see valid data residency locations. Please
         choose one of 'United States', 'Europe', and 'Asia Pacific'.
        :type location: str
        :param properties:
        :type properties: ~$(python-base-namespace).v2019_01_01_preview.models.CreateTenantRequestBodyProperties
        :param tags: Resource Tags.
        :type tags: dict[str, str]
        :param name: The name of the SKU for the tenant.
        :type name: str or ~$(python-base-namespace).v2019_01_01_preview.models.B2CResourceSkuName
