...
class DataSet(ProxyDto):
    ...
    sub-classes are: AdlsGen1FileDataSet, AdlsGen1FolderDataSet, AdlsGen2FileDataSet, AdlsGen2FileSystemDataSet, AdlsGen2FolderDataSet, BlobDataSet, BlobFolderDataSet, BlobContainerDataSet, KustoClusterDataSet, KustoDatabaseDataSet, SqlDBTableDataSet, SqlDwTableDataSet, StorageAccountDataSet.
    ...
    :param kind: Required. Kind of data set.Constant filled by server.  Possible values include:
     ...
     "AdlsGen1Folder", "AdlsGen1File", "StorageAccount", "KustoCluster", "KustoDatabase",
    ...
    _subtype_map = {
        'kind': {'AdlsGen1File': 'AdlsGen1FileDataSet', 'AdlsGen1Folder': 'AdlsGen1FolderDataSet', 'AdlsGen2File': 'AdlsGen2FileDataSet', 'AdlsGen2FileSystem': 'AdlsGen2FileSystemDataSet', 'AdlsGen2Folder': 'AdlsGen2FolderDataSet', 'Blob': 'BlobDataSet', 'BlobFolder': 'BlobFolderDataSet', 'Container': 'BlobContainerDataSet', 'KustoCluster': 'KustoClusterDataSet', 'KustoDatabase': 'KustoDatabaseDataSet', 'SqlDBTable': 'SqlDBTableDataSet', 'SqlDWTable': 'SqlDwTableDataSet', 'StorageAccount': 'StorageAccountDataSet'}
    }
...
class DataSetMapping(ProxyDto):
    ...
    :param kind: Required. Kind of data set mapping.Constant filled by server.  Possible values
     ...
     "AdlsGen2File", "AdlsGen1Folder", "AdlsGen1File", "StorageAccount", "KustoCluster",
     "KustoDatabase", "SqlDBTable", "SqlDWTable", "ScheduleBased".
    :type kind: str or ~azure.mgmt.datashare.models.Kind
    """
...
class ConsumerSourceDataSet(ProxyDto):
    ...
    :ivar data_set_type: Type of data set. Possible values include: "Blob", "Container",
     ...
     "AdlsGen1File", "StorageAccount", "KustoCluster", "KustoDatabase", "SqlDBTable", "SqlDWTable".
...
class StorageAccountDataSet(DataSet):
    ...
    :param storage_account_resource_id: Required. Resource id of the storage account.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.storage_account_resource_id = kwargs['storage_account_resource_id']
...
class StorageAccountDataSetMapping(DataSetMapping):
    ...
    :ivar provisioning_state: Provisioning state of the data set mapping. Possible values include:
     "Succeeded", "Creating", "Deleting", "Moving", "Failed".
    :vartype provisioning_state: str or ~azure.mgmt.datashare.models.ProvisioningState
    :param storage_account_resource_id: Required. Resource id of the sink storage account.
    :type storage_account_resource_id: str
    """
