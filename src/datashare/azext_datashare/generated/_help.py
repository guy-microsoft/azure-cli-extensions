...
e-group "SampleResourceGroup" --share-name "Share1"
      - name: DataSets_StorageAccount_Create
        text: |-
               az datashare data-set create --account-name "Account1" --storage-account-data-set paths={"consumerPath":\
"/samplefolder1","containerName":"container1","providerPath":"samplefile.txt"} storage-account-resource-id="/subscripti\
ons/0f3dcfc3-18f8-4099-b381-8353e19d43a7/resourceGroups/resourceGroup1/providers/Microsoft.Storage/storageAccounts/stor\
ageAccount1" --data-set-name "Dataset1" --resource-group "SampleResourceGroup" --share-name "Share1"
"""
...
-subscription-name "ShareSubscription1"
      - name: DataSetMappings_StorageAccount_Create
        text: |-
               az datashare data-set-mapping create --account-name "Account1" --storage-account-data-set-mapping contai\
ner-name="Container1" data-set-id="a08f184b-0567-4b11-ba22-a1199336d226" storage-account-resource-id="/subscriptions/43\
3a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.Storage/storageaccounts/stora\
geaccount1" --data-set-mapping-name "DatasetMapping1" --resource-group "SampleResourceGroup" --share-subscription-name \
"ShareSubscription1"
"""
