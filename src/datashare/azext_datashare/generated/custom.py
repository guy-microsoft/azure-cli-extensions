...
def datashare_data_set_create(cmd, client,
    ...
    if storage_account_data_set is not None:
        all_data_set.append(storage_account_data_set)
    if len(all_data_set) > 1:
        raise CLIError('at most one of  blob_data_set, blob_folder_data_set, blob_container_data_set, adls_gen2_file_da'
                       ...
                       ' sql_d_b_table_data_set, storage_account_data_set is needed for data_set!')
    if len(all_data_set) != 1:
        raise CLIError('data_set is required. but none of blob_data_set, blob_folder_data_set, blob_container_data_set,'
                       ...
                       'dw_table_data_set, sql_d_b_table_data_set, storage_account_data_set is provided!')
...
def datashare_data_set_mapping_create(cmd, client,
                                      ...
                                      storage_account_data_set_mapping=None):
    ...
    if storage_account_data_set_mapping is not None:
        all_data_set_mapping.append(storage_account_data_set_mapping)
    if len(all_data_set_mapping) > 1:
        raise CLIError('at most one of  blob_data_set_mapping, blob_folder_data_set_mapping, blob_container_data_set_ma'
                       ...
                       'le_data_set_mapping, sql_d_b_table_data_set_mapping, storage_account_data_set_mapping is needed'
                       ' for data_set_mapping!')
    if len(all_data_set_mapping) != 1:
        raise CLIError('data_set_mapping is required. but none of blob_data_set_mapping, blob_folder_data_set_mapping, '
                       ...
                       'ta_set_mapping, sql_dw_table_data_set_mapping, sql_d_b_table_data_set_mapping, storage_account_'
                       'data_set_mapping is provided!')
