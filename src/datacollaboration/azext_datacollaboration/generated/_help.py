...
helps['datacollaboration proposal revoke'] = """
    ...
    examples:
      - name: Proposals_Revoke
        text: |-
               az datacollaboration proposal revoke --name "Proposal1" --resource-group "SampleResourceGroup" --workspa\
ce-name "Workspace1"
"""
...
helps['datacollaboration data-asset-reference create'] = """
 ...
 "d164252e-2909-4718-a91e-315195c54b09" --proposal-name "Proposal1" --reference-name "DataAssetReference1" --resource-g\
roup "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration data-asset-reference update'] = """
    ...
    examples:
      - name: DataAssetReferences_CreateOrUpdate
        text: |-
               az datacollaboration data-asset-reference update --description "Reference to DataAsset1" --data-asset-id\
 "d164252e-2909-4718-a91e-315195c54b09" --proposal-name "Proposal1" --reference-name "DataAssetReference1" --resource-g\
roup "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration data-asset-reference resolve'] = """
    ...
    examples:
      - name: DataAssetReferences_Resolve
        text: |-
               az datacollaboration data-asset-reference resolve --proposal-name "Proposal1" --reference-name "DataAsse\
tReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
0c87-4671-bc4c-a6d9f1228948" --resource-type "DataAssetReference" --subject-id "a415f518-e721-4852-84de-8b139f92b933" -\
-name "Entitlement1" --proposal-name "Proposal1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration script-reference resolve'] = """
    ...
    examples:
      - name: ScriptReferences_Resolve
        text: |-
               az datacollaboration script-reference resolve --proposal-name "Proposal1" --reference-name "ScriptRefere\
nce1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""
