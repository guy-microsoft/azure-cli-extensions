...
helps['datacollaboration pipeline-step create'] = """
    ...
    parameters:
      - name: --synapse-spark-pipeline-step
        ...
        long-summary: |
            Usage: --synapse-spark-pipeline-step cluster-size=XX dependencies=XX script-id=XX script-revision=XX \
script-sink-bindings=XX script-source-bindings=XX kind=XX
...
cluster-size=2 dependencies="PipelineStep0" script-id="284878c1-deb7-440a-9f87-28b6e58242a3" script-revision=1 \
script-sink-bindings={"dataAssetId":"2f5a9076-3372-4282-b52d-a382382930ee","key":"sink1"} \
...
script-source-bindings={"dataAssetId":"2aa367d4-839c-468c-95b9-f3e63c628111","key":"source2"} --name "PipelineStep1" \
--resource-group "SampleResourceGroup" --workspace-name "Workspace1"
...
helps['datacollaboration participant'] = """
    type: group
    short-summary: datacollaboration participant
"""
...
helps['datacollaboration script-reference create'] = """
    type: command
    short-summary: "Create or update a ScriptReference in a Proposal"
    examples:
...
helps['datacollaboration resource-reference'] = """
    type: group
    short-summary: datacollaboration resource-reference
"""
