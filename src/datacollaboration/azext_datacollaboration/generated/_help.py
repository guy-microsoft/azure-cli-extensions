...
helps['datacollaboration consumer-invitation'] = """
    type: group
    short-summary: Manage consumer invitation with datacollaboration
"""
...
helps['datacollaboration consumer-invitation reject-invitation'] = """
    ...
    examples:
      - name: ConsumerInvitations_RejectInvitation
        text: |-
               az datacollaboration consumer-invitation reject-invitation --invitation-id \
"dfbbc788-19eb-4607-a5a1-c74181bfff03" --location "East US 2"
"""

helps['datacollaboration workspace'] = """
    type: group
    short-summary: Manage workspace with datacollaboration
"""

helps['datacollaboration workspace list'] = """
    type: command
    short-summary: "List Workspaces in ResourceGroup And List Workspaces in Subscription."
    examples:
      - name: Workspaces_ListByResourceGroup
        text: |-
               az datacollaboration workspace list --resource-group "SampleResourceGroup"
      - name: Workspaces_ListBySubscription
        text: |-
...
helps['datacollaboration workspace create'] = """
    type: command
    short-summary: "Create an workspace."
    examples:
...
helps['datacollaboration workspace wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration workspace is successfully created.
        text: |-
               az datacollaboration workspace wait --resource-group "SampleResourceGroup" --name "Workspace1" \
--created
...
helps['datacollaboration constrained-resource'] = """
    type: group
    short-summary: Manage constrained resource with datacollaboration
"""

helps['datacollaboration constrained-resource list'] = """
    type: command
    short-summary: "List constrained resources in a Workspace."
    examples:
      - name: ConstrainedResources_ListByWorkspace
        text: |-
               az datacollaboration constrained-resource list --resource-group "SampleResourceGroup" --workspace-name \
"Workspace1"
"""

helps['datacollaboration constrained-resource show'] = """
    type: command
    short-summary: "Get a ConstrainedResource in a Workspace."
    examples:
      - name: ConstrainedResources_Get
        text: |-
               az datacollaboration constrained-resource show --name "SynapseSparkPool1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration constrained-resource create'] = """
    type: command
    short-summary: "Create a constrained resource in a Workspace."
    examples:
      - name: ConstrainedResources_CreateOrUpdate
        text: |-
               az datacollaboration constrained-resource create --constrained-resource "{\\"kind\\":\\"SynapseSparkPool\
\\",\\"properties\\":{\\"autoPause\\":{\\"delayInMinutes\\":15,\\"enabled\\":true},\\"autoScale\\":{\\"enabled\\":true,\
\\"maxNodeCount\\":50,\\"minNodeCount\\":3},\\"nodeCount\\":4,\\"nodeSize\\":\\"Medium\\",\\"nodeSizeFamily\\":\\"Memor\
yOptimized\\",\\"sparkVersion\\":\\"2.4\\"}}" --name "SynapseSparkPool1" --resource-group "SampleResourceGroup" \
--workspace-name "Workspace1"
      - name: ConstrainedResources_SynapseSparkPool_CreateOrUpdate
        text: |-
               az datacollaboration constrained-resource create --constrained-resource "{\\"kind\\":\\"SynapseSparkPool\
\\",\\"properties\\":{\\"autoPause\\":{\\"delayInMinutes\\":15,\\"enabled\\":true},\\"autoScale\\":{\\"enabled\\":true,\
\\"maxNodeCount\\":50,\\"minNodeCount\\":3},\\"nodeCount\\":4,\\"nodeSize\\":\\"Medium\\",\\"nodeSizeFamily\\":\\"Memor\
...
helps['datacollaboration constrained-resource update'] = """
    type: command
    short-summary: "Update a constrained resource in a Workspace."
"""

helps['datacollaboration constrained-resource delete'] = """
    type: command
    short-summary: "Delete a ConstrainedResource in a Workspace."
    examples:
      - name: ConstrainedResources_Delete
        text: |-
               az datacollaboration constrained-resource delete --name "SynapseSparkPool1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration constrained-resource wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the datacollaboration constrained-resource is \
met.
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration constrained-resource is successfully \
created.
        text: |-
               az datacollaboration constrained-resource wait --name "SynapseSparkPool1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1" --created
      - name: Pause executing next line of CLI script until the datacollaboration constrained-resource is successfully \
updated.
        text: |-
               az datacollaboration constrained-resource wait --name "SynapseSparkPool1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1" --updated
      - name: Pause executing next line of CLI script until the datacollaboration constrained-resource is successfully \
deleted.
        text: |-
               az datacollaboration constrained-resource wait --name "SynapseSparkPool1" --resource-group \
...
helps['datacollaboration data-asset'] = """
    type: group
    short-summary: Manage data asset with datacollaboration
"""
...
helps['datacollaboration data-asset list'] = """
    ...
    examples:
      - name: DataAssets_ListByWorkspace
        text: |-
               az datacollaboration data-asset list --resource-group "SampleResourceGroup" --workspace-name \
"Workspace1"
"""
...
helps['datacollaboration data-asset create'] = """
    type: command
    short-summary: "Create a DataAsset."
    examples:
      - name: DataAssets_CreateOrUpdate
        text: |-
               az datacollaboration data-asset create --description "Data of DataSet1" --data-processing-strategy \
"CopyBased" --name "DataAsset1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration data-asset update'] = """
    type: command
    short-summary: "Update a DataAsset."
"""
...
helps['datacollaboration data-asset wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration data-asset is successfully deleted.
        text: |-
               az datacollaboration data-asset wait --name "DataAsset1" --resource-group "SampleResourceGroup" \
--workspace-name "Workspace1" --deleted
"""

helps['datacollaboration data-set'] = """
    type: group
    short-summary: Manage data set with datacollaboration
"""
...
helps['datacollaboration data-set list'] = """
    ...
    examples:
      - name: DataSets_ListByDataAsset
        text: |-
               az datacollaboration data-set list --data-asset-name "DataAsset1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration data-set create'] = """
    ...
    parameters:
      - name: --adls-gen2-file-data-set
        ...
        long-summary: |
            Usage: --adls-gen2-file-data-set file-path=XX file-system=XX storage-account-id=XX kind=XX
      ...
      - name: --adls-gen2-file-system-data-set
        ...
        long-summary: |
            Usage: --adls-gen2-file-system-data-set file-system=XX storage-account-id=XX kind=XX
      ...
      - name: --adls-gen2-folder-data-set
        ...
        long-summary: |
            Usage: --adls-gen2-folder-data-set file-system=XX folder-path=XX storage-account-id=XX kind=XX
...
helps['datacollaboration data-set wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration data-set is successfully deleted.
        text: |-
               az datacollaboration data-set wait --data-asset-name "DataAsset1" --data-set-category "Production" \
--resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration pipeline-run'] = """
    type: group
    short-summary: Manage pipeline run with datacollaboration
"""

helps['datacollaboration pipeline-run list'] = """
    type: command
    short-summary: "List pipelines runs in a workspace."
    examples:
      - name: PipelineRuns_ListByWorkspace
        text: |-
               az datacollaboration pipeline-run list --resource-group "SampleResourceGroup" --workspace-name \
"Workspace1"
"""

helps['datacollaboration pipeline-run show'] = """
    type: command
    short-summary: "Get a pipeline run from a workspace."
    examples:
...
helps['datacollaboration pipeline-run wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration pipeline-run is successfully \
created.
        text: |-
               az datacollaboration pipeline-run wait --name "a4cdba19-a513-46ca-9d48-47806e396d13" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1" --created
"""

helps['datacollaboration pipeline-step-run'] = """
    type: group
    short-summary: Manage pipeline step run with datacollaboration
"""

helps['datacollaboration pipeline-step-run list'] = """
    type: command
    short-summary: "List all step runs in a pipeline run."
    examples:
...
helps['datacollaboration pipeline-step-run show'] = """
    type: command
    short-summary: "Get a pipeline step run from a pipeline run."
    examples:
...
helps['datacollaboration pipeline'] = """
    type: group
    short-summary: Manage pipeline with datacollaboration
"""
...
helps['datacollaboration pipeline run'] = """
    ...
    examples:
      - name: Pipelines_Run
        text: |-
               az datacollaboration pipeline run --name "Pipeline1" --pipeline-run-mode "Test" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration pipeline wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration pipeline is successfully deleted.
        text: |-
               az datacollaboration pipeline wait --name "Pipeline1" --resource-group "SampleResourceGroup" \
--workspace-name "Workspace1" --deleted
      - name: Pause executing next line of CLI script until the datacollaboration pipeline is successfully created.
        text: |-
               az datacollaboration pipeline wait --name "Pipeline1" --resource-group "SampleResourceGroup" \
...
helps['datacollaboration pipeline-step'] = """
    type: group
    short-summary: Manage pipeline step with datacollaboration
"""
...
helps['datacollaboration pipeline-step list'] = """
    ...
    examples:
      - name: PipelineSteps_ListByPipeline
        text: |-
               az datacollaboration pipeline-step list --pipeline-name "Pipeline1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration pipeline-step create'] = """
    type: command
    short-summary: "Create a PipelineStep."
    parameters:
      - name: --synapse-spark-pipeline-step
        short-summary: "A Synapse Spark based pipeline step."
        long-summary: |
            Usage: --synapse-spark-pipeline-step dependencies=XX executor-node-size=XX executors-count=XX script-id=XX \
script-revision=XX script-sink-bindings=XX script-source-bindings=XX synapse-spark-pool-id=XX kind=XX

            dependencies: List of other steps names, in the same pipeline, which this step is depended on and should \
run only when they finish.
            executor-node-size: The node size to use per executor.
            executors-count: Number of executors to execute this step.
            ...
            synapse-spark-pool-id: The Synapse Spark pool that will execute this step
...
helps['datacollaboration pipeline-step update'] = """
    type: command
    short-summary: "Update a PipelineStep."
    parameters:
      - name: --synapse-spark-pipeline-step
        short-summary: "A Synapse Spark based pipeline step."
        long-summary: |
...
helps['datacollaboration pipeline-step wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration pipeline-step is successfully \
deleted.
        text: |-
               az datacollaboration pipeline-step wait --pipeline-name "Pipeline1" --name "PipelineStep1" \
--resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration proposal'] = """
    type: group
    short-summary: Manage proposal with datacollaboration
"""
...
helps['datacollaboration proposal create'] = """
    type: command
    short-summary: "Create a Proposal in a Workspace."
    examples:
      - name: Proposals_CreateOrUpdate
        text: |-
               az datacollaboration proposal create --description "Proposal description" --terms "Proposal terms" \
--name "Proposal1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration proposal update'] = """
    type: command
    short-summary: "Update a Proposal in a Workspace."
"""
...
helps['datacollaboration proposal revoke'] = """
    type: command
    short-summary: "Revoke an Active Proposal in a Workspace."
    examples:
      - name: Proposals_Revoke
        text: |-
               az datacollaboration proposal revoke --name "Proposal1" --resource-group "SampleResourceGroup" \
--workspace-name "Workspace1"
"""

helps['datacollaboration proposal sign'] = """
    type: command
    short-summary: "Sign a Proposal in a Workspace."
    examples:
      - name: Proposals_Sign
        text: |-
               az datacollaboration proposal sign --name "Proposal1" --proposal-version "ae660cb9-0c0c-4ff5-a68f-dc5584\
a63c79" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration proposal wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration proposal is successfully created.
        text: |-
               az datacollaboration proposal wait --name "Proposal1" --resource-group "SampleResourceGroup" \
--workspace-name "Workspace1" --created
      - name: Pause executing next line of CLI script until the datacollaboration proposal is successfully updated.
        text: |-
               az datacollaboration proposal wait --name "Proposal1" --resource-group "SampleResourceGroup" \
...
helps['datacollaboration data-asset-reference'] = """
    type: group
    short-summary: Manage data asset reference with datacollaboration
"""
...
helps['datacollaboration data-asset-reference list'] = """
    ...
    examples:
      - name: DataAssetReferences_ListByProposal
        text: |-
               az datacollaboration data-asset-reference list --proposal-name "Proposal1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration data-asset-reference show'] = """
    ...
    examples:
      - name: DataAssetReferences_Get
        text: |-
               az datacollaboration data-asset-reference show --proposal-name "Proposal1" --reference-name \
"DataAssetReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration data-asset-reference create'] = """
    type: command
    short-summary: "Create a DataAssetReference in a Workspace."
    examples:
...
--data-asset-id "d164252e-2909-4718-a91e-315195c54b09" --proposal-name "Proposal1" --reference-name \
"DataAssetReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration data-asset-reference update'] = """
    type: command
    short-summary: "Update a DataAssetReference in a Workspace."
"""
...
helps['datacollaboration data-asset-reference delete'] = """
    ...
    examples:
      - name: DataAssetReferences_Delete
        text: |-
               az datacollaboration data-asset-reference delete --proposal-name "Proposal1" --reference-name \
"DataAssetReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration data-asset-reference resolve'] = """
    type: command
    short-summary: "Resolve and return the DataAsset that the DataAssetReference points to."
    examples:
      - name: DataAssetReferences_Resolve
        text: |-
               az datacollaboration data-asset-reference resolve --proposal-name "Proposal1" --reference-name \
"DataAssetReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
deleted.
        text: |-
               az datacollaboration data-asset-reference wait --proposal-name "Proposal1" --reference-name \
"DataAssetReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration entitlement'] = """
    type: group
    short-summary: Manage entitlement with datacollaboration
"""
...
helps['datacollaboration entitlement list'] = """
    ...
    examples:
      - name: Entitlements_ListByProposal
        text: |-
               az datacollaboration entitlement list --proposal-name "Proposal1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration entitlement create'] = """
    type: command
    short-summary: "Create an entitlement in a proposal."
    examples:
...
helps['datacollaboration entitlement update'] = """
    type: command
    short-summary: "Update an entitlement in a proposal."
"""
...
helps['datacollaboration entitlement wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration entitlement is successfully deleted.
        text: |-
               az datacollaboration entitlement wait --name "Entitlement1" --proposal-name "Proposal1" \
--resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration constraint'] = """
    type: group
    short-summary: Manage constraint with datacollaboration
"""
...
helps['datacollaboration constraint create'] = """
    type: command
    short-summary: "Create a constraint in an entitlement."
    parameters:
      - name: --location-constraint
        short-summary: "Constraint used to only allow access if the resource is used within the specified Azure \
location."
        long-summary: |
...
helps['datacollaboration constraint update'] = """
    type: command
    short-summary: "Update a constraint in an entitlement."
    parameters:
      - name: --location-constraint
        short-summary: "Constraint used to only allow access if the resource is used within the specified Azure \
location."
...
helps['datacollaboration constraint wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration constraint is successfully deleted.
        text: |-
               az datacollaboration constraint wait --name "Constraint1" --entitlement-name "Entitlement1" \
--proposal-name "Proposal1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration policy'] = """
    type: group
    short-summary: Manage policy with datacollaboration
"""
...
helps['datacollaboration policy show'] = """
    ...
    examples:
      - name: Policies_Get
        text: |-
               az datacollaboration policy show --entitlement-name "Entitlement1" --name "Policy1" --proposal-name \
"Proposal1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration policy create'] = """
    type: command
    short-summary: "Create a policy in an entitlement."
    parameters:
    ...
    examples:
      - name: Policies_CreateOrUpdate
        text: |-
               az datacollaboration policy create --entitlement-name "Entitlement1" --diagnostic-policy \
description="Policy description" log-level="Information" --name "Policy1" --proposal-name "Proposal1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration policy update'] = """
    type: command
    short-summary: "Update a policy in an entitlement."
    parameters:
      - name: --diagnostic-policy
        short-summary: "A diagnostic policy."
        long-summary: |
...
helps['datacollaboration policy delete'] = """
    ...
    examples:
      - name: Policies_Delete
        text: |-
               az datacollaboration policy delete --entitlement-name "Entitlement1" --name "Policy1" --proposal-name \
"Proposal1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration policy wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration policy is successfully deleted.
        text: |-
               az datacollaboration policy wait --entitlement-name "Entitlement1" --name "Policy1" --proposal-name \
"Proposal1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration invitation'] = """
    type: group
    short-summary: Manage invitation with datacollaboration
"""
...
helps['datacollaboration participant'] = """
    type: group
    short-summary: Manage participant with datacollaboration
"""

helps['datacollaboration participant list'] = """
    type: command
    short-summary: "List Participants in a Proposal."
    examples:
      - name: Participants_ListByProposal
        text: |-
               az datacollaboration participant list --proposal-name "Proposal1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration participant show'] = """
    type: command
    short-summary: "Get a Participant in a Proposal."
    examples:
      - name: Participants_Get
        text: |-
...
helps['datacollaboration script-reference'] = """
    type: group
    short-summary: Manage script reference with datacollaboration
"""

helps['datacollaboration script-reference list'] = """
    type: command
    short-summary: "List ScriptReference in a Proposal."
    examples:
      - name: ScriptReferences_ListByProposal
        text: |-
               az datacollaboration script-reference list --proposal-name "Proposal1" --resource-group \
"SampleResourceGroup" --workspace-name "Workspace1"
"""
...
helps['datacollaboration script-reference show'] = """
    ...
    examples:
      - name: ScriptReferences_Get
        text: |-
               az datacollaboration script-reference show --proposal-name "Proposal1" --reference-name \
"ScriptReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration script-reference create'] = """
    type: command
    short-summary: "Create a ScriptReference in a Proposal."
    examples:
      - name: ScriptReferences_CreateOrUpdate
        text: |-
               az datacollaboration script-reference create --proposal-name "Proposal1" --reference-name \
"ScriptReference1" --resource-group "SampleResourceGroup" --revision 1 --script-id "d164252e-2909-4718-a91e-315195c54b0\
9" --workspace-name "Workspace1"
"""

helps['datacollaboration script-reference update'] = """
    type: command
    short-summary: "Update a ScriptReference in a Proposal."
"""

helps['datacollaboration script-reference delete'] = """
    type: command
    short-summary: "Delete a ScriptReference in a Proposal."
    examples:
      - name: ScriptReferences_Delete
        text: |-
               az datacollaboration script-reference delete --proposal-name "Proposal1" --reference-name \
"ScriptReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration script-reference resolve'] = """
    type: command
    short-summary: "Resolve and return the Script that the ScriptReference points to."
    examples:
      - name: ScriptReferences_Resolve
        text: |-
               az datacollaboration script-reference resolve --proposal-name "Proposal1" --reference-name \
"ScriptReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1"
"""

helps['datacollaboration script-reference wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the datacollaboration script-reference is \
met.
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration script-reference is successfully \
deleted.
        text: |-
               az datacollaboration script-reference wait --proposal-name "Proposal1" --reference-name \
"ScriptReference1" --resource-group "SampleResourceGroup" --workspace-name "Workspace1" --deleted
"""

helps['datacollaboration resource-reference'] = """
    type: group
    short-summary: Manage resource reference with datacollaboration
"""

helps['datacollaboration resource-reference list'] = """
    type: command
    short-summary: "List resource references in a Workspace."
    examples:
      - name: ResourceReferences_ListByWorkspace
        text: |-
               az datacollaboration resource-reference list --resource-group "SampleResourceGroup" --workspace-name \
"Workspace1"
"""

helps['datacollaboration script'] = """
    type: group
    short-summary: Manage script with datacollaboration
"""
...
helps['datacollaboration script show'] = """
    ...
    examples:
      - name: Scripts_Get
        text: |-
               az datacollaboration script show --resource-group "SampleResourceGroup" --name "Script1" \
--workspace-name "Workspace1"
"""

helps['datacollaboration script create'] = """
    type: command
    short-summary: "Create a Script in a Workspace."
    parameters:
      - name: --synapse-spark-script
        short-summary: "A type of script based on the compute engine"
        long-summary: |
            Usage: --synapse-spark-script content=XX language=XX sinks=XX sources=XX visibility=XX kind=XX

            content: Required. The script content
            language: Required. The script language
    ...
    examples:
      - name: Scripts_CreateOrUpdate
        text: |-
               az datacollaboration script create --resource-group "SampleResourceGroup" --synapse-spark-script \
content="Hello Python!" language="Python" sinks="bar" sources="foo" visibility="ShowAll" --name "Script1" \
--workspace-name "Workspace1"
...
helps['datacollaboration script update'] = """
    type: command
    short-summary: "Update a Script in a Workspace."
    parameters:
      - name: --synapse-spark-script
        short-summary: "A type of script based on the compute engine"
        long-summary: |
...
helps['datacollaboration script wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datacollaboration script is successfully deleted.
        text: |-
               az datacollaboration script wait --resource-group "SampleResourceGroup" --name "Script1" \
--workspace-name "Workspace1" --deleted
"""

helps['datacollaboration script-revision'] = """
    type: group
    short-summary: Manage script revision with datacollaboration
"""
...
helps['datacollaboration script-revision list'] = """
    ...
    examples:
      - name: ScriptRevisions_ListByScript
        text: |-
               az datacollaboration script-revision list --resource-group "SampleResourceGroup" --script-name \
"Script1" --workspace-name "Workspace1"
"""
...
helps['datacollaboration script-revision show'] = """
    ...
    examples:
      - name: ScriptRevisions_Get
        text: |-
               az datacollaboration script-revision show --resource-group "SampleResourceGroup" --revision 1 \
--script-name "Script1" --workspace-name "Workspace1"
"""
