...
def load_command_table(self, _):
    ...
    with self.command_group('datacollaboration data-asset', datacollaboration_data_asset, client_factory=cf_data_asset,
        ...
        g.generic_update_command('update', setter_arg_name='system_data', custom_func_name=''
                                 'datacollaboration_data_asset_update')
    ...
    with self.command_group('datacollaboration data-set', datacollaboration_data_set, client_factory=cf_data_set,
        ...
        g.generic_update_command('update', setter_arg_name='data_set', custom_func_name=''
                                 'datacollaboration_data_set_update')
    ...
    with self.command_group('datacollaboration pipeline', datacollaboration_pipeline, client_factory=cf_pipeline,
        ...
        g.generic_update_command('update', setter_arg_name='system_data', custom_func_name=''
                                 'datacollaboration_pipeline_update')
    ...
    with self.command_group('datacollaboration pipeline-step', datacollaboration_pipeline_step,
        ...
        g.generic_update_command('update', setter_arg_name='pipeline_step', custom_func_name=''
                                 'datacollaboration_pipeline_step_update')
    ...
    with self.command_group('datacollaboration data-asset-reference', datacollaboration_data_asset_reference,
        ...
        g.generic_update_command('update', setter_arg_name='system_data', custom_func_name=''
                                 'datacollaboration_data_asset_reference_update')
    ...
    with self.command_group('datacollaboration entitlement', datacollaboration_entitlement,
        ...
        g.generic_update_command('update', setter_arg_name='system_data', custom_func_name=''
                                 'datacollaboration_entitlement_update')
    ...
    with self.command_group('datacollaboration constraint', datacollaboration_constraint, client_factory=cf_constraint,
        ...
        g.generic_update_command('update', setter_arg_name='constraint', custom_func_name=''
                                 'datacollaboration_constraint_update')
    ...
    with self.command_group('datacollaboration script-reference', datacollaboration_script_reference,
        ...
        g.generic_update_command('update', setter_arg_name='system_data', custom_func_name=''
                                 'datacollaboration_script_reference_update')
    ...
    datacollaboration_resource_reference = CliCommandType(
        operations_tmpl='azext_datacollaboration.vendored_sdks.datacollaboration.operations._resource_reference_operati'
        'ons#ResourceReferenceOperations.{}',
    ...
    with self.command_group('datacollaboration resource-reference', datacollaboration_resource_reference,
                            client_factory=cf_resource_reference, is_experimental=True) as g:
