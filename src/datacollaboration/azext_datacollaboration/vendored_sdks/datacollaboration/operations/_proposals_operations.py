...
class ProposalsOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.Proposal"]
        ...
        :type proposal: ~data_collaboration_management_client.models.Proposal
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~data_collaboration_management_client.models.Proposal]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _sign_initial(
        ...
        workspace_name,  # type: str
        proposal_name,  # type: str
        proposal_signature,  # type: "models.ProposalSignature"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Proposal"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Proposal"]
    ...
    def begin_sign(
        ...
        **kwargs  # type: Any
        ...
        :type proposal_signature: ~data_collaboration_management_client.models.ProposalSignature
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
