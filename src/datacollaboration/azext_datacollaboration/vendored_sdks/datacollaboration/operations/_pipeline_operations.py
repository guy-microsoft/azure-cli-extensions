...
class PipelineOperations(object):
    ...
    def list_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.PipelineList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~data_collaboration_management_client.models.PipelineList]
    ...
    def _run_initial(
        ...
        workspace_name,  # type: str
        pipeline_name,  # type: str
        pipeline_run_mode=None,  # type: Optional[Union[str, "models.PipelineRunMode"]]
        **kwargs  # type: Any
    ):
