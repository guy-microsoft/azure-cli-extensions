...
class PipelineStepRunOperations(object):
    """PipelineStepRunOperations operations.
    ...
    def list_by_pipeline_run(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.PipelineStepRunList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~data_collaboration_management_client.models.PipelineStepRunList]
    ...
    list_by_pipeline_run.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelines/{pipelineName}/pipelineRuns/{pipelineRunName}/pipelineStepRuns'}  # type: ignore
    ...
    def get(
        ...
        pipeline_name,  # type: str
        pipeline_run_name,  # type: str
        pipeline_step_run_id,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.PipelineStepRun"
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelines/{pipelineName}/pipelineRuns/{pipelineRunName}/pipelineStepRuns/{pipelineStepRunId}'}  # type: ignore
