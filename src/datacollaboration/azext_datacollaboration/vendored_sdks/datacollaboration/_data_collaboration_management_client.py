...
from .operations import ResourceReferenceOperations
...
class DataCollaborationManagementClient(object):
    ...
    :vartype resource_reference: data_collaboration_management_client.operations.ResourceReferenceOperations
