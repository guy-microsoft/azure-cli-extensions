...
class DataCollaborationManagementClient(object):
    ...
    :vartype consumer_invitations: data_collaboration_management_client.aio.operations.ConsumerInvitationsOperations
    :ivar operations: Operations operations
    :vartype operations: data_collaboration_management_client.aio.operations.Operations
    :ivar workspaces: WorkspacesOperations operations
    :vartype workspaces: data_collaboration_management_client.aio.operations.WorkspacesOperations
    :ivar constrained_resources: ConstrainedResourcesOperations operations
    :vartype constrained_resources: data_collaboration_management_client.aio.operations.ConstrainedResourcesOperations
    :ivar data_assets: DataAssetsOperations operations
    :vartype data_assets: data_collaboration_management_client.aio.operations.DataAssetsOperations
    :ivar data_sets: DataSetsOperations operations
    :vartype data_sets: data_collaboration_management_client.aio.operations.DataSetsOperations
    :ivar pipeline_runs: PipelineRunsOperations operations
    :vartype pipeline_runs: data_collaboration_management_client.aio.operations.PipelineRunsOperations
    :ivar pipeline_step_runs: PipelineStepRunsOperations operations
    :vartype pipeline_step_runs: data_collaboration_management_client.aio.operations.PipelineStepRunsOperations
    :ivar pipelines: PipelinesOperations operations
    :vartype pipelines: data_collaboration_management_client.aio.operations.PipelinesOperations
    :ivar pipeline_steps: PipelineStepsOperations operations
    :vartype pipeline_steps: data_collaboration_management_client.aio.operations.PipelineStepsOperations
    :ivar proposals: ProposalsOperations operations
    :vartype proposals: data_collaboration_management_client.aio.operations.ProposalsOperations
    :ivar data_asset_references: DataAssetReferencesOperations operations
    :vartype data_asset_references: data_collaboration_management_client.aio.operations.DataAssetReferencesOperations
    :ivar entitlements: EntitlementsOperations operations
    :vartype entitlements: data_collaboration_management_client.aio.operations.EntitlementsOperations
    :ivar constraints: ConstraintsOperations operations
    :vartype constraints: data_collaboration_management_client.aio.operations.ConstraintsOperations
    :ivar policies: PoliciesOperations operations
    :vartype policies: data_collaboration_management_client.aio.operations.PoliciesOperations
    :ivar invitations: InvitationsOperations operations
    :vartype invitations: data_collaboration_management_client.aio.operations.InvitationsOperations
    :ivar participants: ParticipantsOperations operations
    :vartype participants: data_collaboration_management_client.aio.operations.ParticipantsOperations
    :ivar script_references: ScriptReferencesOperations operations
    :vartype script_references: data_collaboration_management_client.aio.operations.ScriptReferencesOperations
    :ivar resource_references: ResourceReferencesOperations operations
    :vartype resource_references: data_collaboration_management_client.aio.operations.ResourceReferencesOperations
    :ivar scripts: ScriptsOperations operations
    :vartype scripts: data_collaboration_management_client.aio.operations.ScriptsOperations
    :ivar script_revisions: ScriptRevisionsOperations operations
    :vartype script_revisions: data_collaboration_management_client.aio.operations.ScriptRevisionsOperations
