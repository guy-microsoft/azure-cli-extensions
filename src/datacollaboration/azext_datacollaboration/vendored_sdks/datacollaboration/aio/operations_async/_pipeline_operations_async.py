...
class PipelineOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs
    ) -> AsyncIterable["models.PipelineList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_collaboration_management_client.models.PipelineList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PipelineList"]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~data_collaboration_management_client.models.Pipeline
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        _pipeline = models.Pipeline(system_data=system_data, description=description)
        api_version = "2020-05-04-preview"
        ...
        body_content = self._serialize.body(_pipeline, 'Pipeline')
    ...
    async def _run_initial(
        ...
        workspace_name: str,
        pipeline_name: str,
        pipeline_run_mode: Optional[Union[str, "models.PipelineRunMode"]] = None,
        **kwargs
    ) -> "models.PipelineRun":
        ...
        _pipeline_run_parameters = models.PipelineRunParameters(pipeline_run_mode=pipeline_run_mode)
        api_version = "2020-05-04-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_pipeline_run_parameters, 'PipelineRunParameters')
        body_content_kwargs['content'] = body_content
    ...
    async def begin_run(
        ...
        **kwargs
        ...
        :param pipeline_name: The name of the pipeline.
        :type pipeline_name: str
        :param pipeline_run_mode: Mode of pipeline run used.
