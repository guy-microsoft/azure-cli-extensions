...
class ConstraintOperations:
    """ConstraintOperations async operations.
    ...
    def list_by_entitlement(
        ...
        **kwargs
    ) -> AsyncIterable["models.ConstraintList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_collaboration_management_client.models.ConstraintList]
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/constraints/{constraintName}'}  # type: ignore
