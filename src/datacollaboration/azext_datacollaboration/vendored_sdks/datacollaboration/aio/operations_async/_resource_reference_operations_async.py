...
class ResourceReferenceOperations:
    """ResourceReferenceOperations async operations.
    ...
    def list_by_workspace(
        ...
        **kwargs
    ) -> AsyncIterable["models.ResourceReferenceList"]:
        ...
        :return: An iterator like instance of either ResourceReferenceList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_collaboration_management_client.models.ResourceReferenceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ResourceReferenceList"]
