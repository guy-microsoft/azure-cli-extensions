...
class DataAssetReferenceOperations:
    """DataAssetReferenceOperations async operations.
    ...
    def list_by_proposal(
        ...
        **kwargs
    ) -> AsyncIterable["models.DataAssetReferenceList"]:
        ...
        :return: An iterator like instance of either DataAssetReferenceList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_collaboration_management_client.models.DataAssetReferenceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataAssetReferenceList"]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~data_collaboration_management_client.models.DataAssetReference
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataAssetReference"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2020-05-04-preview"
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :param reference_name: The name of the reference.
        :type reference_name: str
        :param data_asset_id: The unique identifier of the referenced data asset.
        ...
        _data_asset_reference = models.DataAssetReference(system_data=system_data, data_asset_id=data_asset_id, description=description)
        api_version = "2020-05-04-preview"
        ...
        body_content = self._serialize.body(_data_asset_reference, 'DataAssetReference')
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/dataAssetReferences/{referenceName}'}  # type: ignore
