...
from .operations_async import ParticipantOperations
from .operations_async import ScriptReferenceOperations
from .operations_async import ResourceReferenceOperations
...
class DataCollaborationManagementClient(object):
    ...
    :vartype participant: data_collaboration_management_client.aio.operations_async.ParticipantOperations
    ...
    :ivar resource_reference: ResourceReferenceOperations operations
    :vartype resource_reference: data_collaboration_management_client.aio.operations_async.ResourceReferenceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.script_reference = ScriptReferenceOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.resource_reference = ResourceReferenceOperations(
            self._client, self._config, self._serialize, self._deserialize)
