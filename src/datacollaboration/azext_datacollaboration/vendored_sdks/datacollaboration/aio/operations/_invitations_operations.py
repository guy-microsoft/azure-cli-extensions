...
class InvitationsOperations:
    ...
    def list_by_proposal(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_collaboration_management_client.models.InvitationList]
    ...
    async def create(
        ...
        **kwargs
        ...
        :type invitation: ~data_collaboration_management_client.models.Invitation
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Invitation, or the result of cls(response)
        :rtype: ~data_collaboration_management_client.models.Invitation
        :raises: ~azure.core.exceptions.HttpResponseError
