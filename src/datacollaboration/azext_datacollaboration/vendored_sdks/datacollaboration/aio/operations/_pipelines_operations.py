...
class PipelinesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type pipeline: ~data_collaboration_management_client.models.Pipeline
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Pipeline, or the result of cls(response)
        :rtype: ~data_collaboration_management_client.models.Pipeline
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def _run_initial(
        ...
        workspace_name: str,
        pipeline_name: str,
        pipeline_run_parameters: "models.PipelineRunParameters",
        **kwargs
    ) -> "models.PipelineRun":
    ...
    async def begin_run(
        ...
        **kwargs
        ...
        :type pipeline_run_parameters: ~data_collaboration_management_client.models.PipelineRunParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
