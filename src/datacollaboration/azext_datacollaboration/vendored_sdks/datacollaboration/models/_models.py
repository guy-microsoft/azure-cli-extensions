...
class DataSet(ProxyDto):
    ...
    :param kind: Required. Kind of Data Set.Constant filled by server.  Possible values include:
     ...
     "AdlsGen2Folder", "AdlsGen2File", "SynapseSpark", "DiagnosticLevel".
...
class ProposalSignature(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.proposal_version = kwargs['proposal_version']
...
class ScriptReference(ProxyDto):
    ...
    :type script_id: str
    :ivar script_kind: Kind of the referenced script. Default value: "SynapseSpark".
    :vartype script_kind: str
    ...
    _validation = {
        ...
        'script_kind': {'readonly': True, 'constant': True},
