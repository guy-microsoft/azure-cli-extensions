...
class DataAssetReference(ProxyDto):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.data_asset_id = kwargs['data_asset_id']
...
class ScriptConstraint(Constraint):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.kind = 'Script'
        self.description = kwargs.get('description', None)
        self.script_reference_id = kwargs['script_reference_id']
...
class SynapseSparkPipelineStep(PipelineStep):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.script_id = kwargs['script_id']
        self.script_revision = kwargs['script_revision']
        self.script_sink_bindings = kwargs['script_sink_bindings']
        self.script_source_bindings = kwargs['script_source_bindings']
