...
class AzureDevOps(object):
    ...
    :vartype operations: azure_dev_ops.operations.Operations
    :ivar pipeline_template_definitions: PipelineTemplateDefinitionsOperations operations
    :vartype pipeline_template_definitions: azure_dev_ops.operations.PipelineTemplateDefinitionsOperations
    :ivar pipelines: PipelinesOperations operations
    :vartype pipelines: azure_dev_ops.operations.PipelinesOperations
