...
class AzureDevOps(object):
    ...
    :vartype operations: azure_dev_ops.aio.operations.Operations
    :ivar pipeline_template_definitions: PipelineTemplateDefinitionsOperations operations
    :vartype pipeline_template_definitions: azure_dev_ops.aio.operations.PipelineTemplateDefinitionsOperations
    :ivar pipelines: PipelinesOperations operations
    :vartype pipelines: azure_dev_ops.aio.operations.PipelinesOperations
