...
def load_command_table(self, _):
    ...
    devops_pipeline_template_definition = CliCommandType(
        operations_tmpl='azext_devops.vendored_sdks.devops.operations._pipeline_template_definitions_operations#Pipelin'
        'eTemplateDefinitionsOperations.{}',
    ...
    devops_pipeline = CliCommandType(
        operations_tmpl='azext_devops.vendored_sdks.devops.operations._pipelines_operations#PipelinesOperations.{}',
    ...
    with self.command_group('devops', is_experimental=True):
        pass
