...
helps['desktopvirtualization workspace create'] = """
    ...
    examples:
      - name: Workspace_Create
        text: |-
               az desktopvirtualization workspace create --resource-group "MyResourceGroup" --location "centralus" --de\
scription "des1" --friendly-name "friendly" --tags tag1="value1" tag2="value2" --name "MyWorkspace"
"""
...
helps['desktopvirtualization workspace update'] = """
    ...
    examples:
      - name: Workspace_Update
        text: |-
               az desktopvirtualization workspace update --resource-group "MyResourceGroup" --description "des1" --frie\
ndly-name "friendly" --tags tag1="value1" tag2="value2" --name "MyWorkspace"
"""
...
helps['desktopvirtualization applicationgroup show'] = """
    ...
    examples:
      - name: ApplicationGroup_Get
        text: |-
               az desktopvirtualization applicationgroup show --name "MyApplicationGroup" --resource-group "MyResourceG\
roup"
"""
...
a63c4fa/resourceGroups/MyResourceGroup/providers/Microsoft.DesktopVirtualization/hostPools/MyHostPool" --tags tag1="val\
ue1" tag2="value2" --name "MyApplicationGroup" --resource-group "MyResourceGroup"
"""
...
helps['desktopvirtualization applicationgroup delete'] = """
    ...
    examples:
      - name: ApplicationGroup_Delete
        text: |-
               az desktopvirtualization applicationgroup delete --name "MyApplicationGroup" --resource-group "MyResourc\
eGroup"
"""
...
n="Update" --sso-context "KeyVaultPath" --tags tag1="value1" tag2="value2" --name "MyHostPool" --resource-group "MyReso\
urceGroup"
"""
...
g1="value1" tag2="value2" --name "MyHostPool" --resource-group "MyResourceGroup"
"""
...
helps['desktopvirtualization hostpool delete'] = """
    ...
    examples:
      - name: HostPool_Delete
        text: |-
               az desktopvirtualization hostpool delete --force true --name "MyHostPool" --resource-group "MyResourceGr\
oup"
"""
