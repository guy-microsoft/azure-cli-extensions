...
def step_hostpool_create(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization hostpool create '
             ...
             '--registration-info expiration-time="2021-01-25T18:28:41.007Z" registration-token-operation="Update" '
...
def step_hostpool_update(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization hostpool update '
             ...
             '--max-session-limit 999999 '
             '--personal-desktop-assignment-type "Automatic" '
             '--registration-info expiration-time="2021-01-25T18:28:41.008Z" registration-token-operation="Update" '
             '--sso-client-id "client" '
             '--sso-client-secret-key-vault-path "https://keyvault/secret" '
             '--sso-context "KeyVaultPath" '
             '--sso-secret-type "SharedKey" '
...
def step_msix_package_create(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization msix-package create '
             ...
             '--last-updated "2021-01-25T18:28:41.011Z" '
...
def step_scaling_plan_create(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization scaling-plan create '
             ...
             'off-peak-start-time="2021-01-25T18:28:40.999Z" peak-load-balancing-algorithm="BreadthFirst" '
             'peak-start-time="2021-01-25T18:28:40.999Z" ramp-down-capacity-threshold-pct=50 '
             'ramp-down-force-logoff-users=true ramp-down-load-balancing-algorithm="DepthFirst" '
             'ramp-down-minimum-hosts-pct=20 ramp-down-notification-message="message" ramp-down-start-time="2021-01-25T'
             '18:28:40.999Z" ramp-down-wait-time-minutes=30 ramp-up-capacity-threshold-pct=80 '
             'ramp-up-load-balancing-algorithm="DepthFirst" ramp-up-minimum-hosts-pct=20 '
             'ramp-up-start-time="2021-01-25T18:28:40.999Z" '
             '--time-zone "" '
             '--tags tag1="value1" tag2="value2" '
             '--name "{myScalingPlan}"',
             checks=checks)
