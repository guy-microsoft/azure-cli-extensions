...
def step_hostpool_create(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization hostpool create '
             ...
             '--registration-info expiration-time="2021-02-05T18:37:37.177Z" registration-token-operation="Update" '
...
def step_hostpool_update(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization hostpool update '
             ...
             '--max-session-limit 999999 '
             '--personal-desktop-assignment-type "Automatic" '
             '--registration-info expiration-time="2021-02-05T18:37:37.179Z" registration-token-operation="Update" '
             '--sso-client-id "client" '
             '--sso-client-secret-key-vault-path "https://keyvault/secret" '
             '--sso-context "KeyVaultPath" '
             '--sso-secret-type "SharedKey" '
...
def step_msix_package_create(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization msix-package create '
             ...
             '--last-updated "2021-02-05T18:37:37.182Z" '
...
def step_scaling_plan_create(test, rg, checks=None):
    ...
    test.cmd('az desktopvirtualization scaling-plan create '
             ...
             'off-peak-start-time="2021-02-05T18:37:37.166Z" peak-load-balancing-algorithm="BreadthFirst" '
             'peak-start-time="2021-02-05T18:37:37.166Z" ramp-down-capacity-threshold-pct=50 '
             ...
             ' ramp-down-start-time="2021-02-05T18:37:37.166Z" ramp-up-algorithm="DepthFirst" '
             'ramp-up-capacity-threshold-pct=80 ramp-up-minimum-host-pct=20 ramp-up-start-time="2021-02-05T18:37:37.166'
             'Z" '
             '--time-zone "" '
             '--tags tag1="value1" tag2="value2" '
             '--name "{myScalingPlan}"',
