...
def step__hostpools_put_hostpool_create(test, rg):
    test.cmd('az desktopvirtualization hostpool create '
             ...
             '--registration-info expiration-time="2020-11-26T02:12:20.221Z" registration-token-operation="Update" '
...
def step__hostpools_patch_hostpool_update(test, rg):
    test.cmd('az desktopvirtualization hostpool update '
             ...
             '--max-session-limit 999999 '
             '--personal-desktop-assignment-type "Automatic" '
             '--registration-info expiration-time="2020-11-26T02:12:20.222Z" registration-token-operation="Update" '
             '--sso-client-id "client" '
             '--sso-client-secret-key-vault-path "https://keyvault/secret" '
             '--sso-context "KeyVaultPath" '
             '--sso-secret-type "SharedKey" '
...
def step__msixpackages_put_msixpackage_create(test, rg):
    test.cmd('az desktopvirtualization msix-package create '
             ...
             '--last-updated "2020-11-26T02:12:20.225Z" '
...
def step__scalingplans_put_scalingplans_create(test, rg):
    test.cmd('az desktopvirtualization scaling-plan create '
             ...
             'off-peak-start-time="2020-11-26T02:12:20.206Z" peak-load-balancing-algorithm="BreadthFirst" '
             'peak-start-time="2020-11-26T02:12:20.207Z" ramp-down-capacity-threshold-pct=50 '
             ...
             ' ramp-down-start-time="2020-11-26T02:12:20.207Z" ramp-up-algorithm="DepthFirst" '
             'ramp-up-capacity-threshold-pct=80 ramp-up-minimum-host-pct=20 ramp-up-start-time="2020-11-26T02:12:20.207'
             'Z" '
             '--time-zone "" '
             '--tags tag1="value1" tag2="value2" '
             '--name "{myScalingPlan}"',
