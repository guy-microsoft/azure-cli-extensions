...
class SessionHost(Resource):
    ...
    :ivar session_host_health_check_result: List of SessionHostHealthCheckReports.
...
class SessionHostHealthCheckFailureDetails(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        last_health_check_in_utc: Optional[datetime.datetime] = None,
        **kwargs
    ):
...
class SessionHostHealthCheckReport(msrest.serialization.Model):
    ...
    :param health_check_name: Represents the name of the health check operation performed.
    :type health_check_name: str
    :param health_check_result: Represents the Health state of the health check we performed.
    :type health_check_result: str
    :param additional_failure_details: Contains details on the failure.
    ...
    def __init__(
        ...
        *,
        ...
        additional_failure_details: Optional["SessionHostHealthCheckFailureDetails"] = None,
        **kwargs
    ):
