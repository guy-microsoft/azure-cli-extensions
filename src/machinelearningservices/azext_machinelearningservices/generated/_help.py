...
helps['machinelearningservices batch-deployment list'] = """
    ...
    examples:
      - name: List Batch Deployment.
        text: |-
               az machinelearningservices batch-deployment list --endpoint-name "testEndpoint" --resource-group \
...
helps['machinelearningservices batch-deployment show'] = """
    ...
    examples:
      - name: Get Batch Deployment.
        text: |-
               az machinelearningservices batch-deployment show --deployment-name "testDeployment" --endpoint-name \
"testEndpoint" --resource-group "testrg123" --workspace-name "testworkspace"
"""

helps['machinelearningservices batch-deployment create'] = """
    type: command
    short-summary: "Creates a batch inference deployment."
    parameters:
      - name: --model-reference
        long-summary: |
            Usage: --model-reference reference-type=XX
      ...
      - name: --retry-settings
        short-summary: "Retry settings for a batch inference operation."
        long-summary: |
            Usage: --retry-settings maximum-retries=XX timeout-in-seconds=XX

            maximum-retries: Maximum retry count for a mini-batch
            timeout-in-seconds: Invocation timeout for a mini-batch, in seconds.
      - name: --partitioning-scheme
        short-summary: "Partitioning scheme for batch inference operation."
        long-summary: |
            Usage: --partitioning-scheme partitioning-keys=XX mini-batch-size=XX

            partitioning-keys: Partition keys list used for Named partitioning.
            mini-batch-size: Size of the mini-batch passed to each batch invocation. For FileDataset, this is the \
number of files per mini-batch. For TabularDataset, this is the size of the records in bytes, per mini-batch.
      - name: --output-configuration
        short-summary: "Batch inference output configuration."
        long-summary: |
            Usage: --output-configuration output-action=XX append-row-file-name=XX
...
--system-identity-url "string" --kind "string" --location "string" --properties description="string" \
batchSettings={"computeId":"string","errorThreshold":0,"loggingLevel":"Info","outputConfiguration":{"appendRowFileName"\
:"string","outputAction":"SummaryOnly"},"partitioningScheme":{"miniBatchSize":0,"partitioningKeys":["string"]},"retrySe\
ttings":{"maximumRetries":0,"timeoutInSeconds":0}} codeConfiguration={"codeArtifactId":"string","command":"string"} \
environmentId="string" modelReference={"referenceType":"Id"} properties={"additionalProp1":"string","additionalProp2":"\
string","additionalProp3":"string"} scaleSettings={"nodeCount":0} --tags additionalProp1="string" \
...
helps['machinelearningservices batch-deployment delete'] = """
    ...
    examples:
      - name: Delete Batch Deployment.
        text: |-
               az machinelearningservices batch-deployment delete --deployment-name "testDeployment" --endpoint-name \
"testEndpoint" --resource-group "testrg123" --workspace-name "testworkspace"
"""
...
helps['machinelearningservices batch-endpoint list'] = """
    ...
    examples:
      - name: List Batch Endpoint.
        text: |-
               az machinelearningservices batch-endpoint list --resource-group "testrg123" --workspace-name \
"testworkspace"
"""
...
helps['machinelearningservices batch-endpoint show'] = """
    ...
    examples:
      - name: Get Batch Endpoint.
        text: |-
               az machinelearningservices batch-endpoint show --endpoint-name "testEndpoint" --resource-group \
"testrg123" --workspace-name "testworkspace"
"""
...
helps['machinelearningservices batch-endpoint create'] = """
    ...
    parameters:
      - name: --compute-configuration
        long-summary: |
            Usage: --compute-configuration compute-type=XX
...
--system-identity-url "string" --kind "string" --location "string" --properties description="string" \
authMode="AMLToken" computeConfiguration={"computeType":"Managed"} keys={"primaryKey":"string","secondaryKey":"string"}\
...
helps['machinelearningservices batch-endpoint delete'] = """
    ...
    examples:
      - name: Delete Batch Endpoint.
        text: |-
               az machinelearningservices batch-endpoint delete --endpoint-name "testEndpoint" --resource-group \
"testrg123" --workspace-name "testworkspace"
"""
...
helps['machinelearningservices batch-endpoint list-key'] = """
    ...
    examples:
      - name: ListKeys Batch Endpoint.
        text: |-
               az machinelearningservices batch-endpoint list-key --endpoint-name "testEndpoint" --resource-group \
"testrg123" --workspace-name "testworkspace"
"""
...
helps['machinelearningservices code-version create'] = """
    ...
    parameters:
      - name: --asset-path
        short-summary: "Details of an AssetUri."
        long-summary: |
...
helps['machinelearningservices job poll'] = """
    type: command
    short-summary: "Polls a Job operation."
    examples:
      - name: Poll Command Job.
        text: |-
               az machinelearningservices job poll --operation-id "1" --id "testContainer" --resource-group \
"testrg123" --workspace-name "testworkspace"
      - name: Poll Sweep Job.
        text: |-
               az machinelearningservices job poll --operation-id "1" --id "testContainer" --resource-group \
...
helps['machinelearningservices labeling-job create'] = """
    ...
    parameters:
      - name: --dataset-configuration
        short-summary: "Labeling dataset configuration definition"
        long-summary: |
      ...
      - name: --labeling-job-media-properties
        short-summary: "Properties of a labeling job"
        long-summary: |
            Usage: --labeling-job-media-properties media-type=XX

            media-type: Required. Media type of the job.
      - name: --inferencing-compute-binding
        short-summary: "Compute binding definition."
        long-summary: |
            Usage: --inferencing-compute-binding compute-id=XX node-count=XX

            compute-id: Required. Resource ID of the compute resource.
            node-count: Number of nodes.
      - name: --training-compute-binding
        short-summary: "Compute binding definition."
        long-summary: |
            Usage: --training-compute-binding compute-id=XX node-count=XX
...
createdTimeUtc="2020-12-08T01:23:37.118Z" datasetConfiguration={"assetName":"string","datasetVersion":"string","increme\
ntalDatasetRefreshEnabled":true} jobInstructions={"uri":"string"} jobType="Labeling" labelCategories={"additionalProp1"\
:{"allowMultiSelect":true,"classes":{"additionalProp1":{"displayName":"string","subclasses":{}},"additionalProp2":{"dis\
playName":"string","subclasses":{}},"additionalProp3":{"displayName":"string","subclasses":{}}},"displayName":"string"}\
,"additionalProp2":{"allowMultiSelect":true,"classes":{"additionalProp1":{"displayName":"string","subclasses":{}},"addi\
tionalProp2":{"displayName":"string","subclasses":{}},"additionalProp3":{"displayName":"string","subclasses":{}}},"disp\
layName":"string"},"additionalProp3":{"allowMultiSelect":true,"classes":{"additionalProp1":{"displayName":"string","sub\
classes":{}},"additionalProp2":{"displayName":"string","subclasses":{}},"additionalProp3":{"displayName":"string","subc\
lasses":{}}},"displayName":"string"}} labelingJobMediaProperties={"mediaType":"Image"} mlAssistConfiguration={"inferenc\
ingComputeBinding":{"computeId":"string","nodeCount":0},"mlAssistEnabled":true,"trainingComputeBinding":{"computeId":"s\
tring","nodeCount":0}} progressMetrics={} projectId="3fa85f64-5717-4562-b3fc-2c963f66afa6" \
properties={"additionalProp1":"string","additionalProp2":"string","additionalProp3":"string"} status="NotStarted" \
statusMessages={} tags={"additionalProp1":"string","additionalProp2":"string","additionalProp3":"string"} --id \
...
helps['machinelearningservices labeling-job show-export-summary'] = """
    type: command
    short-summary: "Get export summary from a labeling job."
    examples:
      - name: GetExportSummary Labeling Job.
        text: |-
               az machinelearningservices labeling-job show-export-summary --export-id "3fa85f64-5717-4562-b3fc-2c963f6\
6afa6" --id "testLabelingJob" --resource-group "workspace-1234" --workspace-name "testworkspace"
"""
...
helps['machinelearningservices online-deployment list'] = """
    ...
    examples:
      - name: List Online Deployment Properties.
        text: |-
               az machinelearningservices online-deployment list --endpoint-name "testContainer" --resource-group \
...
helps['machinelearningservices online-deployment show'] = """
    ...
    examples:
      - name: Get Online Deployment Properties.
        text: |-
...
in the RFC Format.
      ...
      - name: --code-configuration
        long-summary: |
            ...
            command: Required. The command to execute on startup of the job. eg. ["python", "train.py"]
    examples:
      - name: CreateOrUpdate Online Deployment Properties.
        text: |-
...
mputeType":"Managed"} environmentId="string" environmentOverrides={"environmentVariables":{"additionalProp1":"string","\
additionalProp2":"string","additionalProp3":"string"}} modelReference={"referenceType":"Id"} \
properties={"additionalProp1":"string","additionalProp2":"string","additionalProp3":"string"} \
scaleSettings={"maxNodeCount":0} --tags additionalProp1="string" additionalProp2="string" additionalProp3="string" \
...
helps['machinelearningservices online-deployment update'] = """
    type: command
    short-summary: "Update Inference Endpoint Deployment."
    parameters:
      - name: --scale-settings
        short-summary: "scale settings for AML Compute"
        long-summary: |
...
helps['machinelearningservices online-deployment delete'] = """
    ...
    examples:
      - name: Delete Online Deployment Properties.
        text: |-
               az machinelearningservices online-deployment delete --deployment-name "1" --endpoint-name \
...
helps['machinelearningservices online-deployment get-log'] = """
    ...
    examples:
      - name: GetLogs Online Deployment Properties.
        text: |-
               az machinelearningservices online-deployment get-log --container-type "StorageInitializer" --tail 20 \
--deployment-name "1" --endpoint-name "testContainer" --resource-group "testrg123" --workspace-name "workspace123"
"""

helps['machinelearningservices online-deployment poll'] = """
    type: command
    short-summary: "Polls an Endpoint operation."
    examples:
      - name: Poll Online Deployment Properties.
        text: |-
...
helps['machinelearningservices online-endpoint list'] = """
    ...
    examples:
      - name: List Online Endpoint Properties.
        text: |-
...
helps['machinelearningservices online-endpoint show'] = """
    ...
    examples:
      - name: Get Online Endpoint Properties.
        text: |-
    ...
    parameters:
      ...
      - name: --keys
        long-summary: |
            ...
            secondary-key: The secondary key.
    examples:
      - name: CreateOrUpdate Online Endpoint Properties.
        text: |-
...
helps['machinelearningservices online-endpoint delete'] = """
    ...
    examples:
      - name: Delete Online Endpoint Properties.
        text: |-
...
helps['machinelearningservices online-endpoint get-token'] = """
    ...
    examples:
      - name: GetToken Online Endpoint Properties.
        text: |-
...
helps['machinelearningservices online-endpoint list-key'] = """
    type: command
    short-summary: "List AuthKeys for an Endpoint using Key-based authentication."
    examples:
      - name: ListKeys Online Endpoint Properties.
        text: |-
               az machinelearningservices online-endpoint list-key --endpoint-name "testEndpoint" --resource-group \
"testrg123" --workspace-name "testworkspace"
"""

helps['machinelearningservices online-endpoint poll'] = """
    type: command
    short-summary: "Polls an Endpoint operation."
    examples:
      - name: Poll Online Endpoint Properties.
        text: |-
...
helps['machinelearningservices online-endpoint regenerate-key'] = """
    type: command
    short-summary: "Regenerate AuthKeys for an Endpoint using Key-based authentication."
    examples:
      - name: RegenerateKeys Online Endpoint Properties.
        text: |-
