...
c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute aks create --compute-name "compute123" --location "e\
astus" --aks-properties "{\\"description\\":\\"some compute\\",\\"computeType\\":\\"AmlCompute\\",\\"properties\\":{\\"\
scaleSettings\\":{\\"maxNodeCount\\":4,\\"minNodeCount\\":4,\\"nodeIdleTimeBeforeScaleDown\\":\\"PT5M\\"}}}" --resource\
...
ompute123-56826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute aml-compute create --compute-name "compute123" --loc\
ation "eastus" --aml-compute-properties "{\\"description\\":\\"some compute\\",\\"computeType\\":\\"AmlCompute\\",\\"pr\
operties\\":{\\"scaleSettings\\":{\\"maxNodeCount\\":4,\\"minNodeCount\\":4,\\"nodeIdleTimeBeforeScaleDown\\":\\"PT5M\\\
...
ters/compute123-56826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute data-lake-analytics create --compute-name "compute12\
3" --location "eastus" --data-lake-analytics-properties description="some compute" computeType="AmlCompute" properties=\
{"scaleSettings":{"maxNodeCount":4,"minNodeCount":4,"nodeIdleTimeBeforeScaleDown":"PT5M"}} --resource-group "testrg123"\
...
826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute databricks create --compute-name "compute123" --loca\
tion "eastus" --databricks-properties description="some compute" computeType="AmlCompute" properties={"scaleSettings":{\
"maxNodeCount":4,"minNodeCount":4,"nodeIdleTimeBeforeScaleDown":"PT5M"}} --resource-group "testrg123" --workspace-name \
"workspaces123"
"""
