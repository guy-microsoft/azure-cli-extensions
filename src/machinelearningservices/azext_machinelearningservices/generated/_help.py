...
description "test description" --application-insights "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGrou\
ps/workspace-1234/providers/microsoft.insights/components/testinsights" --container-registry "/subscriptions/00000000-1\
111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.ContainerRegistry/registries/testRegistry"\
 --encryption-key-vault-properties identity-client-id="" key-identifier="https://testkv.vault.azure.net/keys/testkey/aa\
bbccddee112233445566778899aabb" key-vault-arm-id="/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/wo\
rkspace-1234/providers/Microsoft.KeyVault/vaults/testkv" --encryption-status "Enabled" --friendly-name "HelloName" --hb\
i-workspace false --key-vault "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/provid\
ers/Microsoft.KeyVault/vaults/testkv" --shared-private-link-resources name="testdbresource" private-link-resource-id="/\
subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.DocumentDB/databas\
eAccounts/testdbresource/privateLinkResources/Sql" group-id="Sql" request-message="Please approve" status="Approved" --\
storage-account "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/accountcrud-1234/providers/Microsof\
t.Storage/storageAccounts/testStorageAccount" --sku name="Basic" tier="Basic" --resource-group "workspace-1234" --works\
pace-name "testworkspace"
"""
...
chineLearningServices/workspaces/demo_workspace1/quotas/Standard_DSv2_Family_Cluster_Dedicated_vCPUs" limit=100 unit="C\
ount" --value type="Microsoft.MachineLearningServices/workspaces/quotas" id="/subscriptions/00000000-0000-0000-0000-000\
000000000/resourceGroups/rg/providers/Microsoft.MachineLearningServices/workspaces/demo_workspace2/quotas/Standard_DSv2\
_Family_Cluster_Dedicated_vCPUs" limit=200 unit="Count"
"""
...
astus" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Create a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute aks create --compute-name "compute123" --location "e\
astus" --aks-properties "{\\"remoteLoginPortPublicAccess\\":\\"NotSpecified\\",\\"scaleSettings\\":{\\"maxNodeCount\\":\
1,\\"minNodeCount\\":0,\\"nodeIdleTimeBeforeScaleDown\\":\\"PT5M\\"},\\"vmPriority\\":\\"Dedicated\\",\\"vmSize\\":\\"S\
TANDARD_NC6\\"}" --resource-group "testrg123" --workspace-name "workspaces123"
...
c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute aks create --compute-name "compute123" --location "e\
astus" --aks-properties "{\\"scaleSettings\\":{\\"maxNodeCount\\":1,\\"minNodeCount\\":0,\\"nodeIdleTimeBeforeScaleDown\
\\":\\"PT5M\\"},\\"vmPriority\\":\\"Dedicated\\",\\"vmSize\\":\\"STANDARD_NC6\\"}" --resource-group "testrg123" --works\
pace-name "workspaces123"
"""
...
ation "eastus" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Create a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute aml-compute create --compute-name "compute123" --loc\
ation "eastus" --aml-compute-properties "{\\"remoteLoginPortPublicAccess\\":\\"NotSpecified\\",\\"scaleSettings\\":{\\"\
...
ompute123-56826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute aml-compute create --compute-name "compute123" --loc\
ation "eastus" --aml-compute-properties "{\\"scaleSettings\\":{\\"maxNodeCount\\":1,\\"minNodeCount\\":0,\\"nodeIdleTim\
eBeforeScaleDown\\":\\"PT5M\\"},\\"vmPriority\\":\\"Dedicated\\",\\"vmSize\\":\\"STANDARD_NC6\\"}" --resource-group "te\
strg123" --workspace-name "workspaces123"
"""
...
3" --location "eastus" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Create a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute data-lake-analytics create --compute-name "compute12\
3" --location "eastus" --data-lake-analytics-properties remoteLoginPortPublicAccess="NotSpecified" scaleSettings={"maxN\
odeCount":1,"minNodeCount":0,"nodeIdleTimeBeforeScaleDown":"PT5M"} vmPriority="Dedicated" vmSize="STANDARD_NC6" --resou\
rce-group "testrg123" --workspace-name "workspaces123"
      - name: Create a DataFactory Compute
        text: |-
               az machinelearningservices machine-learning-compute data-lake-analytics create --compute-name "compute12\
3" --location "eastus" --resource-group "testrg123" --workspace-name "workspaces123"
...
ters/compute123-56826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute data-lake-analytics create --compute-name "compute12\
3" --location "eastus" --data-lake-analytics-properties scaleSettings={"maxNodeCount":1,"minNodeCount":0,"nodeIdleTimeB\
eforeScaleDown":"PT5M"} vmPriority="Dedicated" vmSize="STANDARD_NC6" --resource-group "testrg123" --workspace-name "wor\
kspaces123"
"""
...
tion "eastus" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Create a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute databricks create --compute-name "compute123" --loca\
tion "eastus" --databricks-properties remoteLoginPortPublicAccess="NotSpecified" scaleSettings={"maxNodeCount":1,"minNo\
deCount":0,"nodeIdleTimeBeforeScaleDown":"PT5M"} vmPriority="Dedicated" vmSize="STANDARD_NC6" --resource-group "testrg1\
23" --workspace-name "workspaces123"
      - name: Create a DataFactory Compute
        text: |-
               az machinelearningservices machine-learning-compute databricks create --compute-name "compute123" --loca\
tion "eastus" --resource-group "testrg123" --workspace-name "workspaces123"
...
826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
               az machinelearningservices machine-learning-compute databricks create --compute-name "compute123" --loca\
tion "eastus" --databricks-properties scaleSettings={"maxNodeCount":1,"minNodeCount":0,"nodeIdleTimeBeforeScaleDown":"P\
T5M"} vmPriority="Dedicated" vmSize="STANDARD_NC6" --resource-group "testrg123" --workspace-name "workspaces123"
"""
