...
from azext_machinelearningservices.action import (
    ...
    AddRetrySettings,
    AddPartitioningScheme,
    AddOutputConfiguration,
    AddBatchendpointsProperties,
    AddBatchendpointsTrafficRules,
    AddComputeConfiguration,
    AddKeys,
    ...
    AddProperties,
    AddOnlineendpointsTrafficRules
)
...
def load_arguments(self, _):
    ...
    with self.argument_context('machinelearningservices batch-deployment create') as c:
        ...
        c.argument('model_reference', action=AddModelReference, nargs='+', help='')
        c.argument('code_configuration', action=AddCodeConfiguration, nargs='+', help='')
        c.argument('environment_id', type=str, help='Environment specification for the endpoint deployment.')
        c.argument('error', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.')
        c.argument('compute_id', type=str, help='Resource ID of the compute resource', arg_group='Batch Settings')
        c.argument('error_threshold', type=int, help='Error threshold, if the error count for the entire input goes '
                   'above this value, the batch inference will be aborted. Range is [-1, int.MaxValue] -1 value '
                   'indicates, ignore all failures during batch inference For FileDataset count of file failures For '
                   'TabularDataset, this is the count of record failures', arg_group='Batch Settings')
        c.argument('retry_settings', action=AddRetrySettings, nargs='+', help='Retry settings for a batch inference '
                   'operation.', arg_group='Batch Settings')
        c.argument('partitioning_scheme', action=AddPartitioningScheme, nargs='+', help='Partitioning scheme for batch '
                   'inference operation.', arg_group='Batch Settings')
        c.argument('logging_level', arg_type=get_enum_type(['Info', 'Warning', 'Debug']), help='Logging level for '
                   'batch inference operation.', arg_group='Batch Settings')
        c.argument('output_configuration', action=AddOutputConfiguration, nargs='+', help='Batch inference output '
                   'configuration.', arg_group='Batch Settings')
        c.argument('node_count', type=int, help='Number of Compute nodes to be used for running the deployment',
                   arg_group='Scale Settings')
        c.argument('type_', options_list=['--type'], type=str, help='', arg_group='Identity')
        c.argument('system_identity_url', type=str, help='', arg_group='Identity')
        c.argument('principal_id', type=str, help='', arg_group='Identity')
        c.argument('tenant_id', type=str, help='', arg_group='Identity')
        c.argument('client_id', type=str, help='', arg_group='Identity')
        c.argument('client_secret_url', type=str, help='', arg_group='Identity')
        c.argument('user_assigned_identities', type=validate_file_or_dict, help='Dictionary of <UserAssignedIdentity> '
    ...
    with self.argument_context('machinelearningservices batch-endpoint create') as c:
        ...
        c.argument('location', arg_type=get_location_type(self.cli_ctx), required=False,
                   validator=get_default_location_from_resource_group)
        c.argument('kind', type=str, help='')
        c.argument('auth_mode', arg_type=get_enum_type(['AMLToken', 'Key', 'AADToken']), help='')
        ...
        c.argument('traffic_rules', action=AddBatchendpointsTrafficRules, nargs='+', help='Traffic rules on how the '
                   'traffic will be routed across deployments. Expect value: KEY1=VALUE1 KEY2=VALUE2 ...')
        c.argument('compute_configuration', action=AddComputeConfiguration, nargs='+', help='')
    ...
    with self.argument_context('machinelearningservices code-version create') as c:
        ...
        c.argument('asset_path', action=AddAssetPath, nargs='+', help='Details of an AssetUri.')
    ...
    with self.argument_context('machinelearningservices datastore create') as c:
        ...
        c.argument('azure_data_lake', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.',
                   arg_group='Contents')
        c.argument('azure_my_sql', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.',
                   arg_group='Contents')
        c.argument('azure_postgre_sql', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.',
                   arg_group='Contents')
        c.argument('azure_sql_database', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.',
                   arg_group='Contents')
        c.argument('azure_storage', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.',
                   arg_group='Contents')
        c.argument('gluster_fs', action=AddGlusterFs, nargs='+', help='', arg_group='Contents')
    ...
    with self.argument_context('machinelearningservices environment-specification-version list') as c:
        ...
        c.argument('orderby', type=str, help='')
        c.argument('top', type=str, help='')
        c.argument('skiptoken', type=str, help='Continuation token for pagination.')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='Name of Azure Machine Learning workspace.')
    ...
    with self.argument_context('machinelearningservices environment-specification-version create') as c:
        c.argument('name', type=str, help='')
        c.argument('version', type=str, help='')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='Name of Azure Machine Learning workspace.')
    ...
    with self.argument_context('machinelearningservices environment-specification-version update') as c:
        c.argument('name', type=str, help='', id_part='child_name_1')
        c.argument('version', type=str, help='', id_part='child_name_2')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='Name of Azure Machine Learning workspace.', id_part='name')
        c.argument('docker', action=AddDocker, nargs='+', help='Class to represent configuration settings for Docker')
        c.argument('conda_file', type=str, help='Standard configuration file used by conda that lets you install any '
    ...
    with self.argument_context('machinelearningservices job poll') as c:
        c.argument('id_', options_list=['--id'], type=str, help='The name and identifier for the Job.',
                   id_part='child_name_1')
        c.argument('operation_id', type=str, help='The operation ID of the async operation to be polled',
                   id_part='child_name_2')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='Name of Azure Machine Learning workspace.', id_part='name')
    ...
    with self.argument_context('machinelearningservices labeling-job create') as c:
        ...
        c.argument('label_categories', type=validate_file_or_dict, help='Label categories of the job. Expected value: '
                   'json-string/@json-file.')
        c.argument('dataset_configuration', action=AddDatasetConfiguration, nargs='+', help='Labeling dataset '
                   'configuration definition')
        c.argument('labeling_job_media_properties', action=AddLabelingJobMediaProperties, nargs='+', help='Properties '
                   'of a labeling job')
        c.argument('project_id', help='Internal id of the job(Previously called project).')
        c.argument('status', arg_type=get_enum_type(['NotStarted', 'Starting', 'Provisioning', 'Preparing', 'Queued',
                                                     'Running', 'Finalizing', 'CancelRequested', 'Completed', 'Failed',
                                                     'Canceled', 'NotResponding', 'Paused']),
                   help='Status of the job.')
        c.argument('created_time_utc', help='Created time of the job in UTC timezone.')
        c.argument('inferencing_compute_binding', action=AddInferencingComputeBinding, nargs='+', help='Compute '
                   'binding definition.', arg_group='Ml Assist Configuration')
        c.argument('training_compute_binding', action=AddInferencingComputeBinding, nargs='+', help='Compute binding '
                   'definition.', arg_group='Ml Assist Configuration')
    ...
    with self.argument_context('machinelearningservices labeling-job export-label') as c:
        ...
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='Name of Azure Machine Learning workspace.', id_part='name')
        c.argument('body', arg_type=get_enum_type(['Dataset', 'Coco', 'CSV']), help='The desired format of export '
                   'operation.')
    ...
    with self.argument_context('machinelearningservices labeling-job show-export-summary') as c:
        c.argument('id_', options_list=['--id'], type=str, help='The name and identifier for the LabelingJob.',
                   id_part='child_name_1')
        c.argument('export_id', help='The unique identifier of Export Labels operation.', id_part='child_name_2')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='Name of Azure Machine Learning workspace.', id_part='name')
    ...
    with self.argument_context('machinelearningservices online-deployment create') as c:
        ...
        c.argument('environment_id', type=str, help='Environment specification for the endpoint deployment.')
        c.argument('error', type=validate_file_or_dict, help=' Expected value: json-string/@json-file.')
        c.argument('environment_variables', action=AddEnvironmentVariables, nargs='+', help='Dictionary of <string> '
                   'Expect value: KEY1=VALUE1 KEY2=VALUE2 ...', arg_group='Environment Overrides')
        c.argument('type_', options_list=['--type'], type=str, help='', arg_group='Identity')
        c.argument('system_identity_url', type=str, help='', arg_group='Identity')
        c.argument('principal_id', type=str, help='', arg_group='Identity')
        c.argument('tenant_id', type=str, help='', arg_group='Identity')
    ...
    with self.argument_context('machinelearningservices online-deployment poll') as c:
        c.argument('endpoint_name', type=str, help='Inference endpoint name.', id_part='child_name_1')
        c.argument('deployment_name', type=str, help='The name and identifier for the endpoint.',
                   id_part='child_name_2')
        c.argument('operation_id', type=str, help='The operation ID of the async operation to be polled',
    ...
    with self.argument_context('machinelearningservices online-endpoint create') as c:
        ...
        c.argument('traffic_rules', action=AddOnlineendpointsTrafficRules, nargs='+', help='Traffic rules on how the '
                   'traffic will be routed across deployments. Expect value: KEY1=VALUE1 KEY2=VALUE2 ...')
        c.argument('compute_configuration', action=AddComputeConfiguration, nargs='+', help='')
    ...
    with self.argument_context('machinelearningservices online-endpoint poll') as c:
        c.argument('endpoint_name', type=str, help='The name and identifier for the endpoint.',
                   id_part='child_name_1')
        c.argument('operation_id', type=str, help='The operation ID of the async operation to be polled',
                   id_part='child_name_2')
        c.argument('resource_group_name', resource_group_name_type)
