...
class PrivateEndpointConnectionOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure_machine_learning_workspaces_dummy_change.models.PrivateEndpointConnection
    ...
    async def put(
        ...
        **kwargs
        ...
        :type private_link_service_connection_state: ~azure_machine_learning_workspaces_dummy_change.models.PrivateLinkServiceConnectionState
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateEndpointConnection, or the result of cls(response)
        :rtype: ~azure_machine_learning_workspaces_dummy_change.models.PrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError
