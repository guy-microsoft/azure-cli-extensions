...
class AzureMachineLearningWorkspacesDummyChangeOperationsMixin:
    ...
    def list_sku(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_machine_learning_workspaces_dummy_change.models.SkuListResult]
