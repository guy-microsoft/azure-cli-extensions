...
class LinkedWorkspaceOperations(object):
    ...
    def list(
        ...
        link_subscription_id=None,  # type: Optional[str]
        link_resource_group=None,  # type: Optional[str]
        link_resource_name=None,  # type: Optional[str]
        link_resource_id=None,  # type: Optional[str]
        uai_resource_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> List["LinkedWorkspace"]
        ...
        """
        cls = kwargs.pop('cls', None )  # type: ClsType[List["LinkedWorkspace"]]
    ...
    def create(
        ...
        user_assigned_identity_resource_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
