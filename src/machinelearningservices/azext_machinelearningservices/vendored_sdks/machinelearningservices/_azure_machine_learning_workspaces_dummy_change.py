...
class AzureMachineLearningWorkspacesDummyChange(AzureMachineLearningWorkspacesDummyChangeOperationsMixin):
    ...
    :vartype operation: azure_machine_learning_workspaces_dummy_change.operations.OperationOperations
    :ivar workspace: WorkspaceOperations operations
    :vartype workspace: azure_machine_learning_workspaces_dummy_change.operations.WorkspaceOperations
    :ivar workspace_feature: WorkspaceFeatureOperations operations
    :vartype workspace_feature: azure_machine_learning_workspaces_dummy_change.operations.WorkspaceFeatureOperations
    :ivar notebook: NotebookOperations operations
    :vartype notebook: azure_machine_learning_workspaces_dummy_change.operations.NotebookOperations
    :ivar usage: UsageOperations operations
    :vartype usage: azure_machine_learning_workspaces_dummy_change.operations.UsageOperations
    :ivar virtual_machine_size: VirtualMachineSizeOperations operations
    :vartype virtual_machine_size: azure_machine_learning_workspaces_dummy_change.operations.VirtualMachineSizeOperations
    :ivar quota: QuotaOperations operations
    :vartype quota: azure_machine_learning_workspaces_dummy_change.operations.QuotaOperations
    :ivar workspace_connection: WorkspaceConnectionOperations operations
    :vartype workspace_connection: azure_machine_learning_workspaces_dummy_change.operations.WorkspaceConnectionOperations
    :ivar machine_learning_compute: MachineLearningComputeOperations operations
    :vartype machine_learning_compute: azure_machine_learning_workspaces_dummy_change.operations.MachineLearningComputeOperations
    :ivar private_endpoint_connection: PrivateEndpointConnectionOperations operations
    :vartype private_endpoint_connection: azure_machine_learning_workspaces_dummy_change.operations.PrivateEndpointConnectionOperations
    :ivar private_link_resource: PrivateLinkResourceOperations operations
    :vartype private_link_resource: azure_machine_learning_workspaces_dummy_change.operations.PrivateLinkResourceOperations
    ...
    def __enter__(self):
        # type: () -> AzureMachineLearningWorkspacesDummyChange
