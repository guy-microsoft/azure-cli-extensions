...
For local jobs, a job endpoint will have a value of FileStreamObject.
    ...
    :param tracking: Any object.
    :type tracking: object
    :param studio: Any object.
    :type studio: object
    :param grafana: Any object.
    :type grafana: object
    :param tensorboard: Any object.
    :type tensorboard: object
    :param local: Any object.
    :type local: object
    :param local_request: Any object.
    ...
    def __init__(
        ...
        *,
        ...
        grafana: Optional[object] = None,
        tensorboard: Optional[object] = None,
        local: Optional[object] = None,
        local_request: Optional[object] = None,
        **kwargs
    ):
