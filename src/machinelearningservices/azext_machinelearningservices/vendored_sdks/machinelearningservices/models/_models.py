...
class AksNetworkingConfiguration(msrest.serialization.Model):
    ...
    _validation = {
        'service_cidr': {'pattern': '^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$'},
        'dns_service_ip': {'pattern': '^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$'},
        'docker_bridge_cidr': {'pattern': '^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$'},
    }
...
class AksProperties(msrest.serialization.Model):
    ...
    :param ssl_configuration: The ssl configuration for scoring.
    :type ssl_configuration: ~azure_machine_learning_workspaces.models.SslConfiguration
    :param aks_networking_configuration: Advance configuration for AKS networking.
...
class AmlComputeProperties(msrest.serialization.Model):
    ...
    :param user_account_credentials: Settings for user account that gets created on each on the
     nodes of a compute.
    :type user_account_credentials:
     ~azure_machine_learning_workspaces.models.UserAccountCredentials
    :param subnet: Represents a resource ID. For example, for a subnet, it is the resource URL for
     the subnet.
    ...
    :ivar node_state_counts: Counts of various compute node states on the amlCompute.
...
class EncryptionProperty(msrest.serialization.Model):
    ...
    :param key_vault_properties: Required.
...
class Identity(msrest.serialization.Model):
    ...
    :param user_assigned_identities: dictionary containing all the user assigned identities, with
     resourceId of the UAI as key.
...
class LinkedWorkspace(msrest.serialization.Model):
    ...
    :type link_name: str
    :ivar link_type: The type of the linked workspace. Default value: "Synapse".
    :vartype link_type: str
    :param subscription_id: SubscriptionId of the target of the linked workspace.
    :type subscription_id: str
    :param resource_group_name: Resource group name of the target of the linked workspace.
    :type resource_group_name: str
    :param provider_namespace: Resource provider namespace of the target of the linked workspace.
    :type provider_namespace: str
    :param resource_type: Resource type of the target of the linked workspace.
    :type resource_type: str
    :param workspace_name: Resource name of the target of the linked workspace.
    :type workspace_name: str
    :param resource_id: ResourceId of the target of the linked workspace.
    :type resource_id: str
    :param user_assigned_identity_resource_id: ResourceId of the user assigned identity that used
     to communicate with the linked workspace.
    :type user_assigned_identity_resource_id: str
    """

    _validation = {
        'link_type': {'readonly': True, 'constant': True},
    }

    _attribute_map = {
        'link_name': {'key': 'linkName', 'type': 'str'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.link_name = kwargs.get('link_name', None)
        self.link_type = None
        self.subscription_id = kwargs.get('subscription_id', None)
        self.resource_group_name = kwargs.get('resource_group_name', None)
        self.provider_namespace = kwargs.get('provider_namespace', None)
...
class LinkedWorkspaceCreateDto(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LinkedWorkspaceCreateDto, self).__init__(**kwargs)
        self.link_name = kwargs.get('link_name', None)
        self.resource_id = kwargs.get('resource_id', None)
        self.user_assigned_identity_resource_id = kwargs.get('user_assigned_identity_resource_id', None)


class LinkedWorkspaceUpdateDto(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LinkedWorkspaceUpdateDto, self).__init__(**kwargs)
        self.user_assigned_identity_resource_id = kwargs.get('user_assigned_identity_resource_id', None)
...
class MachineLearningServiceErrorException(HttpResponseError):
    """Server responded with exception of type: 'MachineLearningServiceError'.
    ...
    def __init__(self, response, error_model):
        self.error = error_model
        super(MachineLearningServiceErrorException, self).__init__(response=response, error_model=error_model)
    ...
    def from_response(cls, response, deserialize):
        ...
        :param deserialize: A deserializer
        """
        model_name = 'MachineLearningServiceError'
        error = deserialize(model_name, response)
        if error is None:
            error = deserialize.dependencies[model_name]()
        return error._EXCEPTION_TYPE(response, error)
...
class MachineLearningServiceError(msrest.serialization.Model):
    ...
    :ivar error: Error response information.
    :vartype error: ~azure_machine_learning_workspaces.models.ErrorResponse
    """
    _EXCEPTION_TYPE = MachineLearningServiceErrorException
...
class SharedPrivateLinkResourceProperty(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SharedPrivateLinkResourceProperty, self).__init__(**kwargs)
        self.private_link_resource_id = kwargs.get('private_link_resource_id', None)
        self.group_id = kwargs.get('group_id', None)
        self.request_message = kwargs.get('request_message', None)
        self.status = kwargs.get('status', None)
...
class Workspace(Resource):
    ...
    _attribute_map = {
        ...
        'linked_workspaces': {'key': 'properties.linkedWorkspaces', 'type': '{LinkedWorkspace}'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.linked_workspaces = kwargs.get('linked_workspaces', None)
...
class WorkspaceProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'key_vault': {'key': 'keyVault', 'type': 'str'},
        'application_insights': {'key': 'applicationInsights', 'type': 'str'},
        ...
        'hbi_workspace': {'key': 'hbiWorkspace', 'type': 'bool'},
        'service_provisioned_resource_group': {'key': 'serviceProvisionedResourceGroup', 'type': 'str'},
        'private_link_count': {'key': 'privateLinkCount', 'type': 'int'},
        'image_build_compute': {'key': 'imageBuildCompute', 'type': 'str'},
        'allow_public_access_when_behind_vnet': {'key': 'allowPublicAccessWhenBehindVnet', 'type': 'bool'},
        'private_endpoint_connections': {'key': 'privateEndpointConnections', 'type': '[PrivateEndpointConnection]'},
        'shared_private_link_resources': {'key': 'sharedPrivateLinkResources', 'type': '[SharedPrivateLinkResource]'},
        'linked_workspaces': {'key': 'linkedWorkspaces', 'type': '{LinkedWorkspace}'},
    }
...
class WorkspacePropertiesUpdateParameters(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(WorkspacePropertiesUpdateParameters, self).__init__(**kwargs)
        self.description = kwargs.get('description', None)
        self.friendly_name = kwargs.get('friendly_name', None)
