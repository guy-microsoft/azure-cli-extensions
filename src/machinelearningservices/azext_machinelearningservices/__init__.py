...
class AzureMachineLearningWorkspacesDummyChangeCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        parent = super(AzureMachineLearningWorkspacesDummyChangeCommandsLoader, self)
...
COMMAND_LOADER_CLS = AzureMachineLearningWorkspacesDummyChangeCommandsLoader
