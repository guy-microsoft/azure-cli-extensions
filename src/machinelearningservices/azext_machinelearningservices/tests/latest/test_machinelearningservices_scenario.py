...
from .example_steps import step_job_poll
from .example_steps import step_job_poll2
...
from .example_steps import step_labeling_job_show_export_summary
...
from .example_steps import step_online_deployment_poll
...
from .example_steps import step_online_endpoint_poll
...
def call_scenario(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6):
    ...
    step_batch_deployment_create(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_deployment_show(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_deployment_list(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_deployment_delete(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_endpoint_create(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_endpoint_show(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_endpoint_list(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_endpoint_list_key(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_batch_endpoint_delete(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    ...
    step_job_poll(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    step_job_poll2(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    ...
    step_labeling_job_show_export_summary(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    ...
    step_online_deployment_poll(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
    ...
    step_online_endpoint_poll(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=[])
