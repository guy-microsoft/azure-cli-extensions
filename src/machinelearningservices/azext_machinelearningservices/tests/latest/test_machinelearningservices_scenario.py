...
def step__machinelearningcompute_put_update_a_aml_compute(test, rg, rg_2, rg_3, rg_4, rg_5, rg_6):
    test.cmd('az machinelearningservices machine-learning-compute aks create '
             '--compute-name "compute123" '
             '--location "eastus" '
             '--aks-properties "{{\\"description\\":\\"some compute\\",\\"computeType\\":\\"AmlCompute\\",\\"properties'
...
def step__quotas_post_update_quotas(test, rg, rg_2, rg_3, rg_4, rg_5, rg_6):
    test.cmd('az machinelearningservices quota update '
             ...
             'esourceGroups/{rg_3}/providers/Microsoft.MachineLearningServices/workspaces/{demo_workspace1}/quotas/{Sta'
             'ndard_DSv2_Family_Cluster_Dedicated_vCPUs}" limit=100 unit="Count" '
             '--value type="Microsoft.MachineLearningServices/workspaces/quotas" id="/subscriptions/{subscription_id}/r'
             'esourceGroups/{rg_3}/providers/Microsoft.MachineLearningServices/workspaces/{Workspaces_2}/quotas/{Standa'
...
class AzureMachineLearningWorkspacesScenarioTest(ScenarioTest):
    ...
    def test_machinelearningservices(self, rg, rg_2, rg_3, rg_4, rg_5, rg_6):
        ...
        self.kwargs.update({
            ...
            'Standard_DSv2_Family_Cluster_Dedicated_vCPUs': 'Standard_DSv2_Family_Cluster_Dedicated_vCPUs',
