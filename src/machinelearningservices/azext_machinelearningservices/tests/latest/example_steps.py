...
@try_manual
def step_batch_deployment_create(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
    test.cmd('az machinelearningservices batch-deployment create '
             '--type "string" '
             '--client-secret-url "string" '
             '--system-identity-url "string" '
             '--kind "string" '
             '--location "string" '
             '--properties description="string" batchSettings={{"computeId":"string","errorThreshold":0,"loggingLevel":'
             '"Info","outputConfiguration":{{"appendRowFileName":"string","outputAction":"SummaryOnly"}},"partitioningS'
             'cheme":{{"miniBatchSize":0,"partitioningKeys":["string"]}},"retrySettings":{{"maximumRetries":0,"timeoutI'
             'nSeconds":0}}}} codeConfiguration={{"codeArtifactId":"string","command":"string"}} '
             'environmentId="string" modelReference={{"referenceType":"Id"}} properties={{"additionalProp1":"string","a'
             'dditionalProp2":"string","additionalProp3":"string"}} scaleSettings={{"nodeCount":0}} '
...
@try_manual
def step_batch_deployment_show(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_batch_deployment_list(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_batch_deployment_delete(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_batch_endpoint_create(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
    test.cmd('az machinelearningservices batch-endpoint create '
             ...
             'keys={{"primaryKey":"string","secondaryKey":"string"}} properties={{"additionalProp1":"string","additiona'
             'lProp2":"string","additionalProp3":"string"}} trafficRules={{"additionalProp1":0,"additionalProp2":0,"add'
             'itionalProp3":0}} '
             '--tags additionalProp1="string" additionalProp2="string" additionalProp3="string" '
             '--endpoint-name "testEndpoint" '
             '--resource-group "{rg_3}" '
...
@try_manual
def step_batch_endpoint_show(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_batch_endpoint_list(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_batch_endpoint_list_key(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_batch_endpoint_delete(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /OnlineDeployments/put/CreateOrUpdate Online Deployment Properties.
@try_manual
def step_online_deployment_create(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    ...
    test.cmd('az machinelearningservices online-deployment create '
             ...
             'deploymentConfiguration={{"appInsightsEnabled":true,"computeType":"Managed"}} environmentId="string" '
             'environmentOverrides={{"environmentVariables":{{"additionalProp1":"string","additionalProp2":"string","ad'
             'ditionalProp3":"string"}}}} modelReference={{"referenceType":"Id"}} properties={{"additionalProp1":"strin'
             'g","additionalProp2":"string","additionalProp3":"string"}} scaleSettings={{"maxNodeCount":0}} '
             '--tags additionalProp1="string" additionalProp2="string" additionalProp3="string" '
             '--deployment-name "1" '
             '--endpoint-name "{myMachinelearningservice3}" '
             '--resource-group "{rg_3}" '
             '--workspace-name "{myWorkspace7}"',
             checks=checks)


# EXAMPLE: /OnlineDeployments/get/Get Online Deployment Properties.
@try_manual
...
# EXAMPLE: /OnlineDeployments/get/List Online Deployment Properties.
@try_manual
...
# EXAMPLE: /OnlineDeployments/get/Poll Online Deployment Properties.
@try_manual
def step_online_deployment_poll(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
    test.cmd('az machinelearningservices online-deployment poll '
             '--operation-id "string" '
             '--deployment-name "1" '
             '--endpoint-name "{myMachinelearningservice3}" '
             '--resource-group "{rg_3}" '
...
# EXAMPLE: /OnlineDeployments/post/GetLogs Online Deployment Properties.
@try_manual
...
# EXAMPLE: /OnlineDeployments/delete/Delete Online Deployment Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/put/CreateOrUpdate Online Endpoint Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/get/Get Online Endpoint Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/get/List Online Endpoint Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/get/Poll Online Endpoint Properties.
@try_manual
def step_online_endpoint_poll(test, rg, rg_2, rg_5, rg_4, rg_7, rg_3, rg_6, checks=None):
    if checks is None:
        checks = []
    test.cmd('az machinelearningservices online-endpoint poll '
             '--operation-id "string" '
             '--endpoint-name "testEndpoint" '
             '--resource-group "{rg_3}" '
             '--workspace-name "{myWorkspace}"',
...
# EXAMPLE: /OnlineEndpoints/post/GetToken Online Endpoint Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/post/ListKeys Online Endpoint Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/post/RegenerateKeys Online Endpoint Properties.
@try_manual
...
# EXAMPLE: /OnlineEndpoints/delete/Delete Online Endpoint Properties.
@try_manual
