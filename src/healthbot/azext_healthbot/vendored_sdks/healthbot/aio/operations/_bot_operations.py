...
class BotOperations:
    ...
    async def _create_initial(
        ...
        **kwargs
        ...
        parameters = models.HealthBot(tags=tags, location=location, properties=properties, name_sku_name=name)
    ...
    async def update(
        ...
        **kwargs
        ...
        parameters = models.HealthBotUpdateParameters(tags=tags, name=name)
        api_version = "2020-12-08"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
