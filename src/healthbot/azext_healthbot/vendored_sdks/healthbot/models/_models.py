...
class HealthBot(TrackedResource):
    ...
    :param name_sku_name: Required. The name of the HealthBot SKU. Possible values include: "F0",
     "S1", "C0".
    :type name_sku_name: str or ~healthbot.models.SkuName
    """
...
class HealthBotUpdateParameters(msrest.serialization.Model):
    ...
    :type tags: dict[str, str]
    :param name: The name of the HealthBot SKU. Possible values include: "F0", "S1", "C0".
