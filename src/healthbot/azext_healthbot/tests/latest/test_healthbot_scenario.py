...
# EXAMPLE: /Bots/put/BatchAccountDelete
@try_manual
def step__bots_put_batchaccountdelete(test, rg, rg_2):
...
# EXAMPLE: /Bots/get/BatchAccountDelete
@try_manual
def step__bots_get_batchaccountdelete(test, rg, rg_2):
...
# EXAMPLE: /Bots/patch/BatchAccountDelete
@try_manual
def step__bots_patch_batchaccountdelete(test, rg, rg_2):
...
# EXAMPLE: /Bots/delete/BatchAccountDelete
@try_manual
def step__bots_delete_batchaccountdelete(test, rg, rg_2):
...
def call_scenario(test, rg, rg_2):
    setup(test, rg, rg_2)
    step__bots_put_batchaccountdelete(test, rg, rg_2)
    step__bots_get_batchaccountdelete(test, rg, rg_2)
    step__bots_get_list_bots_by_resource_group(test, rg, rg_2)
    step__bots_get_list_bots_by_subscription(test, rg, rg_2)
    step__bots_patch_batchaccountdelete(test, rg, rg_2)
    step__bots_delete_batchaccountdelete(test, rg, rg_2)
