...
class SubscriptionOperations:
    ...
    async def cancel(
        ...
        **kwargs
        ...
        query_parameters = {}  # type: Dict[str, Any]
        query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
        if self._config.ignore_resource_check is not None:
            query_parameters['IgnoreResourceCheck'] = self._serialize.query("self._config.ignore_resource_check", self._config.ignore_resource_check, 'bool')
