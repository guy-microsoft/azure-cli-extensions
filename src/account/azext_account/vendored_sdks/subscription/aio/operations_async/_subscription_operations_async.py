...
class SubscriptionOperations:
    ...
    async def change_tenant_request(
        self,
        subscription_id: str,
        destination_email: Optional[str] = None,
        **kwargs
    ) -> "models.ChangeTenantBody":
        """Change tenant request.

        :param subscription_id: Subscription Id.
        :type subscription_id: str
        :param destination_email: Email Id of the destination user.
        :type destination_email: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ChangeTenantBody, or the result of cls(response)
        :rtype: ~subscription_client.models.ChangeTenantBody
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ChangeTenantBody"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))

        _body = models.ChangeTenantBody(destination_email=destination_email)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")

        # Construct URL
        url = self.change_tenant_request.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'ChangeTenantBody')
        body_content_kwargs['content'] = body_content
        ...
        deserialized = self._deserialize('ChangeTenantBody', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    change_tenant_request.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Subscription/changeTenantRequest/default'}  # type: ignore

    async def get_change_tenant_request(
        self,
        subscription_id: str,
        **kwargs
    ) -> "models.ChangeTenantBody":
        """Get change tenant status.
        ...
        # Construct URL
        url = self.get_change_tenant_request.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    get_change_tenant_request.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Subscription/changeTenantRequest/default'}  # type: ignore

    async def delete_change_tenant_request(
        self,
        subscription_id: str,
        **kwargs
    ) -> "models.ChangeTenantBody":
        """Delete change tenant request.
        ...
        # Construct URL
        url = self.delete_change_tenant_request.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    delete_change_tenant_request.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Subscription/changeTenantRequest/default'}  # type: ignore

    async def accept_change_tenant_request(
        self,
        subscription_id: str,
        **kwargs
    ) -> None:
        """Accept change tenant request.
        ...
        # Construct URL
        url = self.accept_change_tenant_request.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    accept_change_tenant_request.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}/acceptChangeTenant'}  # type: ignore

    async def get_accept_change_tenant_status(
        self,
        subscription_id: str,
        **kwargs
    ) -> "models.ChangeTenantStatusBody":
        """Get accept change tenant status.

        :param subscription_id: Subscription Id.
        :type subscription_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ChangeTenantStatusBody, or the result of cls(response)
        :rtype: ~subscription_client.models.ChangeTenantStatusBody
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ChangeTenantStatusBody"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-10-01-preview"

        # Construct URL
        url = self.get_accept_change_tenant_status.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        deserialized = self._deserialize('ChangeTenantStatusBody', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    get_accept_change_tenant_status.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}/changeTenantStatus'}  # type: ignore
