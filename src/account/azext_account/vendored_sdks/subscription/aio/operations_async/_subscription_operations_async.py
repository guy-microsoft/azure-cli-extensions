...
class SubscriptionOperations:
    ...
    async def create_subscription(
     ...
     level agreement of the subscription. Use 0001 for Microsoft Azure Plan and 0002 for Microsoft
    ...
    async def _put_subscription_initial(
        self,
        subscription_id: str,
        properties: Optional["models.PutSubscriptionRequestProperties"] = None,
        **kwargs
    ) -> "models.PutSubscriptionResponse":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PutSubscriptionResponse"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))

        _body = models.PutSubscriptionRequest(properties=properties)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")

        # Construct URL
        url = self._put_subscription_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'PutSubscriptionRequest')
        body_content_kwargs['content'] = body_content
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('PutSubscriptionResponse', pipeline_response)
        ...
        return deserialized
    _put_subscription_initial.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}'}  # type: ignore
    ...
    async def put_subscription(
        ...
        **kwargs
        ...
        """The operation to create a new subscription or update the display name of an existing subscription.

        :param subscription_id: Subscription Id.
        :type subscription_id: str
        :param properties: Put subscription request properties.
        :type properties: ~subscription_client.models.PutSubscriptionRequestProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: PutSubscriptionResponse, or the result of cls(response)
        :rtype: ~subscription_client.models.PutSubscriptionResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PutSubscriptionResponse"]
        ...
        raw_result = await self._put_subscription_initial(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    put_subscription.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}'}  # type: ignore
    ...
    async def get_subscription(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PutSubscriptionResponse, or the result of cls(response)
        :rtype: ~subscription_client.models.PutSubscriptionResponse or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PutSubscriptionResponse"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        ...
        return deserialized
    get_subscription.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}'}  # type: ignore
