...
class SubscriptionOperationOperations:
    ...
    async def _get_initial(
        ...
        **kwargs
        ...
        return deserialized
    _get_initial.metadata = {'url': '/providers/Microsoft.Subscription/subscriptionOperations/{operationId}'}  # type: ignore
    ...
    begin_get.metadata = {'url': '/providers/Microsoft.Subscription/subscriptionOperations/{operationId}'}  # type: ignore
