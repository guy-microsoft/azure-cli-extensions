...
class SubscriptionClient(object):
    ...
    :param ignore_resource_check: Ignore existing resources in the subscription to be cancelled.
    ...
    def __init__(
        ...
        ignore_resource_check: Optional[bool] = None,
        base_url: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        if not base_url:
            base_url = 'https://management.azure.com'
        self._config = SubscriptionClientConfiguration(credential, ignore_resource_check, **kwargs)
