...
class SubscriptionPolicyOperations(object):
    ...
    def add_update_policy_for_tenant(
        self,
        body,  # type: "models.PutTenantPolicyRequestProperties"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.GetTenantPolicyResponse"
        """Create or Update Subscription tenant policy for user's tenant.

        :param body:
        :type body: ~subscription_client.models.PutTenantPolicyRequestProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GetTenantPolicyResponse, or the result of cls(response)
        :rtype: ~subscription_client.models.GetTenantPolicyResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.GetTenantPolicyResponse"]
        error_map = {
    ...
    def list_policy_for_tenant(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.GetTenantPolicyListResponse"]
        """Get the subscription tenant policy for the user's tenant.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either GetTenantPolicyListResponse or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~subscription_client.models.GetTenantPolicyListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.GetTenantPolicyListResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
