...
class ChangeTenantBody(msrest.serialization.Model):
    """The parameters required to perform change tenant operation.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar id: Subscription Id.
    :vartype id: str
    :ivar name: Subscription Name.
    :vartype name: str
    :ivar type: Resource type.
    :vartype type: str
    :param destination_email: Email Id of the destination user.
    :type destination_email: str
    :ivar status: Current transfer Status. Possible values include: "Initiated", "InProgress",
     "Completed".
    :vartype status: str or ~subscription_client.models.Status
    :ivar expires_on: Expiry time of the transfer.
    ...
    _attribute_map = {
        ...
        'destination_email': {'key': 'properties.destinationEmail', 'type': 'str'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ChangeTenantBody, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
        self.destination_email = kwargs.get('destination_email', None)
        self.status = None
        self.expires_on = None


class ChangeTenantStatusBody(msrest.serialization.Model):
    """The response body for get change tenant status.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar status: Change tenant status.
    :vartype status: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ChangeTenantStatusBody, self).__init__(**kwargs)
        self.status = None
