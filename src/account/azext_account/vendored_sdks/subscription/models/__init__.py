...
try:
    ...
    from ._models_py3 import ChangeTenantBody
    from ._models_py3 import ChangeTenantStatusBody
    ...
    from ._models import ChangeTenantBody  # type: ignore
    from ._models import ChangeTenantStatusBody  # type: ignore
