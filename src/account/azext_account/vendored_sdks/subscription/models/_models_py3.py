...
class BillingAccountPoliciesResponseProperties(msrest.serialization.Model):
    ...
    :type service_tenants: list[~subscription_client.models.ServiceTenantResponse]
...
class GetTenantPolicyListResponse(msrest.serialization.Model):
    ...
    :vartype value: list[~subscription_client.models.GetTenantPolicyResponse]
...
class GetTenantPolicyResponse(msrest.serialization.Model):
    ...
    :type properties: ~subscription_client.models.TenantPolicy
    """
...
class RedeemSubscriptionRequest(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        properties: Optional["RedeemSubscriptionRequestProperties"] = None,
        **kwargs
    ):
...
class SubscriptionAliasListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~subscription_client.models.SubscriptionAliasResponse]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
...
class SubscriptionAliasResponse(msrest.serialization.Model):
    ...
    :type properties: ~subscription_client.models.SubscriptionAliasResponseProperties
    """
...
class SubscriptionAliasResponseProperties(msrest.serialization.Model):
    ...
    :ivar redeem_state: The redeem state of the resource. Possible values include: "Pending",
     "Completed".
    :vartype redeem_state: str or ~subscription_client.models.RedeemState
    """
