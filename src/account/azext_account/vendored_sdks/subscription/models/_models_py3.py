...
class ModernCspSubscriptionCreationParameters(msrest.serialization.Model):
    ...
    :param sku_id: Required. The SKU ID of the Azure plan. Azure plan determines the pricing and
     service-level agreement of the subscription. Use 0001 for Microsoft Azure Plan and 0002 for
...
class PutSubscriptionRequest(msrest.serialization.Model):
    """The parameters required to create a new subscription.
    ...
    def __init__(
        self,
        *,
        properties: Optional["PutSubscriptionRequestProperties"] = None,
        **kwargs
    ):
...
class PutSubscriptionRequestProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        sku_id: str,
        billing_scope: str,
        initial_owner_principal_id: Optional[str] = None,
        initial_owner_tenant_id: Optional[str] = None,
        **kwargs
    ):
...
class PutSubscriptionResponse(msrest.serialization.Model):
    ...
    :type properties: ~subscription_client.models.PutSubscriptionResponseProperties
    """
    ...
    def __init__(
        ...
        *,
        ...
        properties: Optional["PutSubscriptionResponseProperties"] = None,
        **kwargs
    ):
...
class PutSubscriptionResponseProperties(msrest.serialization.Model):
