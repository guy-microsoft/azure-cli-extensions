...
def account_subscription_get_subscription(client,
                                          subscription_id):
    return client.get_subscription(subscription_id=subscription_id)


def account_subscription_put_subscription(client,
                                          subscription_id,
                                          properties=None):
    return client.begin_put_subscription(subscription_id=subscription_id,
