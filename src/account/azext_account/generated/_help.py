...
helps['account subscription delete'] = """
    type: command
    short-summary: Delete change tenant request.
"""

helps['account subscription accept-change-tenant-request'] = """
    type: command
    short-summary: Accept change tenant request.
"""
...
helps['account subscription change-tenant-request'] = """
    type: command
    short-summary: Change tenant request.
"""
...
helps['account subscription get-accept-change-tenant-status'] = """
    type: command
    short-summary: Get accept change tenant status.
"""

helps['account subscription get-change-tenant-request'] = """
    type: command
    short-summary: Get change tenant status.
"""
