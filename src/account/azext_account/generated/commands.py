...
def load_command_table(self, _):
    ...
    with self.command_group('account subscription', account_subscription, client_factory=cf_subscription,
        ...
        g.custom_command('accept-change-tenant-request', 'account_subscription_accept_change_tenant_request')
        g.custom_command('cancel', 'account_subscription_cancel')
        g.custom_command('change-tenant-request', 'account_subscription_change_tenant_request')
        ...
        g.custom_command('get-accept-change-tenant-status', 'account_subscription_get_accept_change_tenant_status')
        g.custom_command('get-change-tenant-request', 'account_subscription_get_change_tenant_request')
