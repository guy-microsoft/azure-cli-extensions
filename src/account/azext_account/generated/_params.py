...
def load_arguments(self, _):
    ...
    with self.argument_context('account subscription accept-change-tenant-request') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')

    with self.argument_context('account subscription cancel') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')

    with self.argument_context('account subscription change-tenant-request') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')
        c.argument('destination_email', help='Email Id of the destination user')
    ...
    with self.argument_context('account subscription get-accept-change-tenant-status') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')

    with self.argument_context('account subscription get-change-tenant-request') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')
