...
def load_arguments(self, _):
    ...
    with self.argument_context('account subscription create-csp-subscription') as c:
        ...
        c.argument('sku_id', help='The SKU ID of the Azure plan. Azure plan determines the pricing and service-level ag'
                   'reement of the subscription. Use 0001 for Microsoft Azure Plan and 0002 for Microsoft Azure Plan fo'
                   'r DevTest.')
    ...
    with self.argument_context('account subscription get-subscription') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')

    with self.argument_context('account subscription put-subscription') as c:
        c.argument('subscription_id', help='Subscription Id.', id_part='subscription')
        c.argument('properties', action=AddProperties, nargs='+', help='Put subscription request properties.')
