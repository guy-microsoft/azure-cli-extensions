...
# EXAMPLE: /Subscription/put/createSubscription
@try_manual
def step__subscription_put_createsubscription(test):
    test.cmd('az account subscription put-subscription '
             ...
             'T4-OBS7-PJA-TGB" display-name="Contoso MCA subscription" sku-id="0001" '
             '--subscription-id "291bba3f-e0a5-47bc-a099-3bdcb2a50a05"',
             checks=[])


# EXAMPLE: /Subscription/get/getSubscription
@try_manual
def step__subscription_get_getsubscription(test):
    test.cmd('az account subscription get-subscription '
             '--subscription-id "291bba3f-e0a5-47bc-a099-3bdcb2a50a05"',
             checks=[])
...
def call_scenario(test):
    setup(test)
    step__subscription_put_createsubscription(test)
    step__subscription_get_getsubscription(test)
