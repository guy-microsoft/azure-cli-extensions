...
### account subscription accept-change-tenant-request

accept-change-tenant-request a account subscription.
...
|------|----|-----------|----------|--------------|
|**--subscription-id**|string|Subscription Id.|subscription_id|
### account subscription change-tenant-request

change-tenant-request a account subscription.

|Option|Type|Description|Path (SDK)|Path (swagger)|
|------|----|-----------|----------|--------------|
|**--subscription-id**|string|Subscription Id.|subscription_id|
|**--destination-email**|string|Email Id of the destination user|destination_email|
...
|------|----|-----------|----------|--------------|
|**--subscription-id**|string|Subscription Id.|subscription_id|
### account subscription get-accept-change-tenant-status

get-accept-change-tenant-status a account subscription.

|Option|Type|Description|Path (SDK)|Path (swagger)|
|------|----|-----------|----------|--------------|
|**--subscription-id**|string|Subscription Id.|subscription_id|
### account subscription get-change-tenant-request

get-change-tenant-request a account subscription.
