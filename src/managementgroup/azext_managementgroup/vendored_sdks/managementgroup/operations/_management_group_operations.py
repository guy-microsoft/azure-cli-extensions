...
class ManagementGroupOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ManagementGroupListResult"
        """List management groups for the authenticated user.

        :param cache_control: Indicates that the request shouldn't utilize any caches.
        :type cache_control: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagementGroupListResult or the result of cls(response)
        :rtype: ~azure.mgmt.managementgroups.models.ManagementGroupListResult
    ...
    def _create_or_update_initial(
        ...
        parent=None,  # type: Optional["models.CreateParentGroupInfo"]
        **kwargs  # type: Any
    ):
        ...
        _create_management_group_request = models.CreateManagementGroupRequest(name=name, display_name=display_name, parent=parent)
        api_version = "2020-02-01"
    ...
    If a management group is already created and a subsequent create request is issued with different properties, the management group properties will be updated.
     ...
     field will be set to the groupId.
        ...
        :return: An instance of LROPoller that returns ManagementGroup
    ...
    If a management group contains child resources, the request will fail.
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns AzureAsyncOperationResults
    ...
    def get_descendant(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DescendantListResult"
        """List all entities that descend from a management group.

        :param group_id: Management Group ID.
        :type group_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DescendantListResult or the result of cls(response)
        :rtype: ~azure.mgmt.managementgroups.models.DescendantListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.get_descendant.metadata['url']
                path_format_arguments = {
                    'groupId': self._serialize.url("group_id", group_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    get_descendant.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}/descendants'}
