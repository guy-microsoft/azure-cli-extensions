...
class EncryptionKeyDetailsKekType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class IdentityDetailsType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
