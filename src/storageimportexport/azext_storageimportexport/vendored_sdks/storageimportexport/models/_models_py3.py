...
class EncryptionKeyDetails(msrest.serialization.Model):
    ...
    :type kek_type: str or ~storage_import_export.models.EncryptionKeyDetailsKekType
    ...
    def __init__(
        self,
        *,
        kek_type: Optional[Union[str, "EncryptionKeyDetailsKekType"]] = "MicrosoftManaged",
...
class IdentityDetails(msrest.serialization.Model):
    ...
    :type type: str or ~storage_import_export.models.IdentityDetailsType
    ...
    def __init__(
        self,
        *,
        type: Optional[Union[str, "IdentityDetailsType"]] = "None",
        **kwargs
    ):
...
class JobDetails(msrest.serialization.Model):
    ...
    :param affinity_id: Specifies the provisioning state of the job.
...
class PutJobParameters(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'percent_complete': {'key': 'properties.percentComplete', 'type': 'long'},
        ...
        'encryption_key': {'key': 'properties.encryptionKey', 'type': 'EncryptionKeyDetails'},
        'affinity_id': {'key': 'properties.affinityId', 'type': 'str'},
    }
