...
class JobOperations(object):
    ...
    def create(
        ...
        encryption_key=None,  # type: Optional["models.EncryptionKeyDetails"]
        affinity_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.JobResponse"
