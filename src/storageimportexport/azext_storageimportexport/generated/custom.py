...
def storageimportexport_job_create(client,
    ...
    body['properties']['backup_drive_manifest'] = backup_drive_manifest
    body['properties']['state'] = state
    body['properties']['cancel_requested'] = cancel_requested
...
def storageimportexport_job_update(client,
    ...
    body = {}
    body['tags'] = tags
    body['cancel_requested'] = cancel_requested
    body['state'] = state
    ...
    body['backup_drive_manifest'] = backup_drive_manifest
