...
def storageimportexport_job_create(cmd, client,
    ...
    if isinstance(export_blob_list_blob_path, str):
        export_blob_list_blob_path = json.loads(export_blob_list_blob_path)
    if isinstance(export_blob_list_blob_path_prefix, str):
        export_blob_list_blob_path_prefix = json.loads(export_blob_list_blob_path_prefix)
