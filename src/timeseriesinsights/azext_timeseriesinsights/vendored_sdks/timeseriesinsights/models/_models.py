...
class EnvironmentCreateOrUpdateParameters(CreateOrUpdateTrackedResourceProperties):
    ...
    :param kind: Required. The kind of the environment.Constant filled by server.  Possible values
     include: "Gen1", "Gen2", "Microsoft.EventHub", "Microsoft.IoTHub".
    :type kind: str or ~time_series_insights_client.models.Kind
...
class Gen1EnvironmentResourceProperties(Gen1EnvironmentCreationProperties):
