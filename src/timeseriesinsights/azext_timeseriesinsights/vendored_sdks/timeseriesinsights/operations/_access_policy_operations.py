...
class AccessPolicyOperations(object):
    ...
    def create_or_update(
        ...
        principal_object_id=None,  # type: Optional[str]
        description=None,  # type: Optional[str]
        roles=None,  # type: Optional[List[Union[str, "models.AccessPolicyRole"]]]
        **kwargs  # type: Any
    ):
        ...
        parameters = models.AccessPolicyCreateOrUpdateParameters(principal_object_id=principal_object_id, description=description, roles=roles)
