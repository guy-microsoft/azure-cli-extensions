...
class DataFactoryManagementClient(object):
    ...
    :vartype private_end_point_connection: data_factory_management_client.aio.operations.PrivateEndPointConnectionOperations
    ...
    :vartype private_link_resource: data_factory_management_client.aio.operations.PrivateLinkResourceOperations
