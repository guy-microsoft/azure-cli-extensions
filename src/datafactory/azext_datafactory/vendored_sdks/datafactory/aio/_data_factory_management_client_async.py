...
from .operations_async import CredentialOperationOperations
from .. import models
...
class DataFactoryManagementClient(object):
    ...
    :vartype credential_operation: data_factory_management_client.aio.operations_async.CredentialOperationOperations
