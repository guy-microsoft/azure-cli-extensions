...
def load_command_table(self, _):
    ...
    from azext_datafactory.generated._client_factory import cf_credential_operation
    datafactory_credential_operation = CliCommandType(
        operations_tmpl='azext_datafactory.vendored_sdks.datafactory.operations._credential_operation_operations#Creden'
        'tialOperationOperations.{}',
        client_factory=cf_credential_operation)
    with self.command_group('datafactory credential-operation', datafactory_credential_operation,
                            client_factory=cf_credential_operation, is_experimental=True) as g:
        g.custom_command('list', 'datafactory_credential_operation_list')
        g.custom_show_command('show', 'datafactory_credential_operation_show')
        g.custom_command('create', 'datafactory_credential_operation_create')
        g.generic_update_command('update', setter_arg_name='properties', custom_func_name=''
                                 'datafactory_credential_operation_update')
        g.custom_command('delete', 'datafactory_credential_operation_delete', confirmation=True)
