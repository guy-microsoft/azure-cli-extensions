...
helps['datafactory credential-operation'] = """
    type: group
    short-summary: datafactory credential-operation
"""

helps['datafactory credential-operation list'] = """
    type: command
    short-summary: "List credentials."
    examples:
      - name: Credentials_ListByFactory
        text: |-
               az datafactory credential-operation list --factory-name "exampleFactoryName" --resource-group \
"exampleResourceGroup"
"""

helps['datafactory credential-operation show'] = """
    type: command
    short-summary: "Gets a credential."
    examples:
      - name: Credentials_Get
        text: |-
               az datafactory credential-operation show --credential-name "exampleCredentialName" --factory-name \
"exampleFactoryName" --resource-group "exampleResourceGroup"
"""

helps['datafactory credential-operation create'] = """
    type: command
    short-summary: "Creates or updates a credential."
    examples:
      - name: Credentials_Create
        text: |-
               az datafactory credential-operation create --properties "{\\"type\\":\\"ServicePrincipal\\",\\"typePrope\
rties\\":{\\"servicePrincipalId\\":\\"12345678-1234-1234-1234-12345678abc\\",\\"servicePrincipalKey\\":{\\"type\\":\\"A\
zureKeyVaultSecret\\",\\"secretName\\":\\"ServicePrincipalKey\\",\\"store\\":{\\"type\\":\\"LinkedServiceReference\\",\
\\"referenceName\\":\\"AzureKeyVaultStorage\\"}},\\"tenant\\":\\"12345678-1234-1234-1234-12345678123\\"}}" \
--credential-name "exampleCredentialName" --factory-name "exampleFactoryName" --resource-group "exampleResourceGroup"
"""

helps['datafactory credential-operation update'] = """
    type: command
    short-summary: "Creates or updates a credential."
"""

helps['datafactory credential-operation delete'] = """
    type: command
    short-summary: "Deletes a credential."
    examples:
      - name: Credentials_Delete
        text: |-
               az datafactory credential-operation delete --credential-name "exampleCredentialName" --factory-name \
"exampleFactoryName" --resource-group "exampleResourceGroup"
"""
