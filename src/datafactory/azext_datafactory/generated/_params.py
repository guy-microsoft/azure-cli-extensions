...
def load_arguments(self, _):
    ...
    with self.argument_context('datafactory credential-operation list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('factory_name', type=str, help='The factory name.')

    with self.argument_context('datafactory credential-operation show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('factory_name', type=str, help='The factory name.', id_part='name')
        c.argument('credential_name', type=str, help='Credential name', id_part='child_name_1')
        c.argument('if_none_match', type=str, help='ETag of the credential entity. Should only be specified for get. '
                   'If the ETag matches the existing entity tag, or if * was provided, then no content will be '
                   'returned.')

    with self.argument_context('datafactory credential-operation create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('factory_name', type=str, help='The factory name.')
        c.argument('credential_name', type=str, help='Credential name')
        c.argument('if_match', type=str, help='ETag of the credential entity. Should only be specified for update, for '
                   'which it should match existing entity or can be * for unconditional update.')
        c.argument('properties', type=validate_file_or_dict, help='Properties of credentials. Expected value: '
                   'json-string/@json-file.')

    with self.argument_context('datafactory credential-operation update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('factory_name', type=str, help='The factory name.', id_part='name')
        c.argument('credential_name', type=str, help='Credential name', id_part='child_name_1')
        c.argument('if_match', type=str, help='ETag of the credential entity. Should only be specified for update, for '
    ...
    with self.argument_context('datafactory credential-operation delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('factory_name', type=str, help='The factory name.', id_part='name')
        c.argument('credential_name', type=str, help='Credential name', id_part='child_name_1')
