...
def datafactory_credential_operation_list(client,
                                          resource_group_name,
                                          factory_name):
    return client.list_by_factory(resource_group_name=resource_group_name,
                                  factory_name=factory_name)
...
def datafactory_credential_operation_show(client,
                                          resource_group_name,
                                          factory_name,
                                          credential_name,
                                          if_none_match=None):
...
def datafactory_credential_operation_create(client,
                                            resource_group_name,
                                            factory_name,
                                            credential_name,
                                            properties,
...
def datafactory_credential_operation_update(instance,
                                            resource_group_name,
                                            factory_name,
                                            credential_name,
                                            if_match=None):
...
def datafactory_credential_operation_delete(client,
                                            resource_group_name,
                                            factory_name,
                                            credential_name):
    return client.delete(resource_group_name=resource_group_name,
