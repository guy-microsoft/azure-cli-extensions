...
|[az datafactory private-endpoint-connection approve-or-reject](#PrivateEndpointConnectionApprovesOrRejects)|ApprovesOrRejects|[Parameters](#ParametersPrivateEndpointConnectionApprovesOrRejects)|[Example](#ExamplesPrivateEndpointConnectionApprovesOrRejects)|
...
#### <a name="PrivateEndpointConnectionApprovesOrRejects">Command `az datafactory private-endpoint-connection approve-or-reject`</a>

##### <a name="ExamplesPrivateEndpointConnectionApprovesOrRejects">Example</a>
```
az datafactory private-endpoint-connection approve-or-reject --factory-name "exampleFactoryName" --name "connection" \
--private-link-service-connection-state description="Approved by admin." actions-required="" status="Approved" \
--resource-group "exampleResourceGroup"
```
##### <a name="ParametersPrivateEndpointConnectionApprovesOrRejects">Parameters</a> 
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--resource-group-name**|string|The resource group name.|resource_group_name|resourceGroupName|
|**--factory-name**|string|The factory name.|factory_name|factoryName|
