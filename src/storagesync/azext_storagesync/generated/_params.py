...
def load_arguments(self, _):
    ...
    with self.argument_context('storagesync storage-sync-service create') as c:
        ...
        c.argument('properties', arg_type=CLIArgumentType(options_list=['--properties'], help='Any object Expected valu'
    ...
    with self.argument_context('storagesync storage-sync-service update') as c:
        ...
        c.argument('storage_sync_service_name', help='Name of Storage Sync Service resource.')
        c.argument('tags', tags_type)
        c.argument('properties', arg_type=CLIArgumentType(options_list=['--properties'], help='The properties of the st'
                   'orage sync service. Expected value: json-string/@json-file.'))
