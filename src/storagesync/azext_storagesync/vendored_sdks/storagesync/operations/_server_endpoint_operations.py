...
class ServerEndpointOperations(object):
    ...
    def _create_initial(
        ...
        initial_upload_policy=None,  # type: Optional[Union[str, "models.InitialUploadPolicy"]]
        **kwargs  # type: Any
    ):
