...
class ServerEndpointOperations:
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        _parameters = models.ServerEndpointUpdateParameters(cloud_tiering=cloud_tiering, volume_free_space_percent=volume_free_space_percent, tier_files_older_than_days=tier_files_older_than_days, offline_data_transfer=offline_data_transfer, offline_data_transfer_share_name=offline_data_transfer_share_name)
        api_version = "2019-10-01"
        content_type = kwargs.pop("content_type", "application/json")
