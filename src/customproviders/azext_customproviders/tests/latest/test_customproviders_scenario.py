...
class CustomprovidersScenarioTest(ScenarioTest):
    ...
    def test_customproviders(self, rg, rg_2):
        ...
        self.kwargs.update({
            'associationName': self.create_random_name(prefix='clitestassociations'[:7], length=24),
        })

        setup(self, rg, rg_2)
        step__associations_put_create_or_update_an_association(self, rg, rg_2)
        step__customresourceprovider_put_create_or_update_the_custom_resource_provider(self, rg, rg_2)
        step__customresourceprovider_get_get_a_custom_resource_provider(self, rg, rg_2)
        step__associations_get_get_an_association(self, rg, rg_2)
        step__customresourceprovider_get_list_all_custom_resource_providers_on_the_resourcegroup(self, rg, rg_2)
        step__customresourceprovider_get_list_all_custom_resource_providers_on_the_subscription(self, rg, rg_2)
        step__customresourceprovider_patch_update_a_custom_resource_provider(self, rg, rg_2)
        step__associations_get_get_all_associations(self, rg, rg_2)
        step__customresourceprovider_delete_delete_a_custom_resource_provider(self, rg, rg_2)
        step__associations_delete_delete_an_association(self, rg, rg_2)
