...
class GenerateDetailedCostReportOperations(object):
    ...
    def _create_operation_initial(
        self,
        scope,  # type: str
        metric=None,  # type: Optional[Union[str, "models.GenerateDetailedCostReportMetricType"]]
        time_period=None,  # type: Optional["models.GenerateDetailedCostReportTimePeriod"]
        billing_period=None,  # type: Optional[str]
