...
class GenerateDetailedCostReportDefinition(msrest.serialization.Model):
    ...
    :param metric: The type of the detailed report. By default ActualCost is provided. Possible
...
class GenerateDetailedCostReportOperationResult(msrest.serialization.Model):
    ...
    :type valid_till: ~datetime.datetime
    """
...
class GenerateDetailedCostReportTimePeriod(msrest.serialization.Model):
    ...
    :param start: Required. The start date to pull data from. example format 2020-03-15.
    :type start: str
    :param end: Required. The end date to pull data to. example format 2020-03-15.
    :type end: str
    """
...
class Status(msrest.serialization.Model):
    ...
    :param status: The status of the long running operation. Possible values include: "InProgress",
