...
from .operations import GenerateDetailedCostReportOperationResultOperations
...
class CostManagementClient(object):
    ...
    :ivar generate_detailed_cost_report_operation_result: GenerateDetailedCostReportOperationResultOperations operations
    :vartype generate_detailed_cost_report_operation_result: cost_management_client.aio.operations.GenerateDetailedCostReportOperationResultOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.generate_detailed_cost_report = GenerateDetailedCostReportOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.generate_detailed_cost_report_operation_result = GenerateDetailedCostReportOperationResultOperations(
            self._client, self._config, self._serialize, self._deserialize)
