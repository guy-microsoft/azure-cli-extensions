...
@try_manual
def step_generate_detailed_cost(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_generate_detailed_cost2(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--invoice-id "M1234567" '
...
@try_manual
def step_generate_detailed_cost3(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--customer-id "456789" '
...
@try_manual
def step_generate_detailed_cost4(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--metric "ActualCost" '
...
@try_manual
def step_generate_detailed_cost5(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--metric "ActualCost" '
...
@try_manual
def step_generate_detailed_cost6(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_generate_detailed_cost7(test, rg, checks=None):
    if checks is None:
        checks = []
