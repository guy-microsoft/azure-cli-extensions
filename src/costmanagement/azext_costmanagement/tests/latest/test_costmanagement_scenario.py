...
# EXAMPLE: /GenerateDetailedCostReport/post/GenerateDetailedCostReportByBillingAccountLegacyAndBillingPeriod
@try_manual
def step__generatedetailedcostreport_post(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--billing-period "202008" '
             '--metric "ActualCost" '
             '--scope "providers/Microsoft.Billing/billingAccounts/12345"',
             checks=[])


# EXAMPLE: /GenerateDetailedCostReport/post/GenerateDetailedCostReportByBillingProfileAndInvoiceId
@try_manual
def step__generatedetailedcostreport_post2(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--invoice-id "M1234567" '
             '--metric "ActualCost" '
             '--scope "providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579"',
...
# EXAMPLE: /GenerateDetailedCostReport/post/GenerateDetailedCostReportByBillingProfileAndInvoiceIdAndCustomerId
@try_manual
def step__generatedetailedcostreport_post3(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--customer-id "456789" '
             '--invoice-id "M1234567" '
             '--metric "ActualCost" '
...
# EXAMPLE: /GenerateDetailedCostReport/post/GenerateDetailedCostReportByCustomerAndTimePeriod
@try_manual
def step__generatedetailedcostreport_post4(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--metric "ActualCost" '
             '--time-period end="2020-03-15" start="2020-03-01" '
             '--scope "providers/Microsoft.Billing/billingAccounts/12345:6789/customers/13579"',
             checks=[])


# EXAMPLE: /GenerateDetailedCostReport/post/GenerateDetailedCostReportBySubscriptionAndTimePeriod
@try_manual
def step__generatedetailedcostreport_post5(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report create-operation '
             '--metric "ActualCost" '
             '--time-period end="2020-03-15" start="2020-03-01" '
...
# EXAMPLE: /GenerateDetailedCostReportOperationResults/get/Get details of the operation
@try_manual
def step__generatedetailedcostreportoperationresults_g(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report-operation-result show '
             '--operation-id "00000000-0000-0000-0000-000000000000" '
             '--scope "subscriptions/00000000-0000-0000-0000-000000000000"',
             checks=[])


# EXAMPLE: /GenerateDetailedCostReportOperationStatus/get/Get details of the operation
@try_manual
def step__generatedetailedcostreportoperationstatus_ge(test, rg):
    test.cmd('az costmanagement generate-detailed-cost-report-operation-status show '
             '--operation-id "00000000-0000-0000-0000-000000000000" '
             '--scope "subscriptions/00000000-0000-0000-0000-000000000000"',
             checks=[])
...
def call_scenario(test, rg):
    ...
    step__generatedetailedcostreport_post(test, rg)
    step__generatedetailedcostreport_post2(test, rg)
    step__generatedetailedcostreport_post3(test, rg)
    step__generatedetailedcostreport_post4(test, rg)
    step__generatedetailedcostreport_post5(test, rg)
    step__generatedetailedcostreportoperationresults_g(test, rg)
    step__generatedetailedcostreportoperationstatus_ge(test, rg)
