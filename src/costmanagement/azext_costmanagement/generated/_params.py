...
from azext_costmanagement.action import (
    AddRecurrencePeriod,
    AddExportsTimePeriod,
    AddExportsConfiguration,
    AddDestination,
    AddGeneratedetailedcostreportTimePeriod,
    AddKpis,
    AddPivots,
    AddViewsTimePeriod,
...
def load_arguments(self, _):
    ...
    with self.argument_context('costmanagement export create') as c:
        ...
        c.argument('time_period', action=AddExportsTimePeriod, nargs='+', help='Has time period for pulling data for '
                   'the export.', arg_group='Definition')
        c.argument('configuration', action=AddExportsConfiguration, nargs='+',
                   help='The export dataset configuration.', arg_group='Definition Data Set')
    ...
    with self.argument_context('costmanagement generate-detailed-cost-report create-operation') as c:
        c.argument('scope', type=str, help='The scope associated with usage details operations. This includes '
                   '\'/subscriptions/{subscriptionId}/\' for subscription scope, \'/providers/Microsoft.Billing/billing'
                   'Accounts/{billingAccountId}\' for Billing Account scope, \'/providers/Microsoft.Billing/departments'
                   '/{departmentId}\' for Department scope, \'/providers/Microsoft.Billing/enrollmentAccounts/{enrollme'
                   'ntAccountId}\' for EnrollmentAccount scope. Also, Modern Commerce Account scopes are '
                   '\'/providers/Microsoft.Billing/billingAccounts/{billingAccountId}\' for billingAccount scope, '
                   '\'/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId'
                   '}\' for billingProfile scope, \'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/bill'
                   'ingProfiles/{billingProfileId}/invoiceSections/{invoiceSectionId}\' for invoiceSection scope, and '
                   '\'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/customers/{customerId}\' specific '
                   'for partners.')
        c.argument('metric', arg_type=get_enum_type(['ActualCost', 'AmortizedCost']), help='The type of the detailed '
                   'report. By default ActualCost is provided')
        c.argument('time_period', action=AddGeneratedetailedcostreportTimePeriod, nargs='+', help='Has time period for '
                   'pulling data for the cost detailed report. Can only have one of either timePeriod or invoiceId or '
                   'billingPeriod parameters. If none provided current month cost is provided.')
        c.argument('billing_period', type=str, help='Billing Period in YearMonth(e.g. 202008) format. Only for legacy '
                   'enterprise customers can use this. Can only have one of either timePeriod or invoiceId or '
                   'billingPeriod parameters. If none provided current month cost is provided.')
        c.argument('invoice_id', type=str, help='Invoice Id for PayAsYouGo customers and Modern billing profile scope. '
                   'Can only have one of either timePeriod or invoiceId or billingPeriod parameters. If none provided '
                   'current month cost is provided.')
        c.argument('customer_id', type=str, help='Customer Id for Modern (Invoice Id and billing profile is also '
                   'required for this).')

    with self.argument_context('costmanagement generate-detailed-cost-report-operation-result show') as c:
        c.argument('operation_id', type=str, help='The target operation Id.')
        c.argument('scope', type=str, help='The scope associated with usage details operations. This includes '
                   '\'/subscriptions/{subscriptionId}/\' for subscription scope, \'/providers/Microsoft.Billing/billing'
                   'Accounts/{billingAccountId}\' for Billing Account scope, \'/providers/Microsoft.Billing/departments'
                   '/{departmentId}\' for Department scope, \'/providers/Microsoft.Billing/enrollmentAccounts/{enrollme'
    ...
    with self.argument_context('costmanagement generate-detailed-cost-report-operation-result wait') as c:
        c.argument('operation_id', type=str, help='The target operation Id.')
        c.argument('scope', type=str, help='The scope associated with usage details operations. This includes '
                   '\'/subscriptions/{subscriptionId}/\' for subscription scope, \'/providers/Microsoft.Billing/billing'
                   'Accounts/{billingAccountId}\' for Billing Account scope, \'/providers/Microsoft.Billing/departments'
    ...
    with self.argument_context('costmanagement generate-detailed-cost-report-operation-status show') as c:
        c.argument('operation_id', type=str, help='The target operation Id.')
        c.argument('scope', type=str, help='The scope associated with usage details operations. This includes '
                   '\'/subscriptions/{subscriptionId}/\' for subscription scope, \'/providers/Microsoft.Billing/billing'
                   'Accounts/{billingAccountId}\' for Billing Account scope, \'/providers/Microsoft.Billing/departments'
    ...
    with self.argument_context('costmanagement generate-detailed-cost-report-operation-status wait') as c:
        c.argument('operation_id', type=str, help='The target operation Id.')
        c.argument('scope', type=str, help='The scope associated with usage details operations. This includes '
                   '\'/subscriptions/{subscriptionId}/\' for subscription scope, \'/providers/Microsoft.Billing/billing'
                   'Accounts/{billingAccountId}\' for Billing Account scope, \'/providers/Microsoft.Billing/departments'
    ...
    with self.argument_context('costmanagement forecast external-cloud-provider-usage') as c:
        ...
        c.argument('configuration', action=AddConfiguration, nargs='+', help='Has configuration information for the '
                   'data in the export. The configuration will be ignored if aggregation and grouping are provided.',
                   arg_group='Dataset')
        c.argument('aggregation', type=validate_file_or_dict, help='Dictionary of aggregation expression to use in the '
