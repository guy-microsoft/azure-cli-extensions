...
helps['costmanagement generate-detailed-cost-report'] = """
    type: group
    short-summary: Manage generate detailed cost report with costmanagement
"""

helps['costmanagement generate-detailed-cost-report create-operation'] = """
    type: command
    short-summary: "Generates the detailed cost report for provided date range, billing period(Only enterprise \
...
status and if the operation is completed the blob file where generated detailed cost report is being stored."
    parameters:
      - name: --time-period
        short-summary: "Has time period for pulling data for the cost detailed report. Can only have one of either \
timePeriod or invoiceId or billingPeriod parameters. If none provided current month cost is provided."
        long-summary: |
            Usage: --time-period start=XX end=XX

            start: Required. The start date to pull data from. example format 2020-03-15
            end: Required. The end date to pull data to. example format 2020-03-15
    examples:
      - name: GenerateDetailedCostReportByBillingAccountLegacyAndBillingPeriod
        text: |-
               az costmanagement generate-detailed-cost-report create-operation --billing-period "202008" --metric \
"ActualCost" --scope "providers/Microsoft.Billing/billingAccounts/12345"
      - name: GenerateDetailedCostReportByBillingProfileAndInvoiceId
        text: |-
               az costmanagement generate-detailed-cost-report create-operation --invoice-id "M1234567" --metric \
"ActualCost" --scope "providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579"
      - name: GenerateDetailedCostReportByBillingProfileAndInvoiceIdAndCustomerId
        text: |-
               az costmanagement generate-detailed-cost-report create-operation --customer-id "456789" --invoice-id \
"M1234567" --metric "ActualCost" --scope "providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579"
      - name: GenerateDetailedCostReportByCustomerAndTimePeriod
        text: |-
               az costmanagement generate-detailed-cost-report create-operation --metric "ActualCost" --time-period \
end="2020-03-15" start="2020-03-01" --scope "providers/Microsoft.Billing/billingAccounts/12345:6789/customers/13579"
      - name: GenerateDetailedCostReportBySubscriptionAndTimePeriod
        text: |-
               az costmanagement generate-detailed-cost-report create-operation --metric "ActualCost" --time-period \
end="2020-03-15" start="2020-03-01" --scope "subscriptions/fae17478-31e7-40fd-b62a-1a127754a463"
"""

helps['costmanagement generate-detailed-cost-report-operation-result'] = """
    type: group
    short-summary: Manage generate detailed cost report operation result with costmanagement
"""

helps['costmanagement generate-detailed-cost-report-operation-result show'] = """
    type: command
    short-summary: "Get the result of the specified operation. This link is provided in the GenerateDetailedCostReport \
creation request response header."
    examples:
      - name: Get details of the operation
        text: |-
               az costmanagement generate-detailed-cost-report-operation-result show --operation-id \
"00000000-0000-0000-0000-000000000000" --scope "subscriptions/00000000-0000-0000-0000-000000000000"
"""

helps['costmanagement generate-detailed-cost-report-operation-result wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the costmanagement \
generate-detailed-cost-report-operation-result is met.
    examples:
      - name: Pause executing next line of CLI script until the costmanagement generate-detailed-cost-report-operation-\
result is successfully created.
        text: |-
               az costmanagement generate-detailed-cost-report-operation-result wait --operation-id \
"00000000-0000-0000-0000-000000000000" --scope "subscriptions/00000000-0000-0000-0000-000000000000" --created
"""

helps['costmanagement generate-detailed-cost-report-operation-status'] = """
    type: group
    short-summary: Manage generate detailed cost report operation status with costmanagement
"""

helps['costmanagement generate-detailed-cost-report-operation-status show'] = """
    type: command
    short-summary: "Get the status of the specified operation. This link is provided in the GenerateDetailedCostReport \
creation request response header."
    examples:
      - name: Get details of the operation
        text: |-
               az costmanagement generate-detailed-cost-report-operation-status show --operation-id \
"00000000-0000-0000-0000-000000000000" --scope "subscriptions/00000000-0000-0000-0000-000000000000"
"""

helps['costmanagement generate-detailed-cost-report-operation-status wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the costmanagement \
generate-detailed-cost-report-operation-status is met.
    examples:
      - name: Pause executing next line of CLI script until the costmanagement generate-detailed-cost-report-operation-\
status is successfully created.
        text: |-
               az costmanagement generate-detailed-cost-report-operation-status wait --operation-id \
"00000000-0000-0000-0000-000000000000" --scope "subscriptions/00000000-0000-0000-0000-000000000000" --created
"""
