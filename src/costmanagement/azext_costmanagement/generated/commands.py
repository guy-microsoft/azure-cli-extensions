...
def load_command_table(self, _):
    ...
    from azext_costmanagement.generated._client_factory import cf_generate_detailed_cost_report
    costmanagement_generate_detailed_cost_report = CliCommandType(
        operations_tmpl='azext_costmanagement.vendored_sdks.costmanagement.operations._generate_detailed_cost_report_op'
        'erations#GenerateDetailedCostReportOperations.{}',
        client_factory=cf_generate_detailed_cost_report)
    with self.command_group('costmanagement generate-detailed-cost-report',
                            costmanagement_generate_detailed_cost_report,
                            client_factory=cf_generate_detailed_cost_report) as g:
        g.custom_command('create-operation', 'costmanagement_generate_detailed_cost_report_create_operation')

    from azext_costmanagement.generated._client_factory import cf_generate_detailed_cost_report_operation_result
    costmanagement_generate_detailed_cost_report_operation_result = CliCommandType(
        operations_tmpl='azext_costmanagement.vendored_sdks.costmanagement.operations._generate_detailed_cost_report_op'
        'eration_results_operations#GenerateDetailedCostReportOperationResultsOperations.{}',
        client_factory=cf_generate_detailed_cost_report_operation_result)
    with self.command_group('costmanagement generate-detailed-cost-report-operation-result',
                            costmanagement_generate_detailed_cost_report_operation_result,
                            client_factory=cf_generate_detailed_cost_report_operation_result) as g:
        g.custom_show_command('show', 'costmanagement_generate_detailed_cost_report_operation_result_show',
                              supports_no_wait=True)
        g.custom_wait_command('wait', 'costmanagement_generate_detailed_cost_report_operation_result_show')

    from azext_costmanagement.generated._client_factory import cf_generate_detailed_cost_report_operation_status
    costmanagement_generate_detailed_cost_report_operation_status = CliCommandType(
        operations_tmpl='azext_costmanagement.vendored_sdks.costmanagement.operations._generate_detailed_cost_report_op'
        'eration_status_operations#GenerateDetailedCostReportOperationStatusOperations.{}',
        client_factory=cf_generate_detailed_cost_report_operation_status)
    with self.command_group('costmanagement generate-detailed-cost-report-operation-status',
                            costmanagement_generate_detailed_cost_report_operation_status,
                            client_factory=cf_generate_detailed_cost_report_operation_status) as g:
        g.custom_show_command('show', 'costmanagement_generate_detailed_cost_report_operation_status_show',
                              supports_no_wait=True)
        g.custom_wait_command('wait', 'costmanagement_generate_detailed_cost_report_operation_status_show')
