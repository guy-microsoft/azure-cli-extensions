...
@try_manual
def step_extension_create(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_extension_list(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_extension_show(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_extension_update(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_extension_delete(test, rg, checks=None):
    if checks is None:
        checks = []
