...
class MachineExtensionOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~connected_machine.models.MachineExtension or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.MachineExtension"]]
        error_map = {
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~connected_machine.models.MachineExtensionsListResultor None]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
