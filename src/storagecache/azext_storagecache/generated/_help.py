...
/scvnet/subnets/sub1" --name "Standard_2G" --tags "{\\"Dept\\":\\"ContosoAds\\"}" --cache-name "sc1" --resource-group \
"scgroup"
"""
...
bind-dn="cn=ldapadmin,dc=contosoad,dc=contoso,dc=local" bind-password="<bindPassword>" --extended-groups true \
--ldap-base-dn "dc=contosoad,dc=contoso,dc=local" --ldap-server "192.0.2.12" --username-source "LDAP" --mtu 1400 \
--access-policies name="default" access-rules={"access":"rw","rootSquash":false,"scope":"default","submountAccess":true\
,"suid":false} --access-policies name="restrictive" access-rules={"access":"rw","filter":"10.99.3.145","rootSquash":fal\
se,"scope":"host","submountAccess":true,"suid":true} access-rules={"access":"rw","filter":"10.99.1.0/24","rootSquash":f\
alse,"scope":"network","submountAccess":true,"suid":true} access-rules={"access":"no","anonymousGID":"-2","anonymousUID\
":"-2","rootSquash":true,"scope":"default","submountAccess":true,"suid":false} --subnet "/subscriptions/00000000-0000-0\
000-0000-000000000000/resourceGroups/scgroup/providers/Microsoft.Network/virtualNetworks/scvnet/subnets/sub1" --name \
...
target-path="/path2/on/exp2" --nfs3 target="10.0.44.44" usage-model="READ_HEAVY_INFREQ"
