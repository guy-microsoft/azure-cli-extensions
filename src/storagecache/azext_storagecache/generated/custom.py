...
def storagecache_create(client,
    ...
    cache['network_settings'] = {}
    cache['network_settings']['mtu'] = 1500 if mtu is None else mtu
    cache['sku'] = {}
    cache['sku']['name'] = name
    cache['identity'] = {}
...
def storagecache_storage_target_create(client,
    ...
    storagetarget['unknown']['unknown_map'] = unknown_map
    storagetarget['clfs'] = {}
...
def storagecache_storage_target_update(instance,
    ...
    if unknown_map is not None:
        instance.unknown.unknown_map = unknown_map
