...
def load_arguments(self, _):
    ...
    with self.argument_context('storagecache create') as c:
        ...
        c.argument('mtu', type=int, help='The IPv4 maximum transmission unit configured for the subnet.',
                   arg_group='Network Settings')
    ...
    with self.argument_context('storagecache storage-target create') as c:
        ...
        c.argument('unknown_map', action=AddUnknownMap, nargs='+', help='Dictionary of string->string pairs containing '
