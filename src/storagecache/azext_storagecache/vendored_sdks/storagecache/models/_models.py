...
class Cache(msrest.serialization.Model):
    ...
    _validation = {
        ...
        'cache_net_bios_name': {'pattern': r'^[-0-9a-zA-Z]{1,15}$'},
    ...
    _attribute_map = {
        ...
        'domain_net_bios_name': {'key': 'directoryServicesSettings.activeDirectory.domainNetBiosName', 'type': 'str'},
        'cache_net_bios_name': {'key': 'directoryServicesSettings.activeDirectory.cacheNetBiosName', 'type': 'str'},
